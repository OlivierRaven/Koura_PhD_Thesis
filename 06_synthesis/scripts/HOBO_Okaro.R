...
DO_Logger_14_reef_122_090225 <- read_csv("Data_raw/DO_Loggers/DO_Logger_14_reef_122_090225.csv", skip = 1)
...
DO_Logger_11_reef_123_280225 <- read_csv("Data_raw/DO_Loggers/DO_Logger_11_reef_123_280225.csv", skip = 1)
...
DO_Logger_3_control_124_280225 <- read_csv("Data_raw/DO_Loggers/DO_Logger_3_control_124_280225.csv", skip = 1)
...
DO_Logger_14_reef_122_131224 <- DO_Logger_14_reef_122_131224 %>% select(ID = 1,DateTime = 2,DO_mg_L = 3,Temp_C = 4) %>%
  mutate(DateTime = as.POSIXct(DateTime, format = "%m/%d/%y %I:%M:%S %p", tz = "Pacific/Auckland"),Site = "122 Reef")
DO_Logger_14_reef_122_090225 <- DO_Logger_14_reef_122_090225 %>% select(ID = 1,DateTime = 2,DO_mg_L = 3,Temp_C = 4) %>%
  mutate(DateTime = as.POSIXct(DateTime, format = "%m/%d/%y %I:%M:%S %p", tz = "Pacific/Auckland"),Site = "122 Reef")
Site_122 <- bind_rows(DO_Logger_14_reef_122_291024, DO_Logger_14_reef_122_131224,DO_Logger_14_reef_122_090225)
# filter after 09/02/25
Site_122 <- Site_122 %>% filter(DateTime < "2025-02-09 00:00:00")
...
DO_Logger_11_reef_123_131224 <- DO_Logger_11_reef_123_131224 %>% select(ID = 1,DateTime = 2,DO_mg_L = 3,Temp_C = 4) %>%
  mutate(DateTime = as.POSIXct(DateTime, format = "%m/%d/%y %I:%M:%S %p", tz = "Pacific/Auckland"),Site = "123 Reef")
DO_Logger_11_reef_123_280225 <- DO_Logger_11_reef_123_280225 %>% select(ID = 1,DateTime = 2,DO_mg_L = 3,Temp_C = 4) %>%
  mutate(DateTime = as.POSIXct(DateTime, format = "%m/%d/%y %I:%M:%S %p", tz = "Pacific/Auckland"),Site = "123 Reef")
Site_123 <- bind_rows(DO_Logger_11_reef_123_291024, DO_Logger_11_reef_123_131224, DO_Logger_11_reef_123_280225)
# filter after 28/02/25
Site_123 <- Site_123 %>% filter(DateTime < "2025-02-28 00:00:00")
...
DO_Logger_3_control_124_131224 <- DO_Logger_3_control_124_131224 %>% select(ID = 1,DateTime = 2,DO_mg_L = 3,Temp_C = 4) %>%
  mutate(DateTime = as.POSIXct(DateTime, format = "%m/%d/%y %I:%M:%S %p", tz = "Pacific/Auckland"),Site = "124 Control")
DO_Logger_3_control_124_280225 <- DO_Logger_3_control_124_280225 %>% select(ID = 1,DateTime = 2,DO_mg_L = 3,Temp_C = 4) %>%
  mutate(DateTime = as.POSIXct(DateTime, format = "%m/%d/%y %I:%M:%S %p", tz = "Pacific/Auckland"),Site = "124 Control")
Site_124 <- bind_rows(DO_Logger_3_control_124_291024,DO_Logger_3_control_124_131224, DO_Logger_3_control_124_280225)
# filter after 28/02/25
Site_124 <- Site_124 %>% filter(DateTime < "2025-02-28 00:00:00")
...
ggplot() +
  ...
  labs(title = "Dissolved Oxygen (DO) Levels. Summer 24/25",x = "Date",y = "DO (mg/L)",color = "Site") +
  theme_bw()

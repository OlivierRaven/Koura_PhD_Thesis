...
![Distribution of kōura (blue left) and catfish (red right) in Aotearoa New Zealand. Source: New Zealand Freshwater Fish Database [@Stoffels2024]](outputs/fig-nz-distribution-maps.png){#fig-nz-distribution-maps}
...
![Rotorua Te Arawa Lakes overview map](outputs/fig-study-lakes-map.png){#fig-study-lakes-map}

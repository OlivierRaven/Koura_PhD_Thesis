...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[color=white, text width=0.92\paperwidth, align=center,
    ...
    {\hyphenpenalty=10000\exhyphenpenalty=10000 Enhancing Kōura (Native Freshwater Crayfish) Habitat in Invaded Lake Ecosystems};
...
{\fontsize{20}{26}\selectfont\bfseries Enhancing K\={o}ura (Native Freshwater Crayfish)\\[0.3cm]Habitat in Invaded Lake Ecosystems}
...
\textit{Enhancing Kōura (Native Freshwater Crayfish) Habitat in Invaded Lake Ecosystems}\\[0.3em]
Olivier V. Raven\\
...
incluso desde tan lejos. Tot slot wil ik graag mijn ouders, broertjes,
omi, opa bedanken voor hun support en sorry voor het zo verweg zijn.
...
title-block-style: none citation: false
...
Kōura populations in some Rotorua Te Arawa Lakes have declined by 76-91
\% since 2003. Freshwater species decline is rarely driven by a single
stressor, and kōura in these lakes face several acting simultaneously:
predation and fear-induced behavioural suppression caused by catfish;
thermal stratification, which compresses suitable habitat into the
shallow littoral zone, precisely where catfish predation pressure is
greatest; and invasive macrophytes, which further constricts the habitat
available to kōura. This thesis investigated whether, within this
compounding-stressor context, habitat enhancement could provide a
practical means of supporting kōura recovery.

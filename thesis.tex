...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[color=white, text width=0.88\paperwidth, align=center,
    ...
    {Conservation of K\={o}ura Under Brown Bullhead Catfish Invasion in the Rotorua Te Arawa Lakes};
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{outputs/fig-study-lakes-map.png}

...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[color=white, text width=0.82\paperwidth, align=center,
    ...
    {Enhancing native freshwater crayfish habitat in invaded lake ecosystems};
...
natural rocky habitat, demonstraiting their potential to support kōura
...
helping restore the traditional practices they have sustaind for
generations.
...
for numerous species (Meerhoff and González-Sagrario 2022a) and
...
al. 2022). This commitment reflects a broader conservation imerative, as
habitat degradation and loss remain key drivers of regional population
extinction (Heinrichs et al. 2016).
...
2007). Approaches to habitat restoration across terestial, costal, and
freshwater systems vary widely depending on the system and species
...
habitat restoration remains comparatively underdevaloped (Geist and
Hawkins 2016).
...
particularly persavive and difficult to manage threat, as non-native
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{images/fig-rotoiti-weeds.png}
...
habitat for kōura (Kusabs et al. 2026). In Lake Rotoiti, this deep
...
structural restoration can build resilience in kōura populations. This
rationale is supported by evidence from other stytems supoporting
crayfish: in lakes where muddy substrates provide limited refugia,
adding rocky substrate has been shown to relax refugia limitation and
increase noble crayfish (\emph{Astacus astacus}) population density
(Johnsen and Taugbøl 2008).

\begin{figure}

\centering{

\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{outputs/fig-livable-habitat-summary.png}
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{outputs/fig-livable-habitat-trends.png}
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{images/setup_combined.png}
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{outputs/fig-refuge-plot.png}
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{images/Natural_habitat_map.png}
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{outputs/fig-koura-by-lake.png}
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{outputs/fig-occupancy-model.png}
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{outputs/fig-cpue-hurdle.png}
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{images/Setup_exp_tanks.png}
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{outputs/fig-exp2.png}
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{outputs/fig-exp3.png}
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{outputs/fig-exp4.png}
...
modelling. This near-ceiling occupancy indicates kōura were using the
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{images/Rotoiti_monitoring_sites.png}
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{outputs/fig-koura-trends.png}
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{images/Stone_pile_development.png}
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{outputs/fig-occ-warm-contrasts.png}
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{outputs/fig-power-curves-combined.png}
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{outputs/fig-trajectory-projection.png}
...
Lake Rotoiti and monitored kōura response over 18 months in a BACI
design. No significant change was detected, but the positive trend
direction and a simulation-based power analysis suggest the study was
structurally underpowered rather than demonstrating true
ineffectiveness. This chapter (Chapter 6) synthesises the findings
across all four chapters and presents two pilot studies that extend the
work in early and future directions. The first trialled the construction
logistics and kōura reintroduction in Lake Ōkaro where it was found that
water quality needs to meet kōura demands before reintroduction is
feasible. The second extended stone pile deployment up to nine meters
deep and found that kōura use stone piles across the littoral zone and
that stone piles are able to suppress invasive macrophytes. Together
with the main chapters, these case studies broaden the application of
the kōura restoration approach developed in this thesis for future
...
compounding stressors, with the most prominent the catfish predation,
thermal stratification, and invasive macrophytes. These stressors
operate at both the local habitat scala and the broader lake scale.
...
substantially lower kōura numbers. On the habitat scale structurally
complex rocky shorelines were associated with more kōura abundance while
excessive machrohyte cover revealed lower kōura densities, confirming
...
exposed to non-native catfish compared to the native eel. This is
...
behavioural change reduces the reproductive capacity of those that
...
persists as long as catfish are present.

Habitat enhancement represents an important intervention under these
conditions. The mesocosm trials (Chapter 4) showed that kōura
...
eliminate the fear response, but it provides kōura with locations where
...
and catfish shoreline use simultaneously peaks, kōura are compressed in
this small zone full of danger. Until winter comes, stratification
breaks down and kōura can redistribute to deeper habitats. Climate
...
({Jane et al.} 2021; Woolway et al. 2021; Lee et al. 2025).
...
algal blooms (Paul et al. 2008; LAWA (Land, Air, Water Aotearoa) 2024).
To improve water quality in the lake, in 2007 a wetland has been
constructed to remove nitrogen and sediments from the main inflows into
the lake (Hudson et al. 2009) and alum dosings (aluminum sulfate) are
carried out as in lake phosphorous treatment (Paul et al. 2008). Kōura
have not been observed in Lake Ōkaro in monitoring surveys from 1981 to
2007 (Parkyn and Kusabs 2007) and monitoring in 2016 and 2017 still were
not able to observe kōura in the lake even as water quality had improved
(Kusabs 2017). Water quality has now improved sufficiently that kōura is
considered feasible but natural recolonisation has not happened yet,
therefore reintroduction might be possible. Lake Ōkaro is stocked with
trout for angling and as a predator of kōura, stone piles would provide
additional refuge to trial habita enhancement alongside the existing
trout stocking. The lake has no stone or rocky substrates therefore the
...
over six months from September 2024. Prior to kōura release, trapping
and spotlighting surveys confirmed the lake held no kōura. In October
2024, twenty kōura sourced from Lake Rerewhakaaitu were released onto
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{outputs/fig-okaro-combined.png}
...
selected, a size that could be thrown from the trailier edge directly
into the lake and reposisioned by hand if needed.
...
when dissolved oxygen drops below kōura tolerance, kōura cannot use a
refuge they cannot survive in. This reinforces the sequencing argument
made later in this chapter: habitat provision must follow, not precede,
the establishment of survivable conditions.
...
around the jetty, by observing for kōura using a torch. Each kōura was
...
swim transects at the location of the stone piles and kōura observed
...
pile. Most kōura were observed at the margins of the stone piles rather
than within them, as internal crevices were visually inaccessible to
both spotlighting and ROV surveys. Kōura were only detected when they
...
growth at the margins complicated kōura detection in that area. Daytime
diving surveys (January 2026, water temp 21 °C; July 2026, water temp 11
°C) detected no kōura on either occasion. As kōura are nocturnal,
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{outputs/fig-deep-combined.png}
...
suppression of macrophytes suggests an additional co-benefit,
potentially creating connectivity between shallow and deep refuges in
overgrown littoal zones, though this warrentes further investigation.
...
carcases of dead predator fish without bias towards native or non-native
species (MacNeil et al. 2025). Trout as bait yielded a CPUE of 0.682
kōura per trap per night and catfish bait 0.638 kōura per trap per
night. Unbaited fyke nets had a notably higher CPUE of 2.71 kōura per
trap per night in the same lake, consistent with their larger net
...
of habitat use. Trap catches alone cannot determine whether kōura are
...
deep structures build in Lake Rotoiti, more active monitoring approaches
were applied including spotlighting, ROV surveys and human dive surveys.
These methods allow direct observation of kōura using the structures and
...
(Jézéquel et al. 2020, 2023), whether passive acoustic monitoring is
sensitieve enough to detect kōura activity in the complex acoustic
environment of a lake litorral zone remains untested.
...
it delivers benefits for kōura. Stone piles function as a buffer against
...
If dissolved oxygen drops below kōura tolerance, structure is
...
highest kōura abundance. As catfish can probably not be eradicated at
...
and management, ranging from individual deployments to lake-wide kōura
...
lakes would test whether the Rotoiti results are genaralise across the
Te Arawa system. Lake Rotorua, which has also declining kōura
...
deployment should incorerate this principle. Standadised monitoring
...
stacked together, are simple to deploy and persites in the lake without
...
attrect kōura and support population recover, with potential benefits
...
cultural kōura harvest in Lake Rotoiti. Given the combounding effects of
...
Kōura populations in the Rotorua Te Arawa Lakes are declining, and this
thesis set out to determine whether habitat enhancement could offer a
practical mean of supporting them.
...
bhavioural suppression from catfish predation compounds with thermal
...
from which recovery remains possible, when broarder conditions improve
in the future. In a system where the primary drivers of decline can not
be removed, giving koura somewhere to hide is not a complete solution,
but it is a meaninfull and actionable one.
...
LAWA (Land, Air, Water Aotearoa) (2024) Lake okaro

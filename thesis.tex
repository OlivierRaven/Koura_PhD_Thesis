...
natural substrates are rare, kōura can excavate tunnels or burrows to
provide cover, a behaviour documented in Lake Tikitapu, where the bottom
sediment substrate permits burrowing (Pers. Comm. Nick Ling).
...
\emph{Anguilla dieffenbachii} Gray, 1842), and common smelt
(\emph{Retropinna retropinna} {[}Richardson, 1848{]}). Introduced
species include brown and rainbow trout (\emph{Salmo trutta} Linnaeus,
1758, \emph{Oncorhynchus mykiss} (Walbaum, 1792)), mosquitofish
(\emph{Gambusia affinis} {[}Baird \& Girard, 1853{]}), and goldfish
(morihana; \emph{Carassius auratus} {[}Linnaeus, 1758{]}). The lakes
also support a mix of native macrophytes and several invasive species
that have transformed the littoral zone in many lakes
...
(Kusabs et al. 2026). This means that for kōura in catfish-invaded
...
Rotoehu, Rerewhakaaitu, Ōkāreka, Ōkaro, and Rotomāhana, while Rotomā and
Tarawera remain almost completely habitable year-round. Over the past
\textasciitilde20 years several lakes show long term declines in annual
mean liveable habitat (Figure~\ref{fig-livable-habitat-trends}). Full
methods are provided in the Appendix (see Appendix: Chapter 1 ---
...
(\emph{Astacus astacus} {[}Linnaeus, 1758{]}) population density
(Johnsen and Taugbøl 2008). Structural addition can only deliver this
benefit when water quality falls within species tolerance, as when
dissolved oxygen or temperature exceeds physiological limits, species
cannot persist regardless of refuge quality.
...
\emph{Journal of Applied Ecology} --- Under review \\
\end{longtable}
...
of background information and methods is unavoidable.
...
activities (Kusabs and Quinn 2009; Kusabs et al. 2015a, 2026). To
...
predation by invasive species (Lee et al. 2025; Kusabs et al. 2026).
...
custodians) of the lake (Kusabs et al. 2015a, 2026). The decline in
...
grazing, allowing algal mats to accumulate on hard surfaces (Wetzel
2001; Bonacina et al. 2023). The freshly quarried piles were free from
biofilm at deployment and by Winter 2026 supported a diverse meiofaunal
assemblage, indicating active succession rather than habitat
degradation; algal cover would be expected to decline as grazer activity
resumes in spring and summer. Despite the near-zero trap catches in
Winter 2026, night spotlighting at two stone pile sites in August 2026
directly observed kōura sheltering within the structures, confirming
that low winter catch rates reflect reduced detectability rather than
abandonment. Together, these results indicate that stone pile refuge
value is inherently seasonal --- greatest in summer and autumn, when
thermal stratification compresses habitat into the littoral zone and
catfish predation peaks, and lowest in winter, when kōura redistribute
...
stratification --- the two primary drivers of kōura decline --- cannot
be managed at the lake scale: eradication is not currently achievable,
and targeted catfish removal in high density areas reduces local
pressure without eliminating the lake-wide population (Dedual 2019).
Emerging biotechnologies such as gene drives and host-specific
biological control agents may offer future options (Thresher et al.
2014; Kopf et al. 2019; Teem et al. 2020), but these remain
experimental, and thermal stratification will continue to intensify
under climate warming (Woolway et al. 2021; Lee et al. 2025). Where the
primary stressors cannot be removed, habitat addition becomes one of the
few available management tools, and refugia become correspondingly more
...
densities for recolonisation (Morelli et al. 2016; Kusabs et al. 2026).
...
showed no evidence of being attracted to the stone piles. This chapter
(Chapter 6) synthesises the findings across all four chapters and
discusses their wider interpretation. Two additional field trials,
detailed in the appendices, were incorporated to extend the findings of
Chapter 3-5 into conditions not covered by the previous chapters. These
included a reintroduction attempt in Lake Ōkaro that tested the water
quality boundary of habitat enhancement (see Appendix: Chapter 6 ---
Supplementary information), and a depth-gradient deployment in Lake
Rotoiti that explored use of stone pile structures beyond wading depth
(see Appendix: Chapter 6 --- Supplementary information).
...
feasible, habitat provision may therefore help a remnant kōura
...
habitats, while increased catfish activity in the littoral zone may
expose kōura to greater predation risk, effectively compressing them
into a narrower band of suitable habitat. In winter, when stratification
breaks down and deeper waters are reoxygenated, kōura may redistribute
into deeper habitats or simply remain within existing shallow refuges
once predation and thermal pressure ease (Devcich 1979). Climate
projections suggest that this seasonal habitat constraint will intensify
as surface waters warm, stratification becomes stronger and more
persistent, and deep-water hypoxia and anoxia become more frequent and
prolonged ({Jane et al.} 2021; Woolway et al. 2021; Lee et al. 2025).
Chapter 1 documents a decline in suitable habitat for kōura over the
last 20 years across eleven lakes, calculated as the proportion of the
lakebed area meeting dissolved oxygen and temperature thresholds for
kōura. For example, Lake Ōkāreka showed a statistically significant
annual decline of 0.4\% in liveable habitat per year, indicating that
the suitable habitat window is narrowing under current conditions, not
just future ones (see Appendix: Chapter 1 --- Supplementary
information).
...
This limitation influenced the monitoring approaches across the thesis,
from netting in Chapter 3 and 5 toward direct observation methods in
later trials (see Appendix: Chapter 6 --- Supplementary information),
where spotlighting, Remotely Operated Vehicle (ROV) surveys, and diving
allowed kōura to be observed on structures directly.
...
In Chapter 3, shoreline habitat surveys across five Te Arawa Lakes
showed that kōura were most consistently associated with complex rocky
habitats and riparian vegetation (Jowett et al. 2008; Kusabs et al.
2015b). Locations where this substrate has been lost or never existed
are therefore logical candidates for stone pile deployment. Chapter 4
confirmed that structural permanence and complexity are the decisive
factors in kōura shelter selection, and stone piles deliver both
(Streissl and Hödl 2002). In lakes where populations are declining,
stone piles can help a remnant population persist and create habitat
stepping stones that lower the cost of dispersal between patches,
keeping populations more connected while broader lake conditions
improve. Stone piles may also physically suppress invasive macrophytes
at the placement site, as demonstrated by the stone pile at 4 m depth in
the deep Rotoiti case study, though whether this reflects sustained
suppression or slow regrowth of macrophytes remains untested. Chapter 5
demonstrates that stone piles represent a specific type of intervention
that operates differently from stressor removal.
...
crevice diversity, as the more hiding places the structures create, the
wider the range of kōura life stages it can support. Stones in the
100--300 mm range, as used in this study, provide abundant shelter space
when stacked together, are simple to deploy and persist in the lake
...
al. 2026) is not only an ecological loss but a cultural one. Increasing
...
this case study we trialled how to build rock piles by extending

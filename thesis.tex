...
{\fontsize{20}{26}\selectfont\bfseries Enhancing Native Freshwater Crayfish\\[0.3cm]Habitat in Invaded Lake Ecosystems}
...
\% in Lake Rotoiti (North Island), making traditional harvesting
...
The \textbf{(2) field survey} confirmed that complex shoreline habitats
consisting of rocks and riparian vegetation were the strongest
predictors of kōura presence across five lakes, consistent with the
well-documented preference of kōura for rocky substrates in river
systems.

The \textbf{(3) mesocosm experiment} evaluated the preference of kōura
for materials that could be used to enhance their habitat. When hole
sizes in habitat elements were held constant, kōura showed no preference
...
deployment offers a scalable, low-cost tool for restoring populations in
degraded lake littoral zones. Beyond ecological value, these results
provide practical evidence for restoration efforts that support kōura
recovery, helping restore the traditional practices they have sustained
for generations.
...
because only a single pre-construction monitoring round was available.
...
Chapter 2 supported the generalised fear hypothesis (Sih et al. 2023):
koura resond with heightened refuge use to catfish compared to the
native eel, meaning fear-induced behavioural suppression operates even
in the absence of direct predation. An animal spending more time in
refuge is an animal spending less time foraging, leading to slower
growth and reduced reproductive output. This is the core mechanism
behind the landscape of fear (Laundré et al. 2001), where predators do
not need to eat every prey individual to suppress a population, but
their presence alone is sufficient to reshape how prey use space and
time, and those behavioural changes carry demographic consequences. In
the context of the Rotorua Te Arawa Lakes, this means that catfish
suppress kōura populations through two channels simultaneously. Direct
predation removes individuals and fear-induced behavioural change
reduces the reproductive capacity of those that survive. Population
recovery under these conditions is likely to be slow even if predation
rates are reduced, because the behaviour suppression persists as long as
catfish are present.
...
information}\label{chapter-6-supplementary-information-1}
\addcontentsline{toc}{section}{Chapter 6 --- Supplementary information}

\subsection{Case study --- Field trial: stone piles in Lake
...
alum dosings (aluminium sulphate) are carried out as in lake phosphorous
...
now improved sufficiently that kōura is considered feasible but natural
...
of kōura, stone piles would provide additional refuge to trial habitat
...
\subsection{Case study --- Deep stone piles in Lake

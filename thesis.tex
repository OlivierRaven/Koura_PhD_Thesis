...
\midrule
Rotorua & 81.0 & 45 & 508.0 & 11.0 & 45.0 & 0.24 & 280 & Polymictic & Eutrophic\\
Rotoiti & 34.0 & 61 & 123.7 & 31.5 & 124.0 & 0.25 & 279 & Monomictic & Mesotrophic\\
Rotoehu & 8.0 & 40 & 49.2 & 8.0 & 13.5 & 0.59 & 295 & Polymictic & Eutrophic\\
Rotomā & 11.0 & 24 & 27.8 & 36.9 & 83.0 & 0.44 & 316 & Monomictic & Oligotrophic\\
Ōkataina & 11.0 & 29 & 59.8 & 39.4 & 78.5 & 0.50 & 305 & Monomictic & Oligotrophic\\
\addlinespace
Ōkāreka & 3.0 & 11 & 19.6 & 20.0 & 33.5 & 0.60 & 355 & Monomictic & Mesotrophic\\
Tikitapu & 1.0 & 5 & 6.2 & 18.0 & 27.5 & 0.65 & 355 & Monomictic & Oligotrophic\\
Rotokākahi & 4.0 & 16 & 18.7 & 17.5 & 32.0 & 0.55 & 395 & Monomictic & Mesotrophic\\
Tarawera & 41.0 & 48 & 143.1 & 50.0 & 87.5 & 0.57 & 305 & Monomictic & Oligotrophic\\
Rotomāhana & 9.0 & 27 & 83.3 & 60.0 & 125.0 & 0.48 & 340 & Monomictic & Mesotrophic\\
\addlinespace
Ōkaro & 0.3 & 2 & 3.9 & 12.5 & 18.0 & 0.69 & 280 & Monomictic & Eutrophic\\
...
rationale is supported by evidence from other systems supporting
...
were selected as reference. In total 20 sites of each 150 m² (15 × 10 m)
were monitored seasonally over 18 months. Physical characteristics of
...
({\textbf{?@tbl-baseline-combined}}), confirming baseline equivalences
...
81--89 \% in summer ({\textbf{?@tbl-psi-warm}}). After construction,
...
Pilotto et al. 2018). Following reconstruction of the Rotorua lakefront,
57 kōura were removed before construction but none were observed after
13 months and only 17 after 28 months (Kusabs 2023). Slow recolonisation
was attributed to persistent catfish predation pressure and distance
...
pile structures may also be difficult for kōura to locate, as
connectivity between habitat patches is a key determinant of
colonisation success (Hanski 1998).
...
lake thermal stratification breaks down in winter, deep-water habitat
becomes thermally accessible, reducing the value of the shallow littoral
zone as refuge and allowing kōura to redistribute along the depth
gradient (Devcich 1979). Kōura activity declines at low water
temperatures (Devcich 1979), reducing the probability of trap entry
independently of true abundance. Water temperature in Winter 2026 was
1.5 °C lower than Winter 2025, though this difference was consistent
across all site types and therefore cannot explain why reference sites
were substantially more resilient to the winter decline than the stone
pile sites.
...
(Wetzel 2001), while reduced water temperature suppresses invertebrate
grazing activity (Bonacina et al. 2023), allowing algal mats to
accumulate on available hard surfaces. The stone pile surfaces, freshly
quarried and free from biofilm at deployment, provided clean substrate
for early colonisers, and by Winter 2026 a diverse assemblage had
established, including cyanobacteria, green algae, \emph{Sinelobus
...
nutrient loading (Wetzel 2001; Bonacina et al. 2023), and algal mat
cover is expected to decline, making the stone piles more accessible for
kōura refuge.
...
host-specific biological control agents may offer future options (Kopf
et al. 2019; Teem et al. 2020; \textbf{Thresher2013?}), but these remain
experimental. Thermal stratification will intensify as the climate
continues to warm (Woolway et al. 2021), further compressing kōura and
expanding suitable conditions for catfish (Lee et al. 2025). When the
primary stressors cannot be removed, habitat addition becomes one of the
few available management tools, and refugia become most valuable under
these conditions (Selwood and Zimmer 2020). While freshwater management
...
focus on removing individual stressors. This study therefore tested
whether structural habitat addition can buffer the combined effects of
predation and thermal compression without removing either stressor.
...
event and whether kōura abundance at stone pile sites continues to build
...
design. Kōura colonised the structures rapidly, with occupancy and
...
directions. The first trialled the construction logistics and kōura
reintroduction in Lake Ōkaro where it was found that water quality needs
to meet kōura demands before reintroduction is feasible. The second
extended stone pile deployment up to nine meters deep and found that
kōura use stone piles across the littoral zone and that stone piles are
able to suppress invasive macrophytes. Together with the main chapters,
these case studies broaden the application of the kōura restoration
...
excessive macrophyte cover revealed lower kōura densities, confirming
...
the lake (Hudson et al. 2009) and alum dosings (aluminium sulfate) are
...
2025-02-27. Buoy data erived from CTD cast collected by LimnoTrack
(Moore2026).}
...
Buoy data erived from CTD cast collected by LimnoTrack (Moore2026).}
...
overgrown littoral zones, though this warrants further investigation.
...
of 0.682 kōura per trap per night and catfish bait 0.638 kōura per trap
per night. Unbaited fyke nets had a notably higher CPUE of 2.71 kōura
...
evaluate kōura use of specific structures. Passive acoustics offer a
...
monitoring is sensitive enough to detect kōura activity in the complex
...
LimnoTrack continuous monitoring buoy (\textbf{MooreMcBride2026?}).
Vertical green line marks stone pile deployment; dashed vertical lines
mark seasonal monitoring rounds. Warm colours in the DO panel
(orange--black) indicate hypoxic and anoxic conditions (\textless{} 5
mg/L), demonstrating the pronounced summer stratification that
compresses oxygenated habitat into the shallow littoral zone.}

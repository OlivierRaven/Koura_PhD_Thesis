...
OOver the past \textasciitilde20 years several lakes show statistically
...
\addcontentsline{toc}{chapter}{\protect\numberline{1}Native vs.\ Novel Threats}
\fi
...
\addcontentsline{toc}{chapter}{\protect\numberline{1}Where do K\={o}ura Live?}
\fi
...
\subsection{Funding statement}\label{funding-statement-1}
...
\subsection{Ethical approval}\label{ethical-approval-1}
...
\subsection{Declarations}\label{declarations-1}
...
\addcontentsline{toc}{chapter}{\protect\numberline{1}The Importance of Structure}
\fi
...
\subsection{Funding statement}\label{funding-statement-2}
...
\subsection{Authors' contributions}\label{authors-contributions-2}
...
\subsection{Ethical approval}\label{ethical-approval-2}
...
\subsection{Declarations}\label{declarations-2}
...
\addcontentsline{toc}{chapter}{\protect\numberline{1}Rock Piles as K\={o}ura Habitat}
\fi
...
preference for enclosed stone structures (Raven et al. in review). Stone
...
more then 2 units relative to the base model (2002). Temperature was
retained in in catfish models where it substantially improved model fit,
...
\subsection{Funding statement}\label{funding-statement-3}
...
\subsection{Authors' contributions}\label{authors-contributions-3}
...
\subsection{Declarations}\label{declarations-3}
...
\section{Stone piles Lake Ōkaro}\label{stone-piles-lake-ux14dkaro}

\subsection{Field test stones to build kōura
habitat}\label{field-test-stones-to-build-kux14dura-habitat}

Lake Okaro is a small lake without a known kōura population. The water
quality in the lake used to be poor, but due to recent restoration
efforts like wetland restoration and alum dosing, the water quality has
improved over the last decade. Kōura used to be in the lake but due to
the poor water quality they probably disapered. Now we wanted to test if
it would be possible to bring kōura back to the lake. as trout are
present in the lake, we wanted to make sure the kōura that would be
translocated would be able to fined refuge. The lake has no stone or
rock substrates therefore we constructed two stone piles to provide
refuge for the kōura. The stone piles were constructed along the
shoreline of Lake Ōkaro, Bay of Plenty, New Zealand. The stones used had
a size range of 70-210 mm mean 120 mm.

In this study is explored if it is possible to reintroduce a population
of native freshwater crayfish known as kōura in a eutrophic small lake.
The lake Ōkaro is a volcanic lake with an area of 30.19 ha, a max and
mean depth of 18 m and 12.5 m, respectively. The catchment is small but
mostly intensive farmland. To improve water quality in the lake a
wetland has been created and alim dosings are execute 2 times a year.
The lake has very often algae blooms.

2 reefs installed in T shape each reef was constructed on 12 August 2024
out of 2.5 trailer loads of rocks (100-300mm). 5 loads are 5 kuub of
rocks in total used. Building the reefs was done by 14 people from Te
Arawa Lake Trust, Ngāti Tahu - Ngāti Whaoa, Te Mana o Ngāti Rangitihi
Trust, Bay of Plenty Regional Council and The University of Waikato. 11
September 2024 hobo DO, and temperature loggers have been placed in the
lake. 2 have been buried inside the reef and one is placed outside of
the reefs. Monthly monitoring data has been collected since 2003 by the
Bay of Plenty Regional Council and buoy data (limontrack) since 2021.
...
\subsection{Stone piles expention}\label{stone-piles-expention}

On 24/11/2025 four stone piles were constructed in Lake Rotoiti, Bay of
Plenty, New Zealand. Three of the stone piles were constructed in
perundiqular to the shoreline. the first one was placed underneed a
jetty around 1 m depth. The second one was placed in the middle of
invasive machrophyte bed infront of the jetty around 3 m depth. the
third one was placed at the end of the machrophytes at a depth of 7 till
9 m depth. To prevent the stones from sinking into the sediment, wooden
slaps were first installed into the sediment wherafter the stones were
placed ontop keeping the woodenslaps inplace. The fourth stone pile was
...
\addcontentsline{toc}{chapter}{\protect\numberline{1}General Conclusion}
\fi
...
(2002) \href{https://doi.org/10.1007/978-0-387-22456-5_6}{Advanced
issues and deeper insights}. In: Model selection and multimodel

...
kōura) are a taonga (treasured) species in Aotearoa New Zealand with a
...
in Lake Rotoiti (North Island, New Zealand), making traditional
harvesting increasingly unviable. This decline is driven by multiple
stressors, including impaired water quality, intensified lake
stratification, and the spread of invasive fish and aquatic weeds. Since
around 2016, the non-native brown bullhead catfish (\emph{Ameiurus
nebulosus}) has become established in the lake and preys on kōura,
compounding upon the effects of other stressors. These threats indicate
that restoring habitat is necessary for kōura population recovery.
...
\textbf{Field experiment} Stone piles construction in Lake Rotoiti
produced no statistically significant change in kōura abundance biomass,
or occupancy relative to control sites over an 18 months period. This
null result is attributed to time and insufficient statistical power
rather than ineffectivness of stone piles. Consistent positive trends
were found between stone pile and control sites and continued monitoring
is needed to test the strength of this trend overtime. As stone pile
deployment could provide koura with refuges under further intensifying
stressors.
...
cycles within lake food webs. Lake shorelines are often heavily impacted
by human activities such as hardening, the introduction of invasive
species, and pollution (Vadeboncoeur et al. 2002; Strayer and Findlay
2010). Despite the importance of littoral zones, the effects of
eutrophication and predation by non-native species remains relatively
understudied (Vander Zanden and Vadeboncoeur 2020). Structurally complex
areas in the littoral zone, including rocky habitats, can function as
...
of halting the degradation of ecosystems worldwide and has specific
...
ecosystem. Approaches to habitat restoration across terestial, costal,
...
structurally simplified or degraded (Banks-Leite et al. 2020; Loch et
al. 2020). Among these approaches, the deliberate addition of hard
substrate, such as boulders, large wood, gravel, or habitat unites, is
one of the more direct and widely applied forms of habitat restoration,
since many species depend on physical complexity for shelter, feeding or
reproduction (Geist and Hawkins 2016). In marine systems, this principle
is most visibly applied through artificial reefs, structures placed on
the seafloor to rebuild the complexity lost from degraded or removed
natural reef habitat, supporting biodiversity recovery and fisheries
productivity (Frehse et al. 2025). While artificial reefs are most often
associated with marine environments, the same principle that adding
physical structure to a degraded habitat can restore the complexity and
shelter availability, extends to freshwater systems as well (Geist and
Hawkins 2016).

In freshwater environments, this principle has been applied through the
addition of rocks, woody debris, or other natural substrates to streams
...
2007; Roni et al. 2008; Parkyn et al. 2009). These additions have been
used to support a range of freshwater taxa, including fish and
invertebrates, by recreating the kind of structurally complex habitats
that naturally support shelter, feeding and reproduction (Santos et al.
2011; McLean et al. 2015; Zhu et al. 2021). However, not all added
structures achieve their intended benefit, poorly designed or
inappropriate materials such as plastic habitat structures can fail to
replicate natural habitat function and risk becoming a form of littering
rather than restoration (Baine 2001; Cooke et al. 2023), underscoring
the importance of careful design when structures are used as a
restoration tool. Within freshwater systems, structural restoration is
particularly relevant for taxa that depend on physical complexity for
shelter, including freshwater crayfish, which are ecologically important
but undergoing severe declines globally.
...
them important ecosystem engineers and keystone species (Crandall and
Buhay 2008; Jones et al. 2016).
...
species, and overexploitation. Invasive species, including non-native
fish and crayfish, prey on native species, compete for habitat, and
...
names including kēwai, kēkēwai, and koeke (2026). The two species are
the northern kōura (\emph{Paranephrops planifrons} White 1842) and the
...
shelters, to hide from predators. At night they emerge to forage, with
some populations known to move in to the productive shallow zones of
lakes (Devcich 1979). Where suitable natural substrates are rare, kōura
can excavate tunnels or burrows to provide cover, a behaviour documented
in Lake Tikitapu, where the bottom sediment substrate permits burrowing.
Kōura have direct development, meaning juveniles hatch as miniature
adults with no free-living larval stage. Females carry eggs and newly
hatched juveniles beneath the abdomen for approximately three weeks
before release, typically at depths of less than 10 m in lakes (Parkyn
and Kusabs 2007). Juveniles mature in two to three years depending on
water temperature (Devcich 1979; Parkyn 2000).
...
calendar) (Hiroa 1921; Henare 2008). For kōura, this period is from
beginning of kōanga (spring) until halfway through ngahuru (autumn).
Kōura are traditionally harvested using baited traps, handpicking, or
the tau kōura which uses several whakaweku (fern bundles) attached to a
tāuhu by pekapeka (Figure~\ref{fig-tau-koura}) (Parkyn and Kusabs 2007;
Kusabs and Quinn 2009). In the Rotorua Te Arawa Lakes (a group of twelve
...
hapū. The tau kōura is still used today, but mostly for research and
...
mykiss}), mosquitofish (\emph{Gambusia affinis}), and goldfish
(morihana; \emph{Carassius auratus}). The lakes also support a mix of
native macrophytes and several invasive species that have transformed
the littoral zone in many lakes (Burton 2017)
...
aims to reduce catfish abundance from the lakes.
...
(Kusabs et al. 2026). In Lake Rotoiti, this deep refuge becomes anoxic
and unavailable for kōura (Kusabs et al. 2026).
...
relatively stable year-round. Over the past \textasciitilde20 years
several lakes show statistically significant declines in annual mean
liveable habitat, with Rotorua and Ōkāreka declining -0.5 \% yr\(^{-1}\)
...
lake bottom area meeting dissolved oxygen (\textgreater{} 5 mg
L\(^{-1}\)) and temperature (\textless{} 21 °C) thresholds suitable for
kōura. Points represent means; lines show linear regressions with 95 \%
confidence intervals. Annual slopes are reported as percentage change
per year (significance: *** p \textless{} 0.001, ns = not significant).
...
predators globally. First, while catfish are implicated as a key driver
of kōura decline, the effect catfish have on kōura behaviour leading to
non-consumptive effects in comparison with native predators had not been
quantified. I therefore conducted aquarium experiments in which kōura
refuge use was recorded when exposed to native longfin eels and to
catfish. I expected that kōura would show no response to catfish
...
features kōura prefer remained unknown. I therefore monitored kōura
presence at 60 shoreline sites across five of the Rotorua Te Arawa
Lakes, recording habitat features and fish species. I expected that
...
Therefore, I deployed stone piles in Lake Rotoiti and expected that
...
depth gradient in Lake Rotoiti, where Remotely Operated Vehicle (ROV)
surveys were used to assess kōura use of the structures beyond wading
depth. Finally, the \textbf{General Conclusion} presents an overview of
the findings and considers how structural habitat restoration can
contribute to building resilience in declining freshwater crayfish
populations more broadly. As each of the four chapters are written as
stand-alone manuscripts, some overlap of background information and
methods is unavoidable. However, the general introduction provides a
comprehensive overview of the study system, the species involved, and
...
freshwater crayfish, have declined by up to 96 \% in Lake Rotoiti. This
decline is driven by two interacting stressors: predation by the
invasive brown bullhead catfish (\emph{Ameiurus nebulosus}) and thermal
stratification compressing suitable habitat into the shallow littoral
zone. As neither stressor can be eliminated at lake scale, we tested
whether stone pile structures deployed in the littoral zone of Lake
Rotoiti could provide structural refuge for kōura. Kōura and catfish
were monitored at five stone piles, five control, and ten natural rocky
reference sites for 18 months using a before-after control-impact (BACI)
design and a two-method Bayesian occupancy model. Stone pile
construction produced no significant change in kōura abundance, biomass,
or occupancy relative to control sites, but effects consistently trended
in the positive direction, with stone pile sites showing higher kōura
...
strengthens over time. Stone piles attracted no additional catfish and
their use by kōura is inherently seasonal, with structures most valuable
when habitat compression and catfish predation pressure peak
...
along the shoreline in the same habitat type. Five naturally occurring
rocky shoreline locations were selected as reference sites, each with
two monitoring points 50 m apart. In total 20 sites of each 150 m² (15 *
10 m) were monitored seasonally over 18 months. Baseline monitoring was
conducted in February 2025 prior to stone pile deployment, which
occurred the following week. Stone piles were constructed from locally
sourced quarry rock (Manawahe Stone and Quarry, \textasciitilde25 km
from the lake) with a size range of 85 - 315 mm mean 173 mm. At each of
the five stone pile sites, three stone piles were arranged horizontally
...
enclosed stone structures (Raven et al. in review). Stone piles were
...
(Jowett and Richardson 1990; Jowett et al. 2008): \[
\begin{aligned}
\text{Substrate index} &= 0.08 \times \text{bedrock} + 0.07 \times \text{boulders} \\
&\quad + 0.06 \times \text{cobble} + 0.04 \times \text{gravel} + 0.03 \times \text{sand} \\
&\quad + 0.02 \times \text{organic matter} + 0.01 \times \text{mud}
...
conducted in R (version 4.6.1; R Core Team (2026)) using the glmmTMB and
...
maximum effective fetch, or wave energy proxy) added at a time. A
covariate was retained only when it reduced AICc by more than two units
relative to the base model (Burnham and Anderson 2002). Temperature was
...
(Scott and Crossman 1973). For the two reference-site catfish models
specifically, the base model failed to converge, and temperature was
required for numerical stability. Season was retained in the kōura
abundance model for reference stability, reflecting the known seasonal
variation in kōura abundance (Kusabs et al. 2015b). Season could not be
evaluated for the BACI models as it is collinear with the before / after
period contrast. Maximum effective fetch (km) and a wave energy proxy
(fetch × wind speed\(^{2}\)) were derived from site-level fetch analysis
and tested as covariates to account for variation in wave exposure
across sites. Fetch was retained in the catfish abundance BACI and
trajectory models where it reduced AICc by more than two units relative
to the base model.
...
highest thermal stratification, compressing kōura into the nearshore
zone where catfish predation pressure is highest and the stone piles are
located. The warm-season model maximises ecological relevance, while
retaining a tractable formula with season as an additive covariate. All
...
bulk effective sample sizes (threshold \textgreater{} 400) (Vehtari et
al. 2021).
...
{Figure~\ref{fig-forest-plot}} and Table S1. Stone pile construction
...
({Figure~\ref{fig-forest-plot}}), indicating stone piles did not attract
catfish.
...
freshwater crayfish is inherently slow: Johnsen and Taugbøl (2008)
reported that crayfish abundance at a stone addition site took 13 years
to reach levels comparable to a reference site, and freshwater
invertebrate colonisation studies consistently show that monitoring
periods shorter than two years are often insufficient to detect
significant responses to habitat modification (Testa et al. 2011; Ruhí
et al. 2012; Pilotto et al. 2018). Following reconstruction of the
Rotorua lakefront, no kōura were observed 13 months after completion,
and only 17 were recorded after 28 months, compared to 57 removed before
construction, with slow recolonisation attributed to persistent catfish
predation pressure (Kusabs 2023). Eighteen months therefore represents a
minimum monitoring window, not a sufficient one, for detecting
...
littoral zone is the most productive zone of the lake (Devcich 1979).
Occupancy is therefore insensitive to the marginal improvement stone
piles add to the littoral zone. Abundance and biomass are better-suited
response variables for this intervention as they can continue to
increase even once sites are occupied.
...
along the depth gradient (Devcich 1979). Second, kōura activity declines
at low water temperatures (Devcich 1979), reducing the probability of
...
increases nutrient availability in the water column (Wetzel 2001), while
reduced water temperature suppresses invertebrate grazing activity
(Bonacina et al. 2023), allowing algal mats to accumulate on available
hard surfaces. The stone pile surfaces, freshly quarried and free from
biofilm at deployment, provided clean substrate for early colonisers,
and by Winter 2026 a diverse assemblage had established, including
cyanobacteria, green algae, \emph{Sinelobus stanfordi} (Richardson,
1901), Tardigrada, Oribatida, Chironomidae, Rhabdocoela, Oligochaeta,
and ciliates (\emph{Paramecium} spp. and \emph{Vorticella} spp.). Rather
than representing degradation of habitat quality, this succession is a
...
making the stone piles accessible for kōura refuge.
...
\subsection{Reference sites as a
...
winter, catfish shift to mid-water movement across the lake basin
...
eradication from a lake of this size is probably not feasible without
measures that would be ecologically catastrophic for the broader fish
community, and targeted removal in high-density areas reduces local
pressure but likely cannot eliminate the lake-wide population (Dedual
2019). Thermal stratification will intensify as the climate continues to
warm (Woolway et al. 2021; Lee et al. 2025), further compressing kōura
and expanding suitable conditions for catfish. When the primary
...
conditions (Selwood and Zimmer 2020). While freshwater management
increasingly recognises that multiple stressors interact simultaneously
(Spears et al. 2021; Orr et al. 2024), practical responses still tend to
focus on removing individual stressors. This study tested whether
structural habitat addition can buffer the combined effects of predation
and thermal compression without removing either stressor.
...
running through macrophyte beds and into deeper water, would create
corridors connecting the shallow littoral zone with deeper refugia and
potentially allow kōura to move freely between depth ranges as
conditions change. This design has not been tested but represents a
promising direction for future deployments and could additionally
suppress macrophyte growth along the corridor.
...
interventions used to produce them (Minns et al. 1996), and scaling from
individual stone pile deployment to restoration at population-relevant
extents is a central challenge in restoration ecology (Ngwenya et al.
2025). The temporal dimension of this mismatch is equally important as
continued monitoring for at least three years is needed to determine
whether the Winter 2026 decline was a one-time event and whether kōura
abundance at stone pile sites continue to build over subsequent spring
and summer seasons.
...
rank-sum test). With only 5 paired sites, these are low-power checks,
and a non-significant result indicates no obvious difference.}
...
tool. Behavioural experiments (\textbf{Chapter 2}) confirmed that kōura
respond with heightened refuge use to novel predatores than native ones.
Field observations (\textbf{Chapter 3}) identified the habitat features
that support kōura along lake shorelines, and mesocosm trials
(\textbf{Chapter 4}) showed that structure stability and complexity
matter more than material when kōura select shelter. \textbf{Chapter 5}
demonstrated that stone piles deployed along the shoreline of Lake
Rotoiti attracted kōura at densities approaching those on natural rocky
substrates. This chapter will synthesise on the findings and main
discussions of each chapter and presents two pilot studies that extend
the work in different directions. The first trialled the construction
logistics and kōura reintroduction in Lake Ōkaro. The second extended
deployment into deeper water across a depth gradient and different
monitoring methods will be discussed. Together with the main chapters,
these case studies broaden the application of the restoration approach
developed in this thesis for future deployment and monitoring.
...
the lake with people from Te Arawa Lake Trust, Tūhourangi, Ngāti
Tahu-Ngāti Whaoa, Te Mana o Ngāti Rangitihi Trust, and Bay of Plenty
Regional Council. Stones were sourced from Rainbow Quarry located on
Rainbow Mountain three km from the lake. Stones used had a size range of
70-210 mm mean 120 mm and a total of 5 m\(^{3}\) was divided over two
stone piles on the north east shore of the lake. Stone piles were placed
3 and 6 m of the shore, horizontal each 5 m long and 2 meters wide at 1
m depth. To follow dissolved oxygen and temperature development of the
stone piles and how they compare to the rest of the lake on 11 September
2024 three HOBO U26-001 Dissolved Oxygen Data Loggers (± 0.2 mg
L\(^{-1}\) DO accuracy, ± 0.2 °C temperature accuracy; 0--30 mg
L\(^{-1}\) measurement range; Onset Computer Corporation, Bourne, MA,
USA), were placed in the lake for a period of six months. Two loggers
were buried inside the stone piles and a third logger was placed outside
of the stone piles as control. In October 2024 twenty kōura sourced from
neighbouring Lake Rerewhakaaitu were released on the stone piles to
start a new population of kōura in Lake Ōkaro. Trapping and spotlighting
surveys prior to release did not find any kōura in the lake.
...
observed at the stone piles from January 2025 till June 2025 (Ian Kusabs
pers. observation). Expected is that the other kōura have spread out
trough the lake as the site with the stone piles now transformed from
sandy into milfoils (\emph{Myriophyllum propinquum}) vegetated
shoreline. The last spotlight session (July 2026) did not show any
kōura.
...
kōura before construction (10/11/2025; water temp 19 °C). The monitoring
after construction (1/05/2026; water temp 16 °C) revealed seven kōura by
spotlighting around the jetty and eleven kōura on the deeper stone piles
in front of the jetty monitored by the ROV. The second after monitoring
(11/08/2026; water temp 10 °C) revealed six kōura by spotlighting and
one on the stone pile in weed bed and one at the deeper stone pile. Most
kōura were seen at the border of the stone piles where they met with the
sandy substrate; this was expected as visual it was hard to look inside
the stone piles and kōura were observed when emerged and started
foraging. The stone pile in the macrophyte bed showed a complete block
of macrophyte growth but at the sides the macrophytes were present
densely making kōura observations difficult. The human diving did not
find any kōura (15/01/2026; water temp 21.7 °C) but noticed many bullies
around the stone piles. The second human dive (28/07/2026; water temp
11.1 °C) found again no kōura.
...
(Figure~\ref{fig-koura-structures-diy}).

\begin{figure}

\centering{

\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{images/Koura_structures_diy.png}
...
\bibitem[\citeproctext]{ref-maoridictionary2026}
(2026) \href{https://maoridictionary.co.nz/word/3157}{Māori dictionary}
...
Zealand}'s {Acclimatisation Society} 1861--1990. Canterbury University

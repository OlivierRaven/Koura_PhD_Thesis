...
accumulating nutrients, sediment, and contaminants over time
(\textbf{Bhateria2016?}). Within lakes, these stressors are unevenly
distributed as they converge most acutely in the shallow littoral zone
which is the productive interface between the terrestrial and aquatic
system (Strayer and Findlay 2010). The littoral zone is characterised by
its exposure to sunlight, which enables photosynthesis in plants and
algae, making it one of the most productive and biodiverse areas in
lakes (Vadeboncoeur et al. 2011; Geist and Hawkins 2016; Porst et al.
2019). In the shallow regions of this zone, emergent vegetation
flourishes, creating essential nurseries for numerous species (Meerhoff
and González-Sagrario 2022a). This vegetation significantly contributes
to the energy and nutrient cycles within lake food webs. Unfortunately,
...
Zanden and Vadeboncoeur 2020). Rocky littoral habitats and structurally
complex areas can function as refugia, buffering multiple species
against co-occurring threats, making their protection a conservation
priority in its own right (\textbf{Selwood2020?}). Reversing the
degradation of these productive but vulnerable littoral habitats
requires targeted interventions, though these are often complex and
resource-intensive (Palmer et al. 2005), a challenge that has driven
recent global commitments to ecosystem restoration such as reduction of
nutrient inputs by creating bufferzones at lakes inlets and landscape
connectivity (Meerhoff et al. 2022).
...
globally (\textbf{Haubrock2026?}). In Aotearoa, 140 individuals were
...
considerably deeper (\textbf{Blanchfield2026?}).
...
predation risk while retaining access to foraging opportunities
(\textbf{Selwood2020?}). Restoring structural habitat may therefore
reduce the effect of fear of living alongside a novel predator.
...
relationships in aquatic organisms ({(Fig. S1)}) (Froese 2006).
Predicted values were back-transformed with a lognormal bias correction
factor \(10^{0.5 \sigma^2}\) (Quinn and Keough 2002).
...
{[}{(Fig. S1)}{]} (Froese 2006). Predicted values were back-transformed
...
Figure~\ref{fig-descriptive-context-ch5}
...
the stone piles. The second human dive (28/07/2026; water temp \ldots{}
°C) found \ldots{} kōura.
...
(Jézéquel et al. 2023; \textbf{Jezequel2020?}), and the potential for
passive acoustic monitoring in lakes warrants exploration for kōura.

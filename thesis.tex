...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[color=white, text width=0.92\paperwidth, align=center,
    ...
    {Enhancing K\={o}ura Habitat in Invaded Lake Ecosystems};
  \node[color=white, text width=0.88\paperwidth, align=center,
        font=\fontsize{13}{18}\selectfont\itshape\sffamily]
    at ([yshift=-5cm]current page.north)
    {Conservation of Freshwater Crayfish Under Brown Bullhead Catfish Invasion in the Rotorua Te Arawa Lakes};
...
{\fontsize{13}{18}\selectfont\itshape Conservation of Freshwater Crayfish Under Brown Bullhead Catfish Invasion\\in the Rotorua Te Arawa Lakes}
...
\begin{enumerate}[label={\bfseries\arabic*.}]
  ...
  \item Structural complexity is essential for the recovery of kōura populations, when
        threatened by a non-native predator.\\
  ...
  \item Stone pile deployment is a viable and scalable tool for freshwater crayfish
...
\textit{Enhancing Kōura Habitat in Invaded Lake Ecosystems}\\[0.3em]
Olivier V. Raven\\
...
taonga (culturally treasured) species in Aotearoa New Zealand with a
rich history of harvest and trade by iwi (Māori communities). Over the
past two decades, however, kōura populations have declined by up to 91\%
in Lake Rotoiti (North Island), making traditional harvesting less
viable. This decline is driven by degraded water quality, intensified
...
coupled with multiple threats, indicates that intervention is necessary
for kōura population recovery. I hypothesised that habitat complexity
moderates predator-prey interactions, and that habitat enhancement
interventions increasing rocky refuge availability would positively
impact kōura by reducing predation risk.
...
The results of the \textbf{(1) laboratory experiment} revealed that
kōura showed greater refuge use in the presence of the novel catfish
than when exposed to the native predator, longfin eel (\emph{Anguilla
dieffenbachii}), highlighting the importance of refuge for kōura in the
presence of catfish.

The \textbf{(2) field survey} assessed habitat conditions in five lakes
using a structured study design and showed that complex shoreline
habitats consisting of rocks and riparian vegetation were the strongest
predictors of kōura presence across five lakes, consistent with the
well-documented preference of kōura for rocky substrates in stream
systems.

The \textbf{(3) mesocosm experiment} evaluated kōura preference for
different materials that could be used to enhance habitat by providing
artificial refuges. When hole sizes in habitat elements were held
constant, kōura showed no preference between wood and stone, but more
stable, heavier structures were preferred, and habitat configurations
providing refuge heterogeneity had the broadest appeal across different
kōura size classes.

To evaluate the effects of adding rocky habitat in the littoral zones, I
conducted a \textbf{(4) field experiment} by placing stone piles at five
separate locations in Lake Rotoiti. The study used a quasi-before-after
control-impact (quasi-BACI) design, collecting before-and-after data
from control, refuge addition and reference sites. The stone piles
attracted kōura at densities similar to those in natural rocky habitat,
demonstrating their potential to support kōura population recovery.
However, differences relative to bare control sites did not reach
statistical significance after 18 months. A simulation-based power
analysis suggested that longer monitoring periods are needed to detect
population-level responses.

Collectively, these findings suggest that habitat complexity is a
critical, actionable lever for kōura conservation, and that stone pile
deployment offers a scalable, low-cost approach for restoring
populations in degraded lake littoral zones. Beyond their ecological
value, these results provide practical evidence to support restoration
efforts that promote kōura recovery, helping restore traditional
...
collection, and logistical support was indispensable.

Special thanks to my friends and flatmates Dion and Josh for their
friendship. I am also very grateful to Rens, who made my time in New
Zealand richer with his stories, and who I will carry with me. Un
agradecimiento muy especial a mi amor, Lisbeth, por estar a mi lado
incluso desde tan lejos. Tot slot wil ik graag mijn ouders en broertjes
bedanken voor hun onvoorwaardelijke support en sorry voor het zo verweg
zijn. Omi en opa, jullie hebben dit niet kunnen meemaken, maar ik draag
dit ook voor jullie.
...
An interactive HTML version of this thesis, with dynamic figures,
searchable tables, and animated maps, is freely available at
\url{https://olivierraven.github.io/Koura_PhD_Thesis/}. This version is
intended to make the research more accessible and explorable beyond what
a static PDF allows. In keeping with my commitment to open science, the
full thesis and associated outputs are archived on Zenodo with a
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[color=white!80, anchor=south east,
    ...
    {K\={o}ura (\textit{Paranephrops planifrons}) caught during monitoring in the Rotorua Te Arawa Lakes.};
\end{tikzpicture}
\null
\clearpage
...
Within lakes, the shallow littoral zone is the productive interface
between the terrestrial and aquatic system where stressors converge most
acutely (Strayer and Findlay 2010). Exposure to sunlight, enables
photosynthesis in plants and algae, making the littoral zone one of the
most productive and biodiverse areas in lakes (Vadeboncoeur et al. 2011;
Geist and Hawkins 2016; Porst et al. 2019). In its shallow regions,
emergent vegetation flourishes, creating essential nurseries for
numerous species (Meerhoff and González-Sagrario 2022) and contributing
significantly to the energy and nutrient cycling within lake food webs.
Structurally complex areas in the littoral zone, including rocky
habitats, can function as refugia, buffering multiple species against
co-occurring threats, making their protection a conservation priority
(Selwood and Zimmer 2020).

Despite this ecological importance, lake shorelines are often heavily
impacted by human activities such as transforming natural shorelines
into engineered shoreline structures, the introduction of invasive
species, and pollution (Vadeboncoeur et al. 2002; Strayer and Findlay
2010). The effects of eutrophication and predation by non-native species
in the littoral zone remain relatively understudied (Vander Zanden and
Vadeboncoeur 2020). Reversing this degradation requires targeted
interventions, which are often complex and resource-intensive (Palmer et
al. 2005). This challenge has nonetheless driven recent global
commitments to ecosystem restoration, including the reduction of
nutrient inputs through buffer zones at lake inlets and the
...
gravel, or habitat units, is one of the more direct and widely applied
...
most often associated with marine environments, the same principle ---
that adding physical structure to a degraded habitat can restore the
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{images/fig-crayfish-families.png}
...
crayfish such as \emph{Astacus astacus} Linnaeus, 1758,
\emph{Austropotamobius pallipes} (Lereboullet, 1858), and \emph{A.
torrentium} are threatened by the crayfish plague pathogen
(\emph{Aphanomyces astaci} Schikora, 1906, an oomycete), which is
...
Northern kōura can be found throughout the North Island and on the west
side of the Southern Alps on the South Island
(Figure~\ref{fig-nz-distribution-maps}). Southern kōura can be found on
the eastern and southern part of the South Island and on Stewart Island.

\begin{figure}

\centering{

\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{outputs/fig-nz-distribution-maps.png}
...
rivers, wetlands, and lakes and have been described as ecosystem
engineers and keystone species in Aotearoa (Collier et al. 1997; Usio
and Townsend 2004). They are associated with structurally complex
habitats that provide physical shelter, preferring coarse gravel and
rocky substrates in both streams and lakes (Jowett et al. 2008; Kusabs
et al. 2015b). In streams, the highest abundances have been recorded on
substrates with an average particle size of 130 mm (Olsson 2008; Jowett
et al. 2008). Kōura avoid areas where dissolved oxygen levels drop below
5 mg/L and temperatures exceed 21 °C (Devcich 1979). Where suitable
natural substrates are rare, kōura can excavate tunnels or shallow
burrows to provide cover, a behaviour documented in Lake Tikitapu, where
the bottom sediment substrate permits burrowing (Pers. Comm. Nick Ling).
...
forage, with some populations known to move into the productive shallow
...
Kōura continue to be a culturally important food for Māori and are
...
and Quinn 2009; Kusabs et al. 2018). Kōura monitoring from 2005 to 2024
revealed declines of 76\% and 91\% in kōura catch per unit effort (CPUE)
in Lakes Rotorua and Rotoiti respectively
...
catfish as a novel predator compounding these pressures and accelerating
the decline (Kusabs et al. 2026a).
...
\caption{\label{fig-tau-koura}Diagrams of (A) the tau kōura, a
traditional Māori method for harvesting kōura after Hiroa (1921).
Pekapeka (drop line), punga (anchor), pōito (float), tāuhu (surface
line), tumu (post) whakaweku (fern bundles); (B) Schematic diagram of
the modern-day tau kōura. The depth and length of tau are indicative and
can be varied depending on lake bathymetry. From Kusabs et al. (2015b).}
...
\caption{\label{fig-koura-decline}Kōura CPUE in Lake Rotoiti at the
Ōkere inlet between 2005 and 2024. Kōura were caught using the tau
kōura. The dashed vertical line indicates first confirmed catfish
detection in Lake Rotoiti (2016). Adapted from Kusabs et al. (2026a).}
...
worldwide for aquaculture and as a game fish, contributing to profound
ecological and economic disruption that biological invasions cause
globally (Haubrock et al. 2025). In Aotearoa, 140 individuals were
...
kōura CPUE in Lakes Rotorua and Rotoiti (Kusabs et al. 2026a). While
...
(Kusabs et al. 2026a). Catfish habitat use varies seasonally: in lakes,
...
rocky habitats in winter when macrophytes cover and biomass typically
reach their annual minimums, and both habitat types during autumn and
spring (Barnes 1996; Barnes and Hicks 2003). Spawning occurs in nests
excavated in mud or sand, typically in shallow areas near rocks or
submerged tree trunks for protection (Scott and Crossman 1973). Nests
are roughly the size of the female, who may carry between 2,000 and
13,000 eggs depending on body size (Scott and Crossman 1973). Acoustic
tagging of catfish in Lake Rotoiti confirmed these seasonal patterns:
catfish concentrated in nearshore shallows during spring and summer,
likely seeking warmer water for feeding and reproduction, before
dispersing to mid-water offshore habitats in winter, consistent with
earlier reports of maximum depths around 17 m (Dedual 2002), rarely
exceeding 15 m depth even when the lake is considerably deeper
(Blanchfield et al. 2026).
...
naivety (Sih et al. 2010; Carthey and Banks 2014). Predator naivety can
...
\includegraphics[width=0.75\linewidth,height=\textheight,keepaspectratio]{outputs/fig-study-lakes-map.png}

}

\caption{\label{fig-study-lakes-map}Rotorua Te Arawa Lakes overview map.
Colours represent the trophic state of each lake. Data sourced from LAWA
(2025).}
...
Komiti Whakahaere, oversees the management of the taonga species in the
Te Arawa Lakes under a mahere whakahaere (Fisheries Management Plan; Te
Arawa Lakes Trust (2015)), reflecting the deep cultural and ecological
...
\toprule
Lake name & \textbackslash{}makecell[c]\{Surface\textbackslash{}\textbackslash{}area (km²)\} & \textbackslash{}makecell[c]\{Perimeter\textbackslash{}\textbackslash{}length (km)\} & \textbackslash{}makecell[c]\{Catchment\textbackslash{}\textbackslash{}area (km²)\} & \textbackslash{}makecell[c]\{Mean\textbackslash{}\textbackslash{}depth (m)\} & \textbackslash{}makecell[c]\{Max\textbackslash{}\textbackslash{}depth (m)\} & \textbackslash{}makecell[c]\{Depth\textbackslash{}\textbackslash{}ratio\} & \textbackslash{}makecell[c]\{Elevation\textbackslash{}\textbackslash{}(m)\} & \textbackslash{}makecell[c]\{Mixing\textbackslash{}\textbackslash{}regime\} & \textbackslash{}makecell[c]\{Trophic\textbackslash{}\textbackslash{}state\}\\
\midrule
...
mussel kākahi (\emph{Echyridella menziesii} (Gray, 1843)), kōaro
(\emph{Galaxias brevipinnis} Günther, 1866), bullies (toitoi;
\emph{Gobiomorphus cotidianus} McDowall, 1975), longfin eel (tuna;
\emph{Anguilla dieffenbachii} Gray, 1842), and common smelt (inanga;
\emph{Retropinna retropinna} (Richardson, 1848)). Introduced species
include brown and rainbow trout (\emph{Salmo trutta} Linnaeus, 1758,
\emph{Oncorhynchus mykiss} (Walbaum, 1792)), mosquitofish
(\emph{Gambusia affinis} (Baird \& Girard, 1853)), and goldfish
(morihana; \emph{Carassius auratus} (Linnaeus, 1758)). The lakes also
support a mix of native macrophytes and several invasive species that
have transformed the littoral zone in many lakes
(Figure~\ref{fig-rotoiti-weeds}) (Burton 2017). Current lake management
prioritises improving water quality and controlling invasive species.
This includes alum dosing (aluminium sulphate) in Lakes Rotorua,
Rotoehu, and Ōkaro to reduce phosphorus loading, mechanical and chemical
control of invasive macrophytes, and the community-led ``Catfish
Killas'' programme, which aims to reduce catfish abundance from the
lakes.
...
\includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{images/fig-rotoiti-weeds.png}

}

\caption{\label{fig-rotoiti-weeds}Photo of native and non-native
macrophyte species found in Lake Rotoiti.}
...
dissolved oxygen concentrations \textless{} 5 mg/L (Devcich 1979), this
displaces kōura from their daytime deep refuge into the shallow littoral
zone (Kusabs et al. 2026a), placing kōura in the depth range where
...
(Kusabs et al. 2026a). This means that for kōura in catfish-invaded
lakes, the period of greatest thermal stratification is also the period
of greatest predation pressure.
...
refuge becomes anoxic and unavailable for kōura (Devcich 1979; Kusabs et
al. 2026a).
...
can be quantified by estimating the proportion of each lake's bottom
area that remains ``liveable'' --- defined here as depth layers where
dissolved oxygen exceeds 5 mg/L and water temperature remains below
21°C, the known physiological limits for kōura (Devcich 1979). Across
the Rotorua Te Arawa lakes, liveable habitat varies with seasons
(Figure~\ref{fig-livable-habitat-summary}), summer declines are most
pronounced in eutrophic and mesotrophic lakes, Rotorua, Rotoiti,
Rotoehu, Rerewhakaaitu, Ōkāreka, Ōkaro, and Rotomāhana, while Rotomā,
Ōkataina and Tarawera remain almost completely habitable year-round.
Over the past \textasciitilde20 years several lakes show long term
declines in annual mean liveable habitat
(Figure~\ref{fig-livable-habitat-trends}). Full methods are provided in
the Appendix (see Appendix: Chapter 1 --- Supplementary information).
...
(\emph{Astacus astacus} Linnaeus, 1758) population density (Johnsen and
Taugbøl 2008). Structural addition can only deliver this benefit when
water quality falls within species tolerance, as when dissolved oxygen
or temperature exceeds physiological limits, species cannot persist
regardless of refuge quality.

\begin{figure}

\centering{

\includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{outputs/fig-livable-habitat-summary.png}
...
\includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{outputs/fig-livable-habitat-trends.png}
...
(significance: *** \emph{p} \textless{} 0.001, ns = not significant).
Derived from CTD cast data collected by BOPRC monthly monitoring and
monitoring buoy data LimnoTrack (Moore and McBride 2026).}
...
2026a). Although the broad drivers of decline are increasingly well
...
naivety (Sih et al. 2010), or that they would show stronger antipredator
responses to the novel catfish than to native eels, consistent with
generalised fear response (Sih et al. 2023).

Second, although the natural habitats prefferd by kōura had been
described in streams and deeper parts of lakes outside macropphyte beds,
the littoral zone features used by kōura were less understood. I
therefore monitored kōura presence at 60 shoreline sites across five of
the Rotorua Te Arawa Lakes, recording habitat features and fish species.
I expected that rocky substrates with high structural complexity would
be the primary predictor of kōura presence, consistent with stream
habitat studies (Olsson 2008; Jowett et al. 2008).
...
\caption{Research questions and publication status of each thesis
...
in kōura? & \emph{Biological Invasions} --- Revising for resubmission \\
2 & 3 --- Where do Kōura Live? & Which natural shoreline features do
kōura prefer? & \emph{Hydrobiologia} --- Published \\
3 & 4 --- The Importance of Structure & Does shelter structure or
material composition drive kōura refuge selection? & \emph{Aquatic
Conservation: Marine and Freshwater Ecosystems} --- Under review \\
4 & 5 --- Stone Piles as Kōura Habitat & Can habitat enhancement
structures provide effective habitat for kōura in Lake Rotoiti? &
\emph{Restoration Ecology} --- Under review \\
\end{longtable}
...
structural enhancement. In the next chapter, \textbf{Chapter 4}, shelter
types were designed and tested to determine kōura preference. Kōura are
known to use various materials and compositions, so for this study we
tested different configurations of wood and stone structures in mesocosm
...
research chapters are written as stand-alone manuscripts, there is some
overlap in background information and methodology.
...
leading to the development of antipredator behaviours such as increased
...
eel (\emph{Anguilla australis} Richardson, 1848) in Aotearoa (Brown
2009; MacNeil et al. 2025). Reflecting this coevolutionary history,
kōura can respond more strongly to eel kairomones than to those of
introduced non-native brown trout (\emph{Salmo trutta} Linnaeus, 1758),
even when sourced from streams where both predators were present (Shave
et al. 1994). Shave et al. (1994) suggest that kōura predator
recognition is a fixed behavioural trait shaped by coevolution. An
invasive fish species that threatens kōura is the brown bullhead catfish
(\emph{Ameiurus nebulosus} (Lesueur, 1819); hereafter catfish). Catfish
were introduced to Aotearoa in 1877, and the invasive species has since
spread to multiple lakes and rivers in the North Island (McDowall 1990;
Barnes and Hicks 2003; Dedual 2019). For example, in 2016/18, the
...
contained large populations of kōura (Francis 2019; Lee et al. 2025).
Catfish are highly tolerant of a wide range of environmental conditions
(Scott and Crossman 1973; Lee et al. 2025) and their broad gape and
opportunistic feeding behaviour enable the consumption of a wide variety
of aquatic prey (Scott and Crossman 1973; Dedual 2019). Given Aotearoa
lacks native Siluriformes, the recent and ongoing spread of catfish into
North Island waterways represents a truly novel predation threat to
which kōura may lack adequate behavioural or sensory adaptations to
respond.
...
to eels, due to naivety towards a novel predator (Carthey and Banks
2014); or 2) kōura would respond more strongly to unfamiliar catfish
cues than to the native eel, consistent with a generalised fear response
to a novel predator type (Sih et al. 2023). Further, we expected that
light regime would have an influence on shelter seeking behaviour, as
kōura, like many crayfish, are primarily nocturnal (Devcich 1979;
Johnson et al. 2014). We also predicted that kōura feeding rates would
follow the patterns hypothesized above and either be more in the
presence of catfish than eels, reflecting stronger antipredator
responses to the native predator, or reduced in the presence of the
unfamiliar invasive predator, reflecting a generalised fear response to
the novel predator. Overall, the refuge-use and feeding experiment aimed
to improve understanding of the behavioural mechanisms underlying kōura
...
study shows that kōura respond asymmetrically to native versus invasive
predator cues, with greater refuge use in catfish treatments than eel
treatments under dark conditions, with potentially far-reaching
...
that predator-induced changes in kōura behaviour may indirectly affect
...
biologically meaningful differences in behavioural responses to a novel
and native predator.
...
starved for at least three days (Hazlett 2003). At day 4, control
feeding rates were numerically higher than the two fish treatments,
though this difference was not statistically significant and the
direction of the trend reversed at day 3. Allowing for ethics and
...
experimental evidence of asymmetric behavioural responses in kōura to
catfish versus native eels, with greater refuge use under catfish
exposure in dark conditions. The heightened refuge-seeking response to
catfish likely reflects a generalised antipredator response triggered by
...
suggests that familiarity with native predators enables kōura to make
more proportionate risk assessments, although their behaviour may have
also been an antipredator strategy. Future studies should particularly
...
catfish-invaded systems (Sih et al. 2010). From a management
perspective, translocation of kōura from catfish-experienced source
populations into catchments facing imminent catfish invasion may
represent a more feasible strategy for seeding populations with
individuals capable of more adaptive responses. Although we found no
significant NCE of fish exudates on feeding behaviour, our study
suggests further investigations of non-visual predator cues on kōura
foraging behaviour is warranted. Because kōura are a keystone species
that act as ecosystem engineer, even a small increase in refuge use
driven by catfish presence could have cascading effects on sediment
dynamics, decomposition, and nutrient cycling in invaded lakes. As brown
bullhead catfish continue to spread across Aotearoa's rivers and lakes,
management strategies aimed at protecting kōura should account for the
behavioural cost of catfish NCEs alongside direct predation pressure as
an underappreciated and ecologically significant dimension to this
invasion.
...
respectively, over the past two decades (Kusabs et al. 2026a).
...
numbers and preys heavily on kōura (Francis 2019; Kusabs et al. 2026a).
...
activities (Kusabs and Quinn 2009; Kusabs et al. 2015a, 2026a). To
effectively conserve and restore populations requires an improved
understanding of where kōura occur within lakes and what habitats are
most important for sustaining healthy populations. Previous research in
stream environments has shown that kōura preferentially occupy
structurally complex habitats characterised by bank undercuts, woody
debris, leaf litter, boulders and low flow velocities (Usio and Townsend
2000; Parkyn and Collier 2004; Jowett et al. 2008; Parkyn et al. 2009).
In contrast, habitats used by kōura in lakes remains poorly understood,
with previous studies largely focussed on deeper offshore habitats
(Devcich 1979; Kusabs and Quinn 2009; Kusabs et al. 2015b). These
studies suggest that benthic substrate characteristics may be more
...
in Lakes Rotorua and Rotoiti at time of sampling (Kusabs et al. 2026a).
...
design (Stevens and Olsen 2004) executed using the spsurvey package in R
(Dumelle et al. 2023; R Core Team 2025), producing unbiased random
coordinates without enforcing fixed spacing between sites. The final
coordinates of the 12 random survey sites per lake were extracted
...
parameters included water temperature (°C), dissolved oxygen (mg/L), and
conductivity (μS/cm), measured with a YSI ProSolo meter (Pro2030
Dissolved Oxygen and Conductivity Meter, YSI Inc., Yellow Springs, OH,
USA) and pH was determined using a handheld pH meter (EC-PCTestr35,
Eutech Instruments Pte Ltd, Paisley, UK).
...
weights due to failure of scale (\emph{n} = 81) were estimated using a
log₁₀--log₁₀ length--weight regression fitted to individuals with both
measurements (\emph{n} = 240), following standard approaches for weight
length relationships in aquatic organisms
...
oxygen (mg/L), pH, specific conductivity (μS/cm), and the presence of
catfish, eels, goldfish, and common smelt. Continuous predictors were
centred and standardised prior to modelling to improve convergence and
facilitate comparison of effect sizes and were modelled as smooth terms
using thin plate regression splines (bs = `ts'), which apply additional
shrinkage to penalise overly complex relationships and can shrink smooth
terms fully to zero during selection (Wood 2017). Basis dimensions (k)
...
particles may favour adult kōura, while smaller interstitial spaces
within mixed substrates may provide refugia for juveniles, suggesting
that heterogeneous substrates support kōura across life stages. However,
mixed substrates containing both coarse and fine particles can reduce
pore space availability as smaller particles infill void spaces between
...
stable coexistence is possible (Kusabs et al. 2026a). Overall, fish
...
considered thermally stressful and may induce aestivation (Devcich 1979;
Angilletta et al. 2004; Hammond et al. 2006; Hesni et al. 2009). During
the study period, surface water temperatures in several lakes exceeded
this threshold, including a mean summer temperature of 23.15 °C in Lake
...
a limiting factor for freshwater crayfish populations in these systems.
...
predation by invasive species (Lee et al. 2025; Kusabs et al. 2026a).
Kōura are a taonga (culturally treasured) species for Māori, the
indigenous people of Aotearoa, and hold significant ecological and
cultural value in freshwater ecosystems (Kusabs and Quinn 2009; Kusabs
et al. 2015a). In their natural habitat, kōura are positively associated
with overhanging banks, coarse substrates, and woody debris (Raven et
al. 2026a; Usio and Townsend 2000; Jowett et al. 2008; Parkyn et al.
2009). Kōura have been shown to significantly increase refuge use in the
presence of predators (Raven et al. 2026b; Shave et al. 1994). Habitat
...
kōura (Kusabs et al. 2026a), enhancing habitat complexity may reduce
...
cascading consequences for freshwater ecosystems (Collier et al. 1997;
Parkyn et al. 2001). In Aotearoa New Zealand, these pressures converge
on kōura (\emph{Paranephrops planifrons} White, 1842), an endemic
...
country (Hiroa 1921; Kusabs and Quinn 2009).
...
have declined by up to 91\% over the past two decades (Kusabs et al.
2026a). This collapse has virtually ended customary harvest practices
for Te Arawa iwi (Māori tribal group) who are hunga tiaki (traditional
custodians) of the lake (Kusabs et al. 2015a, 2026a). The decline in
kōura numbers is driven by multiple interacting stressors that compound
over time in different parts of the lake (Lee et al. 2025; Kusabs et al.
2026a). The invasive brown bullhead catfish (\emph{Ameiurus nebulosus}
...
this invasive predator (Kusabs et al. 2026a).
...
Taupō, where kōura persist at greater depth even in the presence of
catfish because the lake remains oxygenated below the thermocline
(Kusabs and Taiaroa 2015; Verburg and Albert 2019). In Lake Rotoiti,
...
littoral margins (Kusabs et al. 2026a), precisely where catfish are most
active during summer (Dedual 2002; Blanchfield et al. 2026). Dense beds
of invasive macrophytes further restrict kōura movement through this
compressed zone and intensify oxygen depletion during die-off events
(Vincent et al. 1984; Hamilton et al. 2005; Kusabs and Quinn 2009). The
dual pressures of catfish predation and thermal stratification are
expected to only strengthen with predicted climate scenarios (Woolway et
al. 2021; Lee et al. 2025), making kōura habitat compression and
predation pressure progressively more severe.
...
substrates (Parkyn and Collier 2004; Jowett et al. 2008; Parkyn et al.
2009). In lake environments, benthic substrate characteristics are a
stronger predictor of kōura distribution than nutrient enrichment or
predator abundance (Kusabs et al. 2015b), and kōura are positively
associated with coarse substrates and riparian vegetation (Raven et al.
2026b). Coarse rocky substrate provides refugia from predators and
shelter during moulting (Streissl and Hödl 2002). Experimental studies
confirm that shelter availability directly reduces catfish predation on
crayfish (Adams 2007; Zhao et al. 2024), and kōura increase refuge use
in the presence of catfish compared to native predators (Raven et al.
2026a), emphasising the importance of shelter availability for kōura
...
beds of introduced macrophytes and little rocky structure. Adding rocky
substrate to soft-bottomed lake areas has been shown to significantly
increase crayfish abundance (Johnsen and Taugbøl 2008), and increasing
structural complexity in streams improves crayfish restocking success
(Huolila et al. 1997). Deploying habitat enhancement structures that add
...
1922). A substrate index, that indicates suitability for kōura, was
...
trajectory of kōura and catfish populations. The design is quasi-BACI
because only a single pre-construction monitoring round was possible.
...
2026a) and when catfish predation pressure is highest in the areas where
...
\subsection{Construction effect and statistical
...
lakefront, which is connected to Lake Rotoiti, kōura showed no
meaningful recolonisation after 28 months (Kusabs 2023). They attributed
slow recolonisation to persistent catfish predation pressure and
distance from source population, consistent with time scales observed
here. The power analysis indicates that five site pairs are insufficient
to reliably detect effects of the magnitude observed here within 18
months, establishing a minimum design threshold: future stone pile
monitoring programmes should plan for at least three years of monitoring
and expect high pre-construction occupancy, leaving little statistical
...
Kōura abundance is highest in lakes without catfish (Raven et al.
2026b), suggesting predation pressure may suppress kōura populations
well below the carrying capacity of existing habitat. If so, structural
habitat availability may not currently be the primary limiting factor,
and a weak or delayed response to habitat addition would be expected.
Equally, if kōura are already at carrying capacity of existing rocky
habitat, stone piles add new capacity that will only be filled gradually
as the population expands, which is unlikely to be detectable within 18
months. In either case, a delayed rather than absent population response
would be expected. Isolated stone pile structures may also be difficult
for kōura to locate, since distance between isolated habitat patches is
a key determinant of colonisation success (Hanski 1998). Each of these
explanations point toward a delayed, rather than absent, population
response, and continued monitoring would be the appropriate next step
rather than a reassessment of the intervention itself.

\subsection{Seasonal dynamics: the Winter 2026
...
temperatures (Devcich 1979). When lake thermal stratification breaks
down in winter, the hypolimnion re-oxygenates and deep-water habitat
becomes accessible, allowing kōura to redistribute along the depth
gradient (Devcich 1979). Reduced activity at low water temperatures
independently lowers the probability of trap capture (Devcich 1979), and
although Winter 2026 was 1.5 °C lower than Winter 2025, this difference
was consistent across all site types and therefore cannot explain why
...
on hard surfaces (Wetzel 2001; Bonacina et al. 2023). The freshly
quarried piles were free from biofilm at deployment and by Winter 2026
supported a diverse meiofaunal assemblage, indicating active succession
rather than habitat degradation; algal cover would be expected to
decline as grazer activity resumes in spring and summer. Despite the
near-zero trap catches in Winter 2026, night spotlighting at two stone
pile sites in August 2026 directly observed kōura sheltering within the
structures, confirming that low winter catch rates reflect reduced
detectability rather than abandonment. Together, these results indicate
that stone pile refuge value is inherently seasonal --- greatest in
summer and autumn, when thermal stratification compresses habitat into
the littoral zone and catfish predation peaks, and lowest in winter,
when kōura redistribute to deeper water regardless of structure type.

\subsection{Catfish: no evidence of attraction to stone
...
beds (Barnes and Hicks 2003). The single-site increase in catfish CPUE
during Summer 2026 was mirrored by an increase at reference sites and
was consistent with lake-wide seasonal redistribution into warm littoral
waters rather than any stone-pile-specific event (Blanchfield et al.
2026). Overall catfish catches remained low throughout the study
relative to targeted removal netting in Te Weta Bay, where highest
catfish densities are concentrated (Francis 2019). In autumn, catfish
shift to mid-water movement across the lake basin remaining above 15 m
depth (Blanchfield et al. 2026), reducing predation pressure on kōura in
the littoral zone. This absence of attraction is an important management
result in its own right: habitat enhancement can be targeted at a
threatened native species without inadvertently improving conditions for
its invasive predator.

\subsection{Restoration design and future
...
and alters the costs and benefits of hunting for a predator (Lennox et
al. 2025). This framework applies directly to catfish-invaded lakes,
where habitat addition offers a practical lever on that interaction, and
...
(Selwood and Zimmer 2020). In Lake Rotoiti, catfish and thermal
stratification are the two primary drivers of kōura decline, and neither
can be addressed at the lake scale. Catfish eradication is not currently
achievable, and targeted catfish removal in high density areas reduces
local pressure without eliminating the lake-wide population (Dedual
2019). Thermal stratification, meanwhile is expected to intensify under
climate warming (Woolway et al. 2021; Lee et al. 2025). Where these
...
valuable (Selwood and Zimmer 2020).
...
extinction than connected habitats (Hanski 1998), and the Winter 2026
decline is consistent with this limitation: stone piles lacked the
connectivity to deep refuge that allowed reference sites to remain
stable. Orienting future structures perpendicular to the shoreline,
extending through macrophyte beds and into deeper water, could create
corridors linking the littoral zone with deeper refugia, allowing kōura
to move more freely between depth ranges as conditions change, as they
do at reference sites. This design has not been tested but is a
promising direction for future deployments, with the addition of
potential benefit of suppressing macrophyte growth along the corridor.
...
disturbed to provide effective shelter (Parkyn and Collier 2004). This
placement trade-off warrants direct investigation in future deployments,
and standardised photography of consistent stone faces each monitoring
visit would allow fouling development to be tracked alongside changes in
kōura use.
...
them (Minns et al. 1996), and scaling from individual stone pile
deployment to habitat addition at population-relevant extents is a
central challenge in restoration ecology (Ngwenya et al. 2025).
...
continued climate warming (Woolway et al. 2021; Lee et al. 2025),
narrowing the band of habitat available to kōura and increasing, rather
than diminishing, the value of structural refugia over time.
Establishing refugia before populations decline further may be more
effective than waiting until source populations fall below critical
densities for recolonisation (Morelli et al. 2016; Kusabs et al. 2026a).
The consistent positive directional trend in occupancy, the rapid and
clearly seasonal use of the structures, and the developing biological
community on the stone pile surfaces together suggest the foundations
for a population-level response by kōura are being laid, even though
catfish showed no comparable benefit from the structures. Whether this
...
practical basis for using stone piles as a kōura habitat enhancement
tool in the Rotorua Te Arawa lakes. Behavioural laboratory experiments
(Chapter 2) tested kōura refuge use when exposed to novel catfish
predators compared to native eel predators. This demonstrated that kōura
spend more time in refuges when they are exposed to catfish than to
eels. Kōura habitat use of lake shorelines was assessed with field
observations (Chapter 3) executed at 60 locations across five lakes.
This identified that habitats comprising complex rocky substrates and
riparian vegetation support higher kōura abundance than muddy or
emergent macrophyte habitats. In mesocosm trials (Chapter 4) four
consecutive experiments were carried out to establish the preferred
material and structure of artificially introduced habitats. The results
showed that structure stability and complexity matter more than material
type when kōura select shelter. The field deployment study (Chapter 5)
deployed five stone piles along the shoreline of Lake Rotoiti and
monitored kōura response over 18 months in a BACI design. Kōura
colonised the structures rapidly, with occupancy and abundance
consistently trending positive at stone pile sites relative to controls,
though this effect did not reach statistical significance. Catfish
showed no evidence of being attracted to the stone piles.

This chapter (Chapter 6) synthesises the findings across all four
chapters and discusses their wider interpretation. Two additional field
trials, detailed in the appendices, were incorporated to extend the
findings of Chapter 3-5 into conditions not covered by the previous
chapters. These included a reintroduction attempt in Lake Ōkaro that
tested the water quality boundary of habitat enhancement (see Appendix:
Chapter 6 --- Supplementary information), and a depth-gradient
deployment in Lake Rotoiti that explored use of stone pile structures
beyond wading depth (see Appendix: Chapter 6 --- Supplementary
information).

\section{Three stressors working
together}\label{three-stressors-working-together}

Kōura decline in the Rotorua Te Arawa Lakes is driven by multiple
compounding stressors, most prominently catfish predation, thermal
stratification, and invasive macrophytes, which together operate at both
the local sub-lake scale and the broader lake scale.

The behavioural response demonstrated in Chapter 2 showed that kōura had
greater refuge use in response to the novel catfish predator than to the
native eel. This finding is consistent with prey exhibiting heightened
caution toward unfamiliar predators with which they share no
evolutionary history (Sih et al. 2023) and demonstrates that
...
sufficient to reshape how prey use habitats over space and time, and
those behavioural changes carry demographic consequences. In the context
of the Rotorua Te Arawa Lakes, this means that catfish potentially
suppress kōura populations through two mechanisms simultaneously. Direct
predation removes individuals and fear-induced behavioural change
reduces the reproductive capacity of those that survive. Even if
predation rates are reduced, population recovery under these conditions
is likely to be slow, because the behaviour suppression can persist as
long as catfish are present.

The lake-scale and sub-lake-scale patterns identified in Chapter 3
provide further evidence that kōura decline results from multiple
interacting pressures rather than catfish predation alone. Oligotrophic
lakes with no catfish had the highest overall kōura catches, while
eutrophic lakes with catfish and anoxic stratification yielded
substantially lower kōura numbers. At the sub-lake scale, structurally
complex rocky shorelines were associated with higher kōura abundance,
while excessive macrophyte cover was associated with lower densities,
which is consistent with preferred kōura habitat in streams (Usio and
Townsend 2000; Parkyn and Collier 2004; Jowett et al. 2008; Parkyn et
al. 2009). These findings show that kōura abundance is shaped by
stressors operating at both lake scale and sub-lake scale.

Habitat enhancement represents an important intervention under current
pressures. The mesocosm trials (Chapter 4) showed that kōura
preferentially select stable, crevice-rich structures, similar to the
habitat characteristics that stone piles provide in the lake, suggesting
that the positive trend in Chapter 5 reflects genuine preference rather
than incidental use. Chapter 5 showed that stone piles in Lake Rotoiti
attracted kōura densities approaching those on natural rocky substrates,
despite the ongoing presence of catfish. While high-quality refuge does
not eliminate the fear response, it provides kōura with locations where
they can shelter effectively and emerge to forage in relative safety,
remaining active and accessible to resources despite the continued
presence of catfish (Shave et al. 1994; Adams 2007; Francis 2019; Zhao
et al. 2024). In catfish-invaded lakes where predator eradication is not
feasible, habitat provision can therefore help a remnant kōura
population persist and gradually recover rather than decline towards
local extinction.

Kōura use of stone pile refuges in the littoral zone was strongly
seasonal (Chapter 5), with greatest use during summer and autumn when
stratification and catfish shoreline use simultaneously peak. During
these periods, deep-water oxygen depletion restricts access to deeper
habitats, particularly in mesotrophic and eutrophic lakes, while
increased catfish activity in the littoral zone may expose kōura to
greater predation risk, effectively compressing them into a narrower
band of suitable habitat. In winter, when stratification breaks down and
deeper waters are reoxygenated, kōura may redistribute into deeper
habitats or simply remain within existing shallow refuges once predation
and thermal pressure ease (Devcich 1979). Climate projections suggest
that this seasonal habitat constraint will intensify as surface waters
warm, stratification becomes stronger and more persistent, and
deep-water hypoxia and anoxia become more frequent and prolonged ({Jane
et al.} 2021; Woolway et al. 2021; Lee et al. 2025). Chapter 1 documents
a decline in suitable habitat for kōura over the last 20 years across
eleven lakes, calculated as the proportion of the lakebed area meeting
dissolved oxygen and temperature thresholds for kōura. For example, Lake
Ōkāreka showed a statistically significant annual decline of 0.4\% in
liveable habitat per year, indicating that the suitable habitat window
is narrowing under current conditions, not just future ones (see
Appendix: Chapter 1 --- Supplementary information).

\section{Kōura monitoring approaches}\label{koura-monitoring-approaches}

A key insight from this research is that standard passive netting, while
effective for estimating relative kōura abundance across sites, cannot
distinguish whether kōura are actively using a specific structure or are
simply present in the surrounding area. This distinction matters
directly for interpreting the Chapter 5 results: higher catches near
stone piles were taken as evidence of greater habitat use, but passive
netting alone cannot confirm structural preference. Johnsen and Taugbøl
(2008) monitored their stone addition site using both diving surveys and
baited traps over 13 years, finding a large increase in noble crayfish
abundance using both methods. More structurally complex habitat may also
introduce a systematic detection bias in the opposite direction: kōura
sheltering within stone piles may become genuinely harder to catch or
observe if they can forage on snails and other invertebrates within the
structure itself, without needing to emerge at all (Francis 2019). A
similar pattern has been reported in North American lakes containing
largemouth bass (\emph{Micropterus salmoides}) (W. Perry, pers. comm.
2017). This limitation influenced the monitoring approaches across the
thesis, from netting in Chapter 3 and 5 toward direct observation
methods in later trials (see Appendix: Chapter 6 --- Supplementary
information), where spotlighting, Remotely Operated Vehicle (ROV)
surveys, and diving allowed kōura to be observed on structures directly.

Traditional Māori harvesting methods using tau kōura with whakaweku
(bundles of bracken fern \emph{Pteridium esculentum}) have proven
effective for kōura monitoring in lakes and stream habitats (Kusabs and
Quinn 2009; Kusabs et al. 2018) but presented two specifics constraints
in this research context. In the shallow wave-exposed zone of the study
lakes, wave action destabilises the whakaweku, reducing their
effectiveness as a consistent shelter substrate. A further limitation in
the context of this thesis is that whakaweku creates habitat. Using it
to assess whether stone piles attract kōura would confound the
monitoring tool with the intervention, making it difficult to determine
whether kōura are responding to the stone pile or the whakaweku itself.

Passive netting with single-winged fyke nets and bait traps were
therefore used throughout the monitoring described in Chapters 3 and 5.
...
was found between bait types. This was expected as kōura scavenge
carcasses of dead fish without bias towards native or non-native species
(MacNeil et al. 2025). Trout as bait yielded a mean CPUE of 0.63 kōura
per trap per night (95\% CI: 0--1.42; \emph{n} = 12 trap nights) and
catfish bait 0.65 kōura per trap per night (95\% CI: 0.43--0.90;
\emph{n} = 135). Unbaited fyke nets had a notably higher CPUE of 2.55
kōura per trap per night (95\% CI: 1.89--3.31; \emph{n} = 148),
consistent with their larger net opening and longer fishing lead.
However, 24-hour passive netting provides an approximation of local
abundance rather than direct evidence of habitat use. As noted above,
trap catches cannot distinguish presence from increased use of habitat
structure. For Chapter 5, higher catches near stone piles were therefore
interpreted as indicating greater use of the structures as habitat. In
...
possible, and kōura may pass beneath the net opening entirely. At the
deep structures built in Lake Rotoiti, more active monitoring approaches
were applied including spotlighting from the jetty, ROV surveys and
human dive surveys (see Appendix: Chapter 6 --- Supplementary
information). These methods allow direct observation of kōura using the
structures and are easier to execute over depth than netting. However,
these direct methods capture only the moment of observation, and the
detection bias introduced by structural complexity means that even
direct observations may underestimate true habitat use if kōura remain
sheltered during surveys. Passive Integrated Transponder (PIT) tagging,
combined with an antenna array installed beneath or around a structure,
would allow individual kōura to be tracked continuously without
requiring their emergence or capture, resolving the detection bias
identified above. The same approach could also support mark-recapture
estimates of population size at stone pile sites, complementing its use
for tracking movement and habitat use. PIT tagging is relatively
low-cost and widely used in fish and crayfish movement studies and
represents a promising direction for confirming genuine structural
preference in future stone pile deployment (Bubb et al. 2006; Westhoff
and Sievert 2013).

Additional monitoring techniques including environmental DNA (eDNA),
remote underwater video (RUV), baited remote underwater video (BRUV),
and passive acoustic monitoring, would be valuable to develop and trial.
Comparative studies suggest that trapping, RUV, BRUV perform similarly
for crayfish detection while eDNA has failed to detect crayfish in
similar stream systems (Harwood et al. 2025, 2026). Conversely, eDNA has
detected invasive crayfish in lakes where trapping alone could not
(Dougherty et al. 2016), suggesting it may be better suited to
lake-scale presence-absence assessments than to evaluate kōura use of
specific structures. Passive acoustics offer a complementary approach as
crayfish produce distinctive sounds during movement and feeding, and
acoustic methods have shown potential for identifying crayfish behaviour
in field and laboratory settings (Buscaino et al. 2012; De Vita et al.
2023). Application in marine systems has advanced further, including
detection of spiny lobsters over great distances (Jézéquel et al. 2020,
2023); whether passive acoustic monitoring is sensitive enough to detect
kōura activity in the complex acoustic environment of a lake littoral
zone remains untested.

\section{What habitat enhancement can and cannot
fix}\label{what-habitat-enhancement-can-and-cannot-fix}

In Chapter 3, habitat surveys across the shallow, wave-exposed shoreline
of five Te Arawa Lakes showed that kōura were most consistently
associated with complex rocky habitats and riparian vegetation (Jowett
et al. 2008; Kusabs et al. 2015b). Locations where this substrate has
been lost or never existed are therefore logical candidates for stone
pile deployment. Chapter 4 confirmed that structural permanence and
complexity are the decisive factors in kōura shelter selection, and
stone piles deliver both (Streissl and Hödl 2002). In lakes where
populations are declining, stone piles can help a remnant population
persist and create habitat stepping stones that lower the cost of
dispersal between patches, keeping populations more connected while
broader lake conditions improve. Stone piles may also physically
suppress invasive macrophytes at the placement site, as demonstrated by
the stone pile at 4 m depth in the deep Rotoiti case study, though
whether this reflects sustained suppression or slow regrowth of
macrophytes remains untested. Chapter 5 demonstrates that stone piles
represent a specific type of intervention that operates differently from
stressor removal.

Unlike water quality improvement or catfish management, structural
habitat addition does not require these broader stressors to be fully
controlled first, although the magnitude and persistence of those
benefits will depend on local conditions, particularly trophic state,
the severity and duration of bottom water anoxia during summer
stratification, and catfish density. Stone piles function as a buffer
against stressors that cannot be eliminated at lake scale. Catfish
eradication would likely require broad-spectrum piscicides or complete
lake drawdown which would also kill or displace native fish species
(Dedual 2019). Future biotechnologies, including gene drives and
pathogens that target only the invasive species, could eventually
provide additional options, but these tools are still in early,
experimental stages of development (Thresher et al. 2014; Kopf et al.
2019; Teem et al. 2020), making current eradication impractical at the
Rotoiti and Rotorua scale. The expected future increase in lake water
temperature will intensify thermal stratification under continued
climate warming, which will benefit catfish more than kōura (Woolway et
al. 2021; Lee et al. 2025). When these stressors cannot be removed
habitat enhancement becomes a practical management tool whose importance
grows even as worsening conditions constrain how much benefit it can
ultimately deliver.
...
The situation in the Rotorua Te Arawa Lakes is more complex as habitat
...
in the predominant sandy littoral zone of Lake Rotoiti. The lack of
suitable habitat is therefore one compounding stressor among several:
structure cannot compensate for water that is unbreathable, nor can it
fully counteract sustained predation pressure.

Kōura recovery is bounded by a ceiling set by whichever stressor is
currently most limiting. This is consistent with the Liebig--Sprengel
``law of the minimum'': population recovery is limited by the scarcest
resource or most severe stressor, not by the average condition of the
system (Holmes et al. 2018). Where water quality is poor or catfish
predation is intense, that ceiling is low, as demonstrated by the anoxic
event in Lake Ōkaro (see Appendix: Chapter 6 --- Supplementary
information). Where conditions are already favourable the ceiling is
correspondingly higher, consistent with findings in Chapter 3 that lakes
with the best water quality, most complex habitat, and no catfish
support the highest kōura abundance. As catfish likely cannot be
eradicated at lake scale, and thermal stratification will intensify
under continued climate warming, the ceiling is unlikely to rise on its
own in lakes like Rotoiti and Rotorua. This does not make habitat
enhancement less valuable; it means structural refuge becomes more
necessary even though its maximum benefit stays limited. Habitat
enhancement should therefore be used alongside water quality and
predator management, not instead of them.

\section{Future direction}\label{future-direction}

\subsection{Scaling habitat
enhancement}\label{scaling-habitat-enhancement}
...
The positive but non-significant trend in kōura abundance suggest that
...
reveal longer-term population-level effects.

Beyond continued monitoring, scaling deployment to additional sites,
depths, and lakes would test whether the Rotoiti results are generalised
across the Te Arawa lakes. Lake Rotorua, which also has declining kōura
populations and limited natural rocky habitats, would be a logical next
...
surveys, would allow for a cross-lake comparison of the habitat
enhancement as a management tool.

\subsection{Community involvement in kōura
restoration}\label{community-involvement-in-kux14dura-restoration}
...
provide effective shelter for kōura (Kusabs et al. 2026b). Some
residents around the Rotorua Te Arawa Lakes have already independently
built kōura habitat structures using similar principles
(Figure~\ref{fig-koura-structures-diy}), demonstrating both the appeal
and feasibility of community-led habitat enhancement. Future community
contributions would benefit from using natural materials that will not
degrade over time, and from maximising crevice diversity, as the more
hiding places the structures create, the wider the range of kōura life
stages it can support. Stones in the 100--300 mm range, as used in this
study, provide abundant shelter space when stacked together, are simple
to deploy and persist in the lake without introducing pollutants.
...
local residents. Left: Kōura pipes by Mark Thomson at Lake Rotoiti.
Right: Kōura wheels by Mark Robinson at Lake Tarawera.}

\end{figure}%

\subsection{Kōura restoration in a Te Arawa
context}\label{kux14dura-restoration-in-a-te-arawa-context}

Kōura are taonga, a treasured species with deep cultural significance
for Te Arawa iwi. The decline of kōura observed in the lakes (Kusabs et
al. 2026a) is not only an ecological loss but a cultural one. Increasing
shelter availability may attract kōura and support population recovery,
with potential benefits for cultural practices. Localised kōura
harvesting currently occurs at Cherry Bay (Ōkahuroroa Bay) in Lake
Rotoiti where regular monitoring using the tau kōura (and whakaweku) in
conjunction with regular aquatic weed spraying and catfish netting has
potentially already created a degree of structural complexity in the
bay. This suggests a model for cultural kōura restoration in Lake
Rotoiti: identifying areas with favourable lake bathymetry, maintaining
regular spraying of aquatic weeds and active catfish removal, and
creating habitat using whakaweku, tau kōura, and potentially stone piles
to establish dedicated kōura reserves within in the lake that could
support renewed cultural harvest activity. This is a suggestion for
future research and management to consider with Te Arawa iwi and hapu.

The evidence in this thesis has direct implications for the restoration
of cultural kōura harvest in Lake Rotoiti. Given the compounding effects
of multiple stressors, and the expectation that climate change and
invasive species pressure will both persist, kōura are likely to remain
present in these lakes, but lake-wide populations are unlikely to reach
the abundance historically required for cultural harvest while catfish
predation remains. Catfish and kōura are likely already setting into a
new predator-prey equilibrium in lakes where sustained, catfish control
is not feasible. In this context, management priorities may be better
directed toward protecting kōura populations that remain strong in lakes
without catfish, like Rotomā, Ōkataina, Ōkāreka, and Tarawera, by
...
Rather than a single outcome, kōura recovery toward cultural harvest
abundance can be understood as a staged process. The first step is to
prevent localised extinction. Findings from this thesis suggest that
rocky habitat or stone piles are a useful tool for sustaining remnant
kōura populations as the lake warms and habitat compression intensifies.
Stabilising the decline is a necessary foundation before broader
recovery becomes possible. The second step is reducing nutrient loading
to reverse lake eutrophication and unlock deep-water habitat during
summer stratification. Lake Taupō illustrates what is possible when
water quality is not limiting, as sixty years of catchment-scale
management have kept the lake oligotrophic with deep waters remaining
oxygenated through summer, giving kōura a place to coexist in the
presence of catfish (West 2026). To achieve this in already eutrophic
lakes such as Rotorua and Rotoiti would require active reversal of
existing nutrient loading.

\section{Conclusion}\label{conclusion-1}

Kōura populations in some Rotorua Te Arawa Lakes have declined by
76-91\% since 2003. Freshwater species decline is rarely driven by a
single stressor, and kōura in these lakes face several acting
simultaneously: predation and fear-induced behavioural suppression
caused by catfish; thermal stratification, which compresses suitable
habitat into the shallow littoral zone, precisely where catfish
predation pressure is greatest; and invasive macrophytes, which further
constrict the habitat available to kōura. This thesis investigated
whether, within this compounding-stressor context, habitat enhancement
could provide a practical means of supporting kōura recovery.

The findings of this thesis are best understood through the concept of a
stressor ``ceiling'' on recovery: kōura population recovery is bounded
not by the average condition of a lake but by whichever stressor is
currently most limiting. Eutrophication acts as something of a master
stressor in this system: reducing nitrogen and phosphorus loading would
also ease the macrophyte and hypoxia pressures. Habitat enhancement
cannot fix eutrophication; that requires action at the catchment scale,
which is fundamentally a political and economic choice rather than an
ecological one.

Habitat enhancement alone is unlikely to restore lake-wide kōura
populations to the abundance needed for cultural harvest while
eutrophication and catfish predation persist. What this thesis shows is
that structural habitat enhancement can be used as a tool to reduce the
risk of localised extinction, by providing refuge to mediate the
predation pressure. Bringing kōura populations back to the abundance
needed for cultural harvest will require action on those wider stressors
too, particularly nutrient loading and invasive macrophyte spread. Until
then, habitat enhancement remains a practical step that lake managers
can take now.
...
nebulosus}}) found at {Ōkawa Bay, Lake Rotoiti}. Centre for
Biodiversity; Ecology Research, University of Waikato, Hamilton, New
Zealand
...
Blanchfield PJ, Rodrigues TH, MacNeil C, et al (2026) Invading brown
bullhead catfish ({\emph{Ameiurus nebulosus}}) show thermal niche
rigidity and benthic niche plasticity: Implications for management.
Biological Invasions 28:205.
...
Brooks M, Bolker B, Kristensen K, et al (2017) {glmmTMB}: Generalized
...
crayfish (kōura, {\emph{Paranephrops planifrons}}) in the lower {North
Island}, {New Zealand}}. Master's thesis, Massey University

\bibitem[\citeproctext]{ref-Bubb2006}
Bubb DH, Thom TJ, Lucas MC (2006) Movement patterns of the invasive
signal crayfish determined by {PIT} telemetry. Canadian Journal of
Zoology 84:1202--1209. \url{https://doi.org/10.1139/z06-100}
...
Burton T (2017) Lake weed and the {Rotorua Te Arawa Lakes} then and now.
\url{https://researchcommons.waikato.ac.nz/server/api/core/bitstreams/ff0cbe45-8f02-4ea7-9118-4343a7869980/content}

\bibitem[\citeproctext]{ref-Buscaino2012}
Buscaino G, Filiciotto F, Buffa G, et al (2012) The underwater acoustic
activities of the red swamp crayfish {\emph{Procambarus clarkii}}. The
Journal of the Acoustical Society of America 132:1792--1798.
\url{https://doi.org/10.1121/1.4742744}
...
behavior of the invasive freshwater crayfish {\emph{Cherax destructor}}
({Clark}, 1936). Journal of Marine Science and Engineering 11:1147.
...
({eDNA}) detects the invasive rusty crayfish {\emph{Orconectes
rusticus}} at low abundances. Journal of Applied Ecology 53:722--732.
\url{https://doi.org/10.1111/1365-2664.12621}
...
Gabry J, Češnovar R, Johnson A, Bronder S (2025) {cmdstanr}: {R}
interface to '{CmdStan}'. \url{https://mc-stan.org/cmdstanr/}
...
Restoration Ecology 27:S1--S46. \url{https://doi.org/10.1111/rec.13035}
...
modeling to support considerations of {Ōhau} channel diversion from
...
{Hartig F, Lohse L, leite M de S} (2024) {DHARMa}: Residual diagnostics
for hierarchical (multi-level / mixed) regression models.
...
signal crayfish ({\emph{Pacifastacus leniusculus}}). River Research and
Applications. \url{https://doi.org/10.1002/rra.70167}
...
crayfish {\emph{Pontastacus leptodactylus}} in a freshwater reservoir.
...
Henare M (2008) Te mahi kai --- food production economics: Calendar of
work. In: Te Ara --- the Encyclopedia of {New Zealand}.
...
\bibitem[\citeproctext]{ref-Holmes2018}
Holmes R, Matthaei C, Gabrielsson R, et al (2018) A decision support
system to diagnose factors limiting stream trout fisheries. River
Research and Applications 34:816--823.
\url{https://doi.org/10.1002/rra.3292}
...
nutrient removal performance of the {Lake Ōkaro} constructed wetland.
...
({\emph{Panulirus argus}}). The Journal of the Acoustical Society of
America 153:529--537. \url{https://doi.org/10.1121/10.0016898}
...
Kopf RK, Boutier M, Finlayson CM, et al (2019) Biocontrol in
{Australia}: {Can} a carp herpesvirus ({CyHV-3}) deliver safe and
effective ecological restoration? Biological Invasions 21:1857--1870.
...
kōura and kākahi. Kusabs \& Associates Ltd, Rotorua, New Zealand

\bibitem[\citeproctext]{ref-Kusabs2017}
Kusabs IAK (2017) {Te Arawa Lakes Kōura Monitoring Programme ---
Rerewhakaaitu \& Ōkaro. 2016--2017}. Bay of Plenty Regional Council

\bibitem[\citeproctext]{ref-Kusabs2026}
Kusabs IAK, Duggan IC, Bruere AC, et al (2026a) Invasive catfish linked
...
Kusabs IAK, Hicks BJ, Quinn JM, et al (2018) Evaluation of a traditional
{Māori} harvesting method for sampling kōura (freshwater crayfish,
{\emph{Paranephrops planifrons}}) and toi toi (bully,
{\emph{Gobiomorphus}} spp.) populations in two {New Zealand} streams.
New Zealand Journal of Marine and Freshwater Research 52:603--625.
...
\bibitem[\citeproctext]{ref-Kusabs2026habitat}
Kusabs I, Holmes R, Doehring K (2026b) Creating habitat for kōura in
lakes and streams: {Guidance} for habitat enhancement and infrastructure
design. IKA Ltd, Rotorua, New Zealand
...
LAWA (2024) Lake {Ōkaro}.
\url{https://www.lawa.org.nz/explore-data/bay-of-plenty-region/lakes/lake-okaro}.
...
Lenth RV, Piaskowski J (2017) {emmeans}: Estimated marginal means, aka
least-squares means. \url{https://CRAN.R-project.org/package=emmeans}

\bibitem[\citeproctext]{ref-Lenth2026}
Lenth RV, Piaskowski J, Banfai B, et al (2026) {emmeans}: Estimated
...
and Wildlife Agencies 62:183--188
...
Ecosystem Model Ensemble Package}.
...
Morris B (2024) World building: The story of kōura. In: New Zealand
Geographic.
\url{https://www.nzgeo.com/stories/world-building-the-story-of-koura/}
...
Parkyn SM, Kusabs IAK (2007) Taonga and mahinga kai species of the {Te
...
as a management tool for internal nutrient loads in {Lake Ōkaro}, {New
Zealand}. New Zealand Journal of Marine and Freshwater Research
...
Ryan P (2009) Eels \textbar{} {Te Ara Encyclopedia of New Zealand}.
\url{https://teara.govt.nz/en/eels}. Accessed 1 Mar 2009
...
United Nations Environment Programme (2022) What you need to know about
the global resolution on sustainable lake management.
\url{https://www.unep.org/news-and-stories/story/what-you-need-know-about-global-resolution-sustainable-lake-management}.
...
\bibitem[\citeproctext]{ref-West2026}
West J (2026) The quality of clarity: Lessons from the sixty-year
struggle to maintain the purity of {Lake Taupō}. Kōtuitui: New Zealand
Journal of Social Sciences Online 21:e70031.
\url{https://doi.org/10.1002/kot2.70031}
...
\bibitem[\citeproctext]{ref-Westhoff2013}
Westhoff JT, Sievert NA (2013) Mortality and growth of crayfish
internally tagged with {PIT} tags. North American Journal of Fisheries
Management 33:878--881.
\url{https://doi.org/10.1080/02755947.2013.815669}
...
information}\label{chapter-1-supplementary-information}
\addcontentsline{toc}{section}{Chapter 1 --- Supplementary information}

\subsection*{Liveable habitat analysis: methods and
results}\label{liveable-habitat-analysis-methods-and-results}
\addcontentsline{toc}{subsection}{Liveable habitat analysis: methods and
results}

Liveable habitat was estimated for eleven of the twelve Rotorua Te Arawa
Lakes from 2003--2026 to quantify the proportion of each lake's bottom
area simultaneously meeting dissolved oxygen and temperature thresholds
suitable for kōura. This section describes the data sources, calculation
method, and statistical approach used to assess seasonal patterns and
long-term trends in liveable habitat. Results are summarised in
Table~\ref{tbl-s1-liveable-trends} and visualised in
Figure~\ref{fig-livable-habitat-summary} and
Figure~\ref{fig-livable-habitat-trends} in the main text.

\subsection{Data}\label{data}

Monthly water column profiles were obtained from Bay of Plenty Regional
Council (BOPRC) as part of their routine lake monitoring programme.
Profiles were collected using a conductivity, temperature, and depth
(CTD) instrument, which records water temperature (°C) and dissolved
oxygen concentration (mg/L) at 1 m depth intervals from the surface to
near the lake floor. Additional high-frequency depth-resolved profiles
were obtained from LimnoTrack monitoring buoys deployed in lakes
Rotorua, Rotoiti, Rotoehu, Ōkataina, Ōkāreka, Tarawera, Ōkaro and
Rerewhakaaitu (Moore and McBride 2026), which record temperature and
dissolved oxygen continuously throughout the water column. Monthly cast
and buoy profile data were pooled as individual profile observations.
For annual and seasonal mean calculations, all profiles from a given
lake and year (or season) were averaged, regardless of source. This
means that in lakes with continues buoy deployment, the annual mean is
computed from a substantially larger number of profiles than in
cast-only lakes, making the precision of the estimate differ between
lakes and across periods within lakes. The practical effect of pooling
both sources is that the annual means in buoy lakes are more heavily
weighted toward buoy measurements, this increases temporal resolution
but introduces differences in sampling design across the dataset that
should be considered when comparing trends between lakes.

\subsection{Liveable habitat
calculation}\label{liveable-habitat-calculation}

A depth layer was classified as liveable for kōura if dissolved oxygen
exceeded 5 mg/L and water temperature remained below 21 °C,
corresponding to the lower oxygen tolerance and upper thermal tolerance
limits for \emph{Paranephrops planifrons} established by Devcich (1979).
For each profile, qualifying depth layers were summed and weighted by
their proportional contribution to total lake area, using lake-specific
bathymetric hypsographs. This yields a liveable habitat percentage for
each profile: the proportion of the total lake bottom area that
simultaneously meets both thresholds. A value of 100\% indicates the
entire lake floor is accessible to kōura; a value of 0\% indicates
complete habitat loss due to anoxia or thermal stress.

\subsection{Trend analysis}\label{trend-analysis}

To assess long-term change, annual mean liveable habitat was calculated
per lake by averaging all profile measurements within each season year,
defined as the calendar year with December assigned to the following
year so that the Southern Hemisphere summer (December--February) is kept
within a single year group. Trends were estimated using ordinary
least-squares (OLS) linear regression of annual mean liveable habitat
against year, fitted separately for each lake. To assess whether trends
differed among seasons, seasonal mean liveable habitat was also
calculated per lake per season, and OLS regression was applied
separately to each lake × season combination. Estimated slopes
(percentage points per year), standard errors, and p-values for all
annual and seasonal models are reported in
Table~\ref{tbl-s1-liveable-trends}

\begingroup\fontsize{8}{10}\selectfont

\begin{longtable}[t]{llrrrll}

\caption{\label{tbl-s1-liveable-trends}OLS regression slopes for annual
and seasonal mean liveable habitat per lake (Cast and buoy CTD profiles
combined, 2003--2026).}

\tabularnewline

\toprule
Lake & Season & Slope (\% per year) & SE & p-value & Sig. & Direction\\
\midrule
\endfirsthead
...
\bottomrule
\endlastfoot
\cellcolor{gray!8}{Rotorua} & \cellcolor{gray!8}{Annual} & \cellcolor{gray!8}{-0.484} & \cellcolor{gray!8}{0.249} & \cellcolor{gray!8}{6.47e-02} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{decreasing}\\
Rotorua & Summer & -1.112 & 0.782 & 1.70e-01 & ns & decreasing\\
\cellcolor{gray!8}{Rotorua} & \cellcolor{gray!8}{Autumn} & \cellcolor{gray!8}{-0.260} & \cellcolor{gray!8}{0.182} & \cellcolor{gray!8}{1.68e-01} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{decreasing}\\
Rotorua & Winter & -0.010 & 0.020 & 6.21e-01 & ns & decreasing\\
\cellcolor{gray!8}{Rotorua} & \cellcolor{gray!8}{Spring} & \cellcolor{gray!8}{-0.512} & \cellcolor{gray!8}{0.362} & \cellcolor{gray!8}{1.73e-01} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{decreasing}\\
\addlinespace
Rotoiti & Annual & -0.306 & 0.268 & 2.66e-01 & ns & decreasing\\
\cellcolor{gray!8}{Rotoiti} & \cellcolor{gray!8}{Summer} & \cellcolor{gray!8}{-0.283} & \cellcolor{gray!8}{0.577} & \cellcolor{gray!8}{6.29e-01} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{decreasing}\\
Rotoiti & Autumn & -0.195 & 0.389 & 6.22e-01 & ns & decreasing\\
\cellcolor{gray!8}{Rotoiti} & \cellcolor{gray!8}{Winter} & \cellcolor{gray!8}{-0.264} & \cellcolor{gray!8}{0.215} & \cellcolor{gray!8}{2.33e-01} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{decreasing}\\
Rotoiti & Spring & -0.046 & 0.027 & 1.09e-01 & ns & decreasing\\
\addlinespace
\cellcolor{gray!8}{Rotoehu} & \cellcolor{gray!8}{Annual} & \cellcolor{gray!8}{-0.290} & \cellcolor{gray!8}{0.114} & \cellcolor{gray!8}{1.81e-02} & \cellcolor{gray!8}{*} & \cellcolor{gray!8}{decreasing}\\
Rotoehu & Summer & -0.636 & 0.392 & 1.20e-01 & ns & decreasing\\
\cellcolor{gray!8}{Rotoehu} & \cellcolor{gray!8}{Autumn} & \cellcolor{gray!8}{-0.125} & \cellcolor{gray!8}{0.085} & \cellcolor{gray!8}{1.58e-01} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{decreasing}\\
Rotoehu & Winter & 0.000 & 0.000 & 9.73e-02 & ns & decreasing\\
\cellcolor{gray!8}{Rotoehu} & \cellcolor{gray!8}{Spring} & \cellcolor{gray!8}{-0.130} & \cellcolor{gray!8}{0.057} & \cellcolor{gray!8}{3.35e-02} & \cellcolor{gray!8}{*} & \cellcolor{gray!8}{decreasing}\\
\addlinespace
Rotomā & Annual & -0.334 & 0.102 & 4.35e-03 & ** & decreasing\\
\cellcolor{gray!8}{Rotomā} & \cellcolor{gray!8}{Summer} & \cellcolor{gray!8}{-0.532} & \cellcolor{gray!8}{0.223} & \cellcolor{gray!8}{2.88e-02} & \cellcolor{gray!8}{*} & \cellcolor{gray!8}{decreasing}\\
Rotomā & Autumn & -0.725 & 0.276 & 1.76e-02 & * & decreasing\\
\cellcolor{gray!8}{Rotomā} & \cellcolor{gray!8}{Winter} & \cellcolor{gray!8}{-0.095} & \cellcolor{gray!8}{0.187} & \cellcolor{gray!8}{6.19e-01} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{decreasing}\\
Rotomā & Spring & 0.000 & 0.000 & 1.01e-01 & ns & increasing\\
\addlinespace
\cellcolor{gray!8}{Ōkataina} & \cellcolor{gray!8}{Annual} & \cellcolor{gray!8}{0.081} & \cellcolor{gray!8}{0.151} & \cellcolor{gray!8}{5.95e-01} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{increasing}\\
Ōkataina & Summer & 0.035 & 0.298 & 9.09e-01 & ns & increasing\\
\cellcolor{gray!8}{Ōkataina} & \cellcolor{gray!8}{Autumn} & \cellcolor{gray!8}{0.336} & \cellcolor{gray!8}{0.310} & \cellcolor{gray!8}{2.91e-01} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{increasing}\\
Ōkataina & Winter & 0.232 & 0.296 & 4.43e-01 & ns & increasing\\
\cellcolor{gray!8}{Ōkataina} & \cellcolor{gray!8}{Spring} & \cellcolor{gray!8}{-0.022} & \cellcolor{gray!8}{0.017} & \cellcolor{gray!8}{2.02e-01} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{decreasing}\\
\addlinespace
Ōkāreka & Annual & -0.407 & 0.170 & 2.59e-02 & * & decreasing\\
\cellcolor{gray!8}{Ōkāreka} & \cellcolor{gray!8}{Summer} & \cellcolor{gray!8}{-1.297} & \cellcolor{gray!8}{0.268} & \cellcolor{gray!8}{8.57e-05} & \cellcolor{gray!8}{***} & \cellcolor{gray!8}{decreasing}\\
Ōkāreka & Autumn & -0.139 & 0.127 & 2.86e-01 & ns & decreasing\\
\cellcolor{gray!8}{Ōkāreka} & \cellcolor{gray!8}{Winter} & \cellcolor{gray!8}{-0.094} & \cellcolor{gray!8}{0.066} & \cellcolor{gray!8}{1.70e-01} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{decreasing}\\
Ōkāreka & Spring & -0.482 & 0.142 & 2.68e-03 & ** & decreasing\\
\addlinespace
\cellcolor{gray!8}{Tikitapu} & \cellcolor{gray!8}{Annual} & \cellcolor{gray!8}{-0.255} & \cellcolor{gray!8}{0.115} & \cellcolor{gray!8}{3.92e-02} & \cellcolor{gray!8}{*} & \cellcolor{gray!8}{decreasing}\\
Tikitapu & Summer & -0.452 & 0.265 & 1.06e-01 & ns & decreasing\\
\cellcolor{gray!8}{Tikitapu} & \cellcolor{gray!8}{Autumn} & \cellcolor{gray!8}{-0.145} & \cellcolor{gray!8}{0.205} & \cellcolor{gray!8}{4.90e-01} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{decreasing}\\
Tikitapu & Winter & -0.070 & 0.032 & 4.11e-02 & * & decreasing\\
\cellcolor{gray!8}{Tikitapu} & \cellcolor{gray!8}{Spring} & \cellcolor{gray!8}{-0.230} & \cellcolor{gray!8}{0.140} & \cellcolor{gray!8}{1.20e-01} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{decreasing}\\
\addlinespace
Tarawera & Annual & -0.025 & 0.025 & 3.34e-01 & ns & decreasing\\
\cellcolor{gray!8}{Tarawera} & \cellcolor{gray!8}{Summer} & \cellcolor{gray!8}{-0.213} & \cellcolor{gray!8}{0.207} & \cellcolor{gray!8}{3.14e-01} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{decreasing}\\
Tarawera & Autumn & -0.032 & 0.025 & 2.24e-01 & ns & decreasing\\
\cellcolor{gray!8}{Tarawera} & \cellcolor{gray!8}{Winter} & \cellcolor{gray!8}{-0.027} & \cellcolor{gray!8}{0.085} & \cellcolor{gray!8}{7.51e-01} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{decreasing}\\
Tarawera & Spring & -0.007 & 0.008 & 3.78e-01 & ns & decreasing\\
\addlinespace
\cellcolor{gray!8}{Rotomāhana} & \cellcolor{gray!8}{Annual} & \cellcolor{gray!8}{-0.870} & \cellcolor{gray!8}{0.223} & \cellcolor{gray!8}{1.02e-03} & \cellcolor{gray!8}{**} & \cellcolor{gray!8}{decreasing}\\
Rotomāhana & Summer & -0.593 & 0.324 & 8.52e-02 & ns & decreasing\\
\cellcolor{gray!8}{Rotomāhana} & \cellcolor{gray!8}{Autumn} & \cellcolor{gray!8}{-2.721} & \cellcolor{gray!8}{0.545} & \cellcolor{gray!8}{1.12e-04} & \cellcolor{gray!8}{***} & \cellcolor{gray!8}{decreasing}\\
Rotomāhana & Winter & -0.066 & 0.050 & 2.00e-01 & ns & decreasing\\
\cellcolor{gray!8}{Rotomāhana} & \cellcolor{gray!8}{Spring} & \cellcolor{gray!8}{-0.133} & \cellcolor{gray!8}{0.072} & \cellcolor{gray!8}{8.13e-02} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{decreasing}\\
\addlinespace
Ōkaro & Annual & 0.194 & 0.160 & 2.38e-01 & ns & increasing\\
\cellcolor{gray!8}{Ōkaro} & \cellcolor{gray!8}{Summer} & \cellcolor{gray!8}{0.142} & \cellcolor{gray!8}{0.346} & \cellcolor{gray!8}{6.85e-01} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{increasing}\\
Ōkaro & Autumn & 0.616 & 0.233 & 1.53e-02 & * & increasing\\
\cellcolor{gray!8}{Ōkaro} & \cellcolor{gray!8}{Winter} & \cellcolor{gray!8}{-0.086} & \cellcolor{gray!8}{0.272} & \cellcolor{gray!8}{7.55e-01} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{decreasing}\\
Ōkaro & Spring & 0.138 & 0.253 & 5.92e-01 & ns & increasing\\
\addlinespace
\cellcolor{gray!8}{Rerewhakaaitu} & \cellcolor{gray!8}{Annual} & \cellcolor{gray!8}{-0.406} & \cellcolor{gray!8}{0.207} & \cellcolor{gray!8}{6.32e-02} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{decreasing}\\
Rerewhakaaitu & Summer & -0.838 & 0.621 & 1.91e-01 & ns & decreasing\\
\cellcolor{gray!8}{Rerewhakaaitu} & \cellcolor{gray!8}{Autumn} & \cellcolor{gray!8}{-0.203} & \cellcolor{gray!8}{0.200} & \cellcolor{gray!8}{3.21e-01} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{decreasing}\\
Rerewhakaaitu & Winter & 0.000 & 0.000 & 3.59e-01 & ns & decreasing\\
\cellcolor{gray!8}{Rerewhakaaitu} & \cellcolor{gray!8}{Spring} & \cellcolor{gray!8}{-0.255} & \cellcolor{gray!8}{0.275} & \cellcolor{gray!8}{3.64e-01} & \cellcolor{gray!8}{ns} & \cellcolor{gray!8}{decreasing}\\*
...
both length and weight measurements (\emph{n} = 240) and used to
estimate missing weights (\emph{n} = 81). Predicted values were
back-transformed using a lognormal bias correction factor. The fitted
regression equation is shown on the plot.}
...
values at individual sites (\emph{n} = 60 for occurrence; \emph{n} = 33
for CPUE and BPUE). Points are jittered slightly for occurrence data to
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{outputs/fig-lake-conditions.png}
...
M1aac & RQ1 & Catfish & abundance & treatment & before & Site type detailStone pile & -0.693 & 1.535 & -0.452 & 0.652 & 0.783 & -3.701 & 2.315\\
...
M1abc & RQ1 & Catfish & biomass & treatment & before & Site type detailStone pile & -5.100 & 3.107 & -1.641 & 0.101 & 0.403 & -11.190 & 0.990\\
...
\addlinespace
M1aak & RQ1 & Kōura & abundance & treatment & before & Site type detailStone pile & 0.288 & 1.044 & 0.276 & 0.783 & 0.783 & -1.759 & 2.334\\
...
M1abk & RQ1 & Kōura & biomass & treatment & before & Site type detailStone pile & 1.044 & 0.977 & 1.068 & 0.286 & 0.571 & -0.872 & 2.959\\
...
M1bac & RQ1 & Catfish & abundance & reference & before & Site type detailReference 2 & -1.655 & 0.536 & -3.087 & 0.002 & 0.004 & -2.706 & -0.604\\
\addlinespace
...
\addlinespace
M1bak & RQ1 & Kōura & abundance & reference & before & Site type detailReference 2 & 0.031 & 0.778 & 0.040 & 0.968 & 0.968 & -1.494 & 1.557\\
...
M1bbk & RQ1 & Kōura & biomass & reference & before & Site type detailReference 2 & -0.041 & 0.681 & -0.061 & 0.952 & 0.968 & -1.375 & 1.293\\
\cellcolor{gray!8}{M2aac} & \cellcolor{gray!8}{RQ2a} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{abundance} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{full} & \cellcolor{gray!8}{(Intercept)} & \cellcolor{gray!8}{-3.976} & \cellcolor{gray!8}{1.631} & \cellcolor{gray!8}{-2.438} & \cellcolor{gray!8}{0.015} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-7.173} & \cellcolor{gray!8}{-0.780}\\
M2aac & RQ2a & Catfish & abundance & vs control & full & PeriodAfter & 0.673 & 1.521 & 0.442 & 0.658 & NA & -2.308 & 3.654\\
\addlinespace
\cellcolor{gray!8}{M2aac} & \cellcolor{gray!8}{RQ2a} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{abundance} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{full} & \cellcolor{gray!8}{siteStone pile} & \cellcolor{gray!8}{-0.639} & \cellcolor{gray!8}{1.762} & \cellcolor{gray!8}{-0.362} & \cellcolor{gray!8}{0.717} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-4.093} & \cellcolor{gray!8}{2.816}\\
M2aac & RQ2a & Catfish & abundance & vs control & full & monitoring int & -0.294 & 0.344 & -0.853 & 0.394 & NA & -0.968 & 0.381\\
\cellcolor{gray!8}{M2aac} & \cellcolor{gray!8}{RQ2a} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{abundance} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{full} & \cellcolor{gray!8}{fetch z} & \cellcolor{gray!8}{-1.194} & \cellcolor{gray!8}{1.077} & \cellcolor{gray!8}{-1.109} & \cellcolor{gray!8}{0.267} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-3.305} & \cellcolor{gray!8}{0.916}\\
M2aac & RQ2a & Catfish & abundance & vs control & full & PeriodAfter:siteStone pile & 2.002 & 1.973 & 1.015 & 0.310 & 0.858 & -1.864 & 5.869\\
\cellcolor{gray!8}{M2abc} & \cellcolor{gray!8}{RQ2a} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{biomass} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{full} & \cellcolor{gray!8}{(Intercept)} & \cellcolor{gray!8}{0.202} & \cellcolor{gray!8}{4.319} & \cellcolor{gray!8}{0.047} & \cellcolor{gray!8}{0.963} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-8.262} & \cellcolor{gray!8}{8.667}\\
\addlinespace
M2abc & RQ2a & Catfish & biomass & vs control & full & PeriodAfter & -0.340 & 2.404 & -0.141 & 0.888 & NA & -5.052 & 4.372\\
\cellcolor{gray!8}{M2abc} & \cellcolor{gray!8}{RQ2a} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{biomass} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{full} & \cellcolor{gray!8}{siteStone pile} & \cellcolor{gray!8}{-5.574} & \cellcolor{gray!8}{7.158} & \cellcolor{gray!8}{-0.779} & \cellcolor{gray!8}{0.436} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-19.604} & \cellcolor{gray!8}{8.456}\\
M2abc & RQ2a & Catfish & biomass & vs control & full & monitoring int & -0.381 & 0.523 & -0.728 & 0.466 & NA & -1.406 & 0.644\\
\cellcolor{gray!8}{M2abc} & \cellcolor{gray!8}{RQ2a} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{biomass} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{full} & \cellcolor{gray!8}{fetch z} & \cellcolor{gray!8}{-1.675} & \cellcolor{gray!8}{2.438} & \cellcolor{gray!8}{-0.687} & \cellcolor{gray!8}{0.492} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-6.454} & \cellcolor{gray!8}{3.103}\\
M2abc & RQ2a & Catfish & biomass & vs control & full & PeriodAfter:siteStone pile & 5.436 & 5.592 & 0.972 & 0.331 & 0.858 & -5.524 & 16.396\\
\addlinespace
\cellcolor{gray!8}{M2aoc} & \cellcolor{gray!8}{RQ2a} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{occupancy} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{full} & \cellcolor{gray!8}{(Intercept)} & \cellcolor{gray!8}{-2.185} & \cellcolor{gray!8}{1.887} & \cellcolor{gray!8}{-1.158} & \cellcolor{gray!8}{0.247} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-5.883} & \cellcolor{gray!8}{1.513}\\
M2aoc & RQ2a & Catfish & occupancy & vs control & full & PeriodAfter & -0.161 & 1.765 & -0.091 & 0.927 & NA & -3.621 & 3.299\\
\cellcolor{gray!8}{M2aoc} & \cellcolor{gray!8}{RQ2a} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{occupancy} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{full} & \cellcolor{gray!8}{siteStone pile} & \cellcolor{gray!8}{0.024} & \cellcolor{gray!8}{1.982} & \cellcolor{gray!8}{0.012} & \cellcolor{gray!8}{0.990} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-3.860} & \cellcolor{gray!8}{3.909}\\
M2aoc & RQ2a & Catfish & occupancy & vs control & full & monitoring int & -0.165 & 0.259 & -0.635 & 0.525 & NA & -0.673 & 0.343\\
\cellcolor{gray!8}{M2aoc} & \cellcolor{gray!8}{RQ2a} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{occupancy} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{full} & \cellcolor{gray!8}{fetch z} & \cellcolor{gray!8}{-0.960} & \cellcolor{gray!8}{1.197} & \cellcolor{gray!8}{-0.802} & \cellcolor{gray!8}{0.423} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-3.306} & \cellcolor{gray!8}{1.387}\\
\addlinespace
M2aoc & RQ2a & Catfish & occupancy & vs control & full & PeriodAfter:siteStone pile & 0.387 & 2.168 & 0.179 & 0.858 & 0.858 & -3.863 & 4.637\\
\cellcolor{gray!8}{M2aak} & \cellcolor{gray!8}{RQ2a} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{abundance} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{full} & \cellcolor{gray!8}{(Intercept)} & \cellcolor{gray!8}{-2.753} & \cellcolor{gray!8}{1.183} & \cellcolor{gray!8}{-2.327} & \cellcolor{gray!8}{0.020} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-5.072} & \cellcolor{gray!8}{-0.434}\\
M2aak & RQ2a & Kōura & abundance & vs control & full & PeriodAfter & 2.374 & 0.976 & 2.432 & 0.015 & NA & 0.461 & 4.286\\
\cellcolor{gray!8}{M2aak} & \cellcolor{gray!8}{RQ2a} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{abundance} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{full} & \cellcolor{gray!8}{siteStone pile} & \cellcolor{gray!8}{0.751} & \cellcolor{gray!8}{1.335} & \cellcolor{gray!8}{0.563} & \cellcolor{gray!8}{0.574} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-1.865} & \cellcolor{gray!8}{3.368}\\
M2aak & RQ2a & Kōura & abundance & vs control & full & monitoring int & -0.253 & 0.082 & -3.094 & 0.002 & NA & -0.413 & -0.093\\
\addlinespace
\cellcolor{gray!8}{M2aak} & \cellcolor{gray!8}{RQ2a} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{abundance} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{full} & \cellcolor{gray!8}{PeriodAfter:siteStone pile} & \cellcolor{gray!8}{0.311} & \cellcolor{gray!8}{1.232} & \cellcolor{gray!8}{0.253} & \cellcolor{gray!8}{0.800} & \cellcolor{gray!8}{0.858} & \cellcolor{gray!8}{-2.104} & \cellcolor{gray!8}{2.727}\\
M2abk & RQ2a & Kōura & biomass & vs control & full & (Intercept) & 0.315 & 1.335 & 0.236 & 0.813 & NA & -2.301 & 2.931\\
\cellcolor{gray!8}{M2abk} & \cellcolor{gray!8}{RQ2a} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{biomass} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{full} & \cellcolor{gray!8}{PeriodAfter} & \cellcolor{gray!8}{2.248} & \cellcolor{gray!8}{1.246} & \cellcolor{gray!8}{1.805} & \cellcolor{gray!8}{0.071} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-0.193} & \cellcolor{gray!8}{4.689}\\
M2abk & RQ2a & Kōura & biomass & vs control & full & siteStone pile & 1.410 & 1.552 & 0.909 & 0.363 & NA & -1.631 & 4.451\\
\cellcolor{gray!8}{M2abk} & \cellcolor{gray!8}{RQ2a} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{biomass} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{full} & \cellcolor{gray!8}{monitoring int} & \cellcolor{gray!8}{-0.196} & \cellcolor{gray!8}{0.110} & \cellcolor{gray!8}{-1.791} & \cellcolor{gray!8}{0.073} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-0.412} & \cellcolor{gray!8}{0.019}\\
\addlinespace
M2abk & RQ2a & Kōura & biomass & vs control & full & PeriodAfter:siteStone pile & -0.336 & 1.471 & -0.228 & 0.819 & 0.858 & -3.220 & 2.548\\
...
M2aok & RQ2a & Kōura & occupancy & vs control & full & PeriodAfter & 1.913 & 1.556 & 1.230 & 0.219 & NA & -1.136 & 4.963\\
\cellcolor{gray!8}{M2aok} & \cellcolor{gray!8}{RQ2a} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{occupancy} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{full} & \cellcolor{gray!8}{siteStone pile} & \cellcolor{gray!8}{0.013} & \cellcolor{gray!8}{2.121} & \cellcolor{gray!8}{0.006} & \cellcolor{gray!8}{0.995} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-4.144} & \cellcolor{gray!8}{4.171}\\
M2aok & RQ2a & Kōura & occupancy & vs control & full & monitoring int & -0.286 & 0.215 & -1.333 & 0.183 & NA & -0.708 & 0.135\\
\addlinespace
\cellcolor{gray!8}{M2aok} & \cellcolor{gray!8}{RQ2a} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{occupancy} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{full} & \cellcolor{gray!8}{PeriodAfter:siteStone pile} & \cellcolor{gray!8}{1.013} & \cellcolor{gray!8}{1.762} & \cellcolor{gray!8}{0.575} & \cellcolor{gray!8}{0.565} & \cellcolor{gray!8}{0.858} & \cellcolor{gray!8}{-2.440} & \cellcolor{gray!8}{4.466}\\
M2bac & RQ2b & Catfish & abundance & vs control & after & (Intercept) & -2.150 & 1.519 & -1.416 & 0.157 & NA & -5.127 & 0.826\\
\cellcolor{gray!8}{M2bac} & \cellcolor{gray!8}{RQ2b} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{abundance} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{siteStone pile} & \cellcolor{gray!8}{-1.392} & \cellcolor{gray!8}{1.832} & \cellcolor{gray!8}{-0.760} & \cellcolor{gray!8}{0.447} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-4.983} & \cellcolor{gray!8}{2.199}\\
M2bac & RQ2b & Catfish & abundance & vs control & after & monitoring int & -0.634 & 0.406 & -1.562 & 0.118 & NA & -1.430 & 0.162\\
\cellcolor{gray!8}{M2bac} & \cellcolor{gray!8}{RQ2b} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{abundance} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{fetch z} & \cellcolor{gray!8}{-1.097} & \cellcolor{gray!8}{0.976} & \cellcolor{gray!8}{-1.124} & \cellcolor{gray!8}{0.261} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-3.010} & \cellcolor{gray!8}{0.816}\\
\addlinespace
M2bac & RQ2b & Catfish & abundance & vs control & after & siteStone pile:monitoring int & 0.831 & 0.557 & 1.492 & 0.136 & 0.215 & -0.261 & 1.922\\
\cellcolor{gray!8}{M2bbc} & \cellcolor{gray!8}{RQ2b} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{biomass} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{(Intercept)} & \cellcolor{gray!8}{2.964} & \cellcolor{gray!8}{2.725} & \cellcolor{gray!8}{1.088} & \cellcolor{gray!8}{0.277} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-2.377} & \cellcolor{gray!8}{8.304}\\
M2bbc & RQ2b & Catfish & biomass & vs control & after & siteStone pile & -4.522 & 4.240 & -1.066 & 0.286 & NA & -12.833 & 3.789\\
\cellcolor{gray!8}{M2bbc} & \cellcolor{gray!8}{RQ2b} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{biomass} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{monitoring int} & \cellcolor{gray!8}{-0.974} & \cellcolor{gray!8}{0.688} & \cellcolor{gray!8}{-1.416} & \cellcolor{gray!8}{0.157} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-2.323} & \cellcolor{gray!8}{0.374}\\
M2bbc & RQ2b & Catfish & biomass & vs control & after & fetch z & -0.886 & 1.390 & -0.638 & 0.524 & NA & -3.610 & 1.837\\
\addlinespace
\cellcolor{gray!8}{M2bbc} & \cellcolor{gray!8}{RQ2b} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{biomass} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{siteStone pile:monitoring int} & \cellcolor{gray!8}{1.357} & \cellcolor{gray!8}{0.974} & \cellcolor{gray!8}{1.393} & \cellcolor{gray!8}{0.164} & \cellcolor{gray!8}{0.215} & \cellcolor{gray!8}{-0.552} & \cellcolor{gray!8}{3.266}\\
M2boc & RQ2b & Catfish & occupancy & vs control & after & (Intercept) & -0.952 & 1.737 & -0.548 & 0.584 & NA & -4.357 & 2.453\\
\cellcolor{gray!8}{M2boc} & \cellcolor{gray!8}{RQ2b} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{occupancy} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{siteStone pile} & \cellcolor{gray!8}{-2.013} & \cellcolor{gray!8}{1.936} & \cellcolor{gray!8}{-1.040} & \cellcolor{gray!8}{0.298} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-5.808} & \cellcolor{gray!8}{1.781}\\
M2boc & RQ2b & Catfish & occupancy & vs control & after & monitoring int & -0.565 & 0.420 & -1.345 & 0.179 & NA & -1.388 & 0.258\\
\cellcolor{gray!8}{M2boc} & \cellcolor{gray!8}{RQ2b} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{occupancy} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{fetch z} & \cellcolor{gray!8}{-0.858} & \cellcolor{gray!8}{1.121} & \cellcolor{gray!8}{-0.766} & \cellcolor{gray!8}{0.444} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-3.055} & \cellcolor{gray!8}{1.339}\\
\addlinespace
M2boc & RQ2b & Catfish & occupancy & vs control & after & siteStone pile:monitoring int & 0.735 & 0.546 & 1.344 & 0.179 & 0.215 & -0.336 & 1.806\\
\cellcolor{gray!8}{M2bak} & \cellcolor{gray!8}{RQ2b} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{abundance} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{(Intercept)} & \cellcolor{gray!8}{0.084} & \cellcolor{gray!8}{0.846} & \cellcolor{gray!8}{0.099} & \cellcolor{gray!8}{0.921} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-1.573} & \cellcolor{gray!8}{1.741}\\
M2bak & RQ2b & Kōura & abundance & vs control & after & siteStone pile & 0.323 & 0.808 & 0.400 & 0.689 & NA & -1.261 & 1.907\\
\cellcolor{gray!8}{M2bak} & \cellcolor{gray!8}{RQ2b} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{abundance} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{monitoring int} & \cellcolor{gray!8}{-0.409} & \cellcolor{gray!8}{0.143} & \cellcolor{gray!8}{-2.861} & \cellcolor{gray!8}{0.004} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-0.690} & \cellcolor{gray!8}{-0.129}\\
M2bak & RQ2b & Kōura & abundance & vs control & after & siteStone pile:monitoring int & 0.243 & 0.179 & 1.359 & 0.174 & 0.215 & -0.107 & 0.593\\
\addlinespace
\cellcolor{gray!8}{M2bbk} & \cellcolor{gray!8}{RQ2b} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{biomass} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{(Intercept)} & \cellcolor{gray!8}{3.270} & \cellcolor{gray!8}{0.856} & \cellcolor{gray!8}{3.821} & \cellcolor{gray!8}{0.000} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{1.593} & \cellcolor{gray!8}{4.948}\\
M2bbk & RQ2b & Kōura & biomass & vs control & after & siteStone pile & -0.077 & 0.986 & -0.078 & 0.938 & NA & -2.010 & 1.856\\
\cellcolor{gray!8}{M2bbk} & \cellcolor{gray!8}{RQ2b} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{biomass} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{monitoring int} & \cellcolor{gray!8}{-0.427} & \cellcolor{gray!8}{0.191} & \cellcolor{gray!8}{-2.240} & \cellcolor{gray!8}{0.025} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-0.800} & \cellcolor{gray!8}{-0.053}\\
M2bbk & RQ2b & Kōura & biomass & vs control & after & siteStone pile:monitoring int & 0.366 & 0.239 & 1.531 & 0.126 & 0.215 & -0.103 & 0.834\\
\cellcolor{gray!8}{M2bok} & \cellcolor{gray!8}{RQ2b} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{occupancy} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{(Intercept)} & \cellcolor{gray!8}{1.585} & \cellcolor{gray!8}{1.885} & \cellcolor{gray!8}{0.841} & \cellcolor{gray!8}{0.400} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-2.109} & \cellcolor{gray!8}{5.280}\\
\addlinespace
M2bok & RQ2b & Kōura & occupancy & vs control & after & siteStone pile & 0.563 & 2.660 & 0.212 & 0.832 & NA & -4.651 & 5.776\\
\cellcolor{gray!8}{M2bok} & \cellcolor{gray!8}{RQ2b} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{occupancy} & \cellcolor{gray!8}{vs control} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{monitoring int} & \cellcolor{gray!8}{-0.403} & \cellcolor{gray!8}{0.311} & \cellcolor{gray!8}{-1.296} & \cellcolor{gray!8}{0.195} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-1.014} & \cellcolor{gray!8}{0.207}\\
M2bok & RQ2b & Kōura & occupancy & vs control & after & siteStone pile:monitoring int & 0.229 & 0.441 & 0.519 & 0.604 & 0.604 & -0.636 & 1.094\\
\cellcolor{gray!8}{M3aac} & \cellcolor{gray!8}{RQ3a} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{abundance} & \cellcolor{gray!8}{vs reference} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{(Intercept)} & \cellcolor{gray!8}{-7.151} & \cellcolor{gray!8}{1.282} & \cellcolor{gray!8}{-5.577} & \cellcolor{gray!8}{0.000} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-9.664} & \cellcolor{gray!8}{-4.638}\\
M3aac & RQ3a & Catfish & abundance & vs reference & after & siteStone pile & -2.471 & 1.940 & -1.274 & 0.203 & NA & -6.273 & 1.331\\
\addlinespace
\cellcolor{gray!8}{M3aac} & \cellcolor{gray!8}{RQ3a} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{abundance} & \cellcolor{gray!8}{vs reference} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{monitoring int} & \cellcolor{gray!8}{-0.215} & \cellcolor{gray!8}{0.147} & \cellcolor{gray!8}{-1.462} & \cellcolor{gray!8}{0.144} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-0.504} & \cellcolor{gray!8}{0.073}\\
M3aac & RQ3a & Catfish & abundance & vs reference & after & Temperature & 0.315 & 0.058 & 5.414 & 0.000 & NA & 0.201 & 0.429\\
\cellcolor{gray!8}{M3aac} & \cellcolor{gray!8}{RQ3a} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{abundance} & \cellcolor{gray!8}{vs reference} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{siteStone pile:monitoring int} & \cellcolor{gray!8}{0.510} & \cellcolor{gray!8}{0.398} & \cellcolor{gray!8}{1.283} & \cellcolor{gray!8}{0.199} & \cellcolor{gray!8}{0.559} & \cellcolor{gray!8}{-0.269} & \cellcolor{gray!8}{1.290}\\
M3abc & RQ3a & Catfish & biomass & vs reference & after & (Intercept) & 3.011 & 1.189 & 2.532 & 0.011 & NA & 0.681 & 5.342\\
\cellcolor{gray!8}{M3abc} & \cellcolor{gray!8}{RQ3a} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{biomass} & \cellcolor{gray!8}{vs reference} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{siteStone pile} & \cellcolor{gray!8}{-4.370} & \cellcolor{gray!8}{3.059} & \cellcolor{gray!8}{-1.429} & \cellcolor{gray!8}{0.153} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-10.366} & \cellcolor{gray!8}{1.626}\\
\addlinespace
M3abc & RQ3a & Catfish & biomass & vs reference & after & monitoring int & -0.250 & 0.209 & -1.196 & 0.232 & NA & -0.660 & 0.160\\
\cellcolor{gray!8}{M3abc} & \cellcolor{gray!8}{RQ3a} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{biomass} & \cellcolor{gray!8}{vs reference} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{siteStone pile:monitoring int} & \cellcolor{gray!8}{0.689} & \cellcolor{gray!8}{0.638} & \cellcolor{gray!8}{1.081} & \cellcolor{gray!8}{0.280} & \cellcolor{gray!8}{0.559} & \cellcolor{gray!8}{-0.560} & \cellcolor{gray!8}{1.939}\\
M3aak & RQ3a & Kōura & abundance & vs reference & after & (Intercept) & 0.229 & 0.519 & 0.440 & 0.660 & NA & -0.789 & 1.247\\
\cellcolor{gray!8}{M3aak} & \cellcolor{gray!8}{RQ3a} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{abundance} & \cellcolor{gray!8}{vs reference} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{siteStone pile} & \cellcolor{gray!8}{0.217} & \cellcolor{gray!8}{0.901} & \cellcolor{gray!8}{0.240} & \cellcolor{gray!8}{0.810} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-1.550} & \cellcolor{gray!8}{1.984}\\
M3aak & RQ3a & Kōura & abundance & vs reference & after & monitoring int & -0.090 & 0.056 & -1.612 & 0.107 & NA & -0.199 & 0.019\\
\addlinespace
\cellcolor{gray!8}{M3aak} & \cellcolor{gray!8}{RQ3a} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{abundance} & \cellcolor{gray!8}{vs reference} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{siteStone pile:monitoring int} & \cellcolor{gray!8}{-0.086} & \cellcolor{gray!8}{0.109} & \cellcolor{gray!8}{-0.791} & \cellcolor{gray!8}{0.429} & \cellcolor{gray!8}{0.572} & \cellcolor{gray!8}{-0.299} & \cellcolor{gray!8}{0.127}\\
M3abk & RQ3a & Kōura & biomass & vs reference & after & (Intercept) & 3.369 & 0.506 & 6.655 & 0.000 & NA & 2.377 & 4.361\\
\cellcolor{gray!8}{M3abk} & \cellcolor{gray!8}{RQ3a} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{biomass} & \cellcolor{gray!8}{vs reference} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{siteStone pile} & \cellcolor{gray!8}{-0.149} & \cellcolor{gray!8}{0.885} & \cellcolor{gray!8}{-0.168} & \cellcolor{gray!8}{0.866} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-1.884} & \cellcolor{gray!8}{1.586}\\
M3abk & RQ3a & Kōura & biomass & vs reference & after & monitoring int & -0.088 & 0.074 & -1.177 & 0.239 & NA & -0.234 & 0.058\\
\cellcolor{gray!8}{M3abk} & \cellcolor{gray!8}{RQ3a} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{biomass} & \cellcolor{gray!8}{vs reference} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{siteStone pile:monitoring int} & \cellcolor{gray!8}{0.016} & \cellcolor{gray!8}{0.142} & \cellcolor{gray!8}{0.112} & \cellcolor{gray!8}{0.911} & \cellcolor{gray!8}{0.911} & \cellcolor{gray!8}{-0.262} & \cellcolor{gray!8}{0.294}\\
\addlinespace
M3bac & RQ3b & Catfish & abundance & reference & after & (Intercept) & -7.372 & 1.705 & -4.324 & 0.000 & NA & -10.713 & -4.031\\
\cellcolor{gray!8}{M3bac} & \cellcolor{gray!8}{RQ3b} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{abundance} & \cellcolor{gray!8}{reference} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{Site type detailReference 2} & \cellcolor{gray!8}{0.753} & \cellcolor{gray!8}{1.007} & \cellcolor{gray!8}{0.747} & \cellcolor{gray!8}{0.455} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-1.221} & \cellcolor{gray!8}{2.726}\\
M3bac & RQ3b & Catfish & abundance & reference & after & monitoring int & -0.130 & 0.220 & -0.591 & 0.555 & NA & -0.562 & 0.301\\
...
M3bac & RQ3b & Catfish & abundance & reference & after & Site type detailReference 2:monitoring int & -0.151 & 0.287 & -0.527 & 0.598 & 0.797 & -0.714 & 0.411\\
\addlinespace
...
M3bbc & RQ3b & Catfish & biomass & reference & after & Site type detailReference 2 & 0.191 & 1.640 & 0.116 & 0.907 & NA & -3.024 & 3.406\\
\cellcolor{gray!8}{M3bbc} & \cellcolor{gray!8}{RQ3b} & \cellcolor{gray!8}{Catfish} & \cellcolor{gray!8}{biomass} & \cellcolor{gray!8}{reference} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{monitoring int} & \cellcolor{gray!8}{-0.227} & \cellcolor{gray!8}{0.301} & \cellcolor{gray!8}{-0.754} & \cellcolor{gray!8}{0.451} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-0.816} & \cellcolor{gray!8}{0.363}\\
M3bbc & RQ3b & Catfish & biomass & reference & after & Site type detailReference 2:monitoring int & 0.022 & 0.419 & 0.052 & 0.959 & 0.959 & -0.800 & 0.843\\
...
\addlinespace
M3bak & RQ3b & Kōura & abundance & reference & after & Site type detailReference 2 & -0.115 & 0.570 & -0.202 & 0.840 & NA & -1.232 & 1.002\\
\cellcolor{gray!8}{M3bak} & \cellcolor{gray!8}{RQ3b} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{abundance} & \cellcolor{gray!8}{reference} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{monitoring int} & \cellcolor{gray!8}{-0.019} & \cellcolor{gray!8}{0.062} & \cellcolor{gray!8}{-0.302} & \cellcolor{gray!8}{0.763} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-0.141} & \cellcolor{gray!8}{0.103}\\
...
\addlinespace
\cellcolor{gray!8}{M3bak} & \cellcolor{gray!8}{RQ3b} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{abundance} & \cellcolor{gray!8}{reference} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{Site type detailReference 2:monitoring int} & \cellcolor{gray!8}{-0.069} & \cellcolor{gray!8}{0.088} & \cellcolor{gray!8}{-0.787} & \cellcolor{gray!8}{0.431} & \cellcolor{gray!8}{0.797} & \cellcolor{gray!8}{-0.241} & \cellcolor{gray!8}{0.103}\\
M3bbk & RQ3b & Kōura & biomass & reference & after & (Intercept) & 3.275 & 0.800 & 4.095 & 0.000 & NA & 1.707 & 4.842\\
\cellcolor{gray!8}{M3bbk} & \cellcolor{gray!8}{RQ3b} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{biomass} & \cellcolor{gray!8}{reference} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{Site type detailReference 2} & \cellcolor{gray!8}{-0.067} & \cellcolor{gray!8}{0.670} & \cellcolor{gray!8}{-0.100} & \cellcolor{gray!8}{0.920} & \cellcolor{gray!8}{NA} & \cellcolor{gray!8}{-1.379} & \cellcolor{gray!8}{1.245}\\
M3bbk & RQ3b & Kōura & biomass & reference & after & monitoring int & -0.047 & 0.087 & -0.548 & 0.584 & NA & -0.217 & 0.122\\
\cellcolor{gray!8}{M3bbk} & \cellcolor{gray!8}{RQ3b} & \cellcolor{gray!8}{Kōura} & \cellcolor{gray!8}{biomass} & \cellcolor{gray!8}{reference} & \cellcolor{gray!8}{after} & \cellcolor{gray!8}{Site type detailReference 2:monitoring int} & \cellcolor{gray!8}{-0.074} & \cellcolor{gray!8}{0.125} & \cellcolor{gray!8}{-0.591} & \cellcolor{gray!8}{0.554} & \cellcolor{gray!8}{0.797} & \cellcolor{gray!8}{-0.319} & \cellcolor{gray!8}{0.171}\\*
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{outputs/fig-power-curves-combined.png}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{outputs/fig-convergence-plot.png}
...
\section*{Chapter 6 --- Supplementary
information}\label{chapter-6-supplementary-information}
\addcontentsline{toc}{section}{Chapter 6 --- Supplementary information}

\subsection{Case study --- Field trial of stone piles at Lake
Ōkaro}\label{sec-supp-okaro}

A trial in Lake Ōkaro tested stone pile construction logistics and kōura
...
kōura tolerance thresholds. Lake Ōkaro is one of the smaller Rotorua Te
...
the lake, in 2007 a wetland was constructed to remove nitrogen and
sediments from the main inflows into the lake (Hudson et al. 2009) and
alum dosing (aluminium sulphate) are carried out as in-lake phosphorus
treatment (Paul et al. 2008). Kōura have not been observed in Lake Ōkaro
in monitoring surveys from 1981 to 2007 (Parkyn and Kusabs 2007) and
monitoring in 2016 and 2017 still were not able to observe kōura in the
lake even as water quality had improved (Kusabs 2017). Water quality has
now improved sufficiently that kōura survival is considered feasible but
natural recolonisation has not happened yet, therefore reintroduction
might be possible. Lake Ōkaro is home to rainbow trout and is frequented
by cormorants both well-known predators of kōura. The lake has little
rocky substrate, so it was hoped that construction of two stone piles,
in the year round oxygenated zone, would provide a beachhead for kōura,
from which a local population could become established.

Stone pile construction was carried out collaboratively with staff from
the Bay of Plenty Regional Council, Te Arawa Lakes Trust, Tūhourangi,
Ngāti Tahu-Ngāti Whaoa, and Te Mana o Ngāti Rangitihi Trust. Two stone
piles (each 5 m × 2 m, depth 1 m; stones 70--210 mm, mean 120 mm; total
5 m\^{}3) were placed 3 and 6 m from the northeast shore, with stones
sourced from local Rainbow Quarry on Rainbow Mountain
(Figure~\ref{fig-Okaro-stonepile}). Dissolved oxygen and temperature
were monitored using three HOBO U26-001 loggers (± 0.2 mg/L DO, ± 0.2
°C; Onset Computer Corporation, Bourne, MA, USA), with two loggers
buried within the stone piles and one at the control site, over six
months from September 2024. Prior to kōura release, trapping and
spotlighting surveys confirmed the lake held no kōura. In October 2024,
twenty kōura sourced from the wider catchment were released onto the
stone piles. Seasonal spotlighting surveys were carried out from January
2025.
...
\includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{images/Okaro_stonepile1.jpg}

}

\caption{\label{fig-Okaro-stonepile}Stone pile on shoreline of Lake
Ōkaro (2025-02-28).}

\end{figure}%

In the early summer of 2024, however, the lake stratified rapidly with
oxygen levels dropping quickly and on December 10th oxygen levels
reached less than 3 mg/L at surface level for multiple days
...
piles or emerge entirely, as DO levels within the piles would fall below
their tolerance. Despite this anoxic event, one kōura was repeatedly
observed at the stone piles between January and June 2025 (pers. comm.
Ian Kusabs). It is possible that other kōura had dispersed more widely
through the lake. The final spotlight session (July 2026) recorded no
kōura at the stone piles but revealed that the previously sandy
shoreline around the stone piles had been colonised by milfoil
(\emph{Myriophyllum propinquum}) (pers. comm. Ian Kusabs).
...
and dissolved oxygen (bottom) at the Ōkaro stone pile, control sites,
and the lake monitoring buoy, averaged over the 0--1 m depth range.
Period: 2024-09-11 to 2025-02-27. Buoy data derived from CTD casts
collected by LimnoTrack (Moore and McBride 2026).}
...
provided limited crevice space for larger kōura. For the Rotoiti
...
without adequate water quality. Dissolved oxygen fell below kōura
tolerance across the entire water column following stone pile
deployment, an unusually severe and unexpected anoxic event that was not
confined to deeper water. This showed that structural complexity
provides little benefit when the surrounding water itself is
unsurvivable; kōura cannot use refuges in conditions they cannot
survive. Nonetheless, further surveys are required to determine the fate
of kōura in Lake Ōkaro and assess whether they have dispersed to other
areas of the lake or persisted in suitable refugia.

\subsection{Case study --- Trial of deep stone piles at Lake
Rotoiti}\label{sec-supp-rotoiti-deep}

Extending stone pile deployment across a depth gradient in Lake Rotoiti
showed that kōura use structures beyond the shallow littoral zone and
...
from the shore and therefore limited to shallow, nearshore depths. In
this case study we trialled how to build stone piles by extending
deployment across a depth gradient required working from a boat and
barge with winch system, this opened two additional possibilities:
placing structures at depths beyond wading distance and positioning them
within invasive macrophyte beds to test whether stone coverage could
suppress growth. Monitoring at greater depths is not well suited to
standard netting, so spotlighting, remotely operated vehicle (ROV)
surveys, and human diving were used before and after construction at
this deep Lake Rotoiti site. Spotlighting was executed after sunset
along the shoreline and the area around the jetty, by observing for
kōura using a torch. Each kōura was counted and their size estimated.
The stone piles in the macrophyte bed and deeper were monitored using a
FIFISH V-EVO (4K 60 fps camera; 166° field of view; QYSEA Technology,
Shenzhen, China). The ROV was used to swim transects at the location of
the stone piles and kōura observed were counted. Spotlight and ROV
surveys were executed two times before stone pile construction, and
...
sediment. A fourth pile was placed on a natural bedrock platform
approximately 120 m away, at a depth of 1--2m.
...
around the jetty and eleven on the deeper stone pile by ROV
(Figure~\ref{fig-koura-deep}). The August 2026 survey (water temp 10 °C)
found six by spotlighting and two by ROV, one on the stone pile in the
macrophyte bed and one at the deeper stone pile. Most kōura were
observed at the margins of the stone piles rather than within them, as
internal crevices were visually inaccessible to both spotlighting and
ROV surveys. Kōura were only detected when they emerged to forage, and
ROV footage confirmed they did so despite thruster noise.

\begin{figure}

\centering{

\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{images/koura_deep.png}

}

\caption{\label{fig-koura-deep}Kōura emerging from its shelter at the
bottom of the deepest stone pile in Lake Rotoiti. Observed with the
ROV.}

\end{figure}%

The stone pile placed within the macrophyte bed showed complete
suppression of macrophyte growth, though dense macrophyte growth at the
margins complicated kōura detection in that area. Daytime diving surveys
(January 2026, water temp 21 °C; July 2026, water temp 11 °C) detected
no kōura on either occasion. As kōura are nocturnal, daytime diving
surveys were expected to yield lower counts as kōura are likely
sheltering within the structures. Dissolved oxygen, measured with HOBO
U26-001 loggers at the stone piles, remained above the 5 mg/L kōura
...
Lake Rotoiti monitoring buoy, averaged over the 0--1 m depth range.
Period: 2025-11-22 to 2026-06-8. Buoy data derived from CTD cast
collected by LimnoTrack (Moore and McBride 2026).}

\end{figure}%

Extending deployment across a depth gradient adds an important dimension
absent from the shallow shoreline work of Chapter 5. Kōura used stone
...
kōura thermal tolerance while deeper structures remain within the
habitable temperature range and stay above the anoxic hypolimnion.
Structures spanning this gradient therefore allow kōura to track the
...
zones, though this warrants further investigation. Beyond these
ecological findings, this case study establishes that constructing
habitat at depth is logistically achievable with a simple boat and winch
system, and future ideas to make the process more cost-effective have
been developed, offering a practical and comparatively low-cost method
for scaling habitat enhancement to deeper parts of the littoral zone in
future deployments.

...
sulphate) in Lakes Rotorua, Rotoehu, and Ōkaro to reduce phosphorus
loading, mechanical and chemical control of invasive macrophytes, and
the community-led ``Catfish Killas'' programme, which aims to reduce
catfish abundance from the lakes.
...
21°C, the known physiological limits for kōura (Devcich 1979). For each
CTD depth profile, each depth layer was classified as liveable or not,
and lake bathymetric data (hypsographs) were used to convert those depth
layers into bottom area, giving a liveable habitat percentage for each
profile. Monthly CTD cast data from Bay of Plenty Regional Council
(BOPRC) monitoring and continuous buoy profiles from LimnoTrack (Moore
and McBride 2026) were combined across eleven of the twelve Rotorua Te
Arawa Lakes (2003--2026). Annual and seasonal trends in liveable habitat
were estimated per lake using ordinary least-squares linear regression.
Across the lakes, liveable habitat varies strongly with season with
sharp summer declines in eutrophic, mesotrophic and shallow lakes such
as Rotorua, Rotoiti, Rotoehu, Rotokākahi, Rerewhakaaitu, Ōkāreka, Ōkaro,
...
--- title: ``Native vs.~Novel Threats'' subtitle: ``Fear of the new: a
predatory invader provokes stronger non-consumptive effects on a
keystone native prey than a native predator''

execute: freeze: false cache: false

author: - name: given: Olivier V. family: Raven orcid:
0009-0008-6184-6831 affiliations: - name: University of Waikato
department: Te Aka Mātuatua -- School of Science address: Private Bag
3105, Hamilton 3240 country: New Zealand email:
olivier.raven@icloud.com; or81@students.waikato.ac.nz corresponding:
true

\begin{itemize}
\tightlist
\item
  name: given: Calum family: MacNeil orcid: 0000-0003-0402-9292
  affiliations:

  \begin{itemize}
  \tightlist
  \item
    name: The Cawthron Institute address: 98 Halifax Street East, Nelson
    7010, Private Bag 2, Nelson 7042 country: New Zealand
  \end{itemize}
\item
  name: given: Finnbar family: Lee orcid: 0000-0002-9219-1486
  affiliations:
  ...
  \end{itemize}
\item
  name: given: Robin family: Holmes orcid: 0000-0002-8737-2717
  affiliations:
  ...
  \end{itemize}
\item
  name: given: Ian A. K. family: Kusabs orcid: 0000-0002-1473-7447
  affiliations:

  \begin{itemize}
  \tightlist
  \item
    name: Ian Kusabs and Associates Limited address: 21 Summit Road,
    Rotorua 3076 country: New Zealand
  \end{itemize}
\item
  name: given: Francis J. family: Burdon orcid: 0000-0002-5398-4993
  affiliations:

  \begin{itemize}
  \tightlist
  \item
    name: University of Waikato department: Te Aka Mātuatua -- School of
    Science address: Private Bag 3105, Hamilton 3240 country: New
    Zealand
  \end{itemize}
\item
  name:\\
  given: Deniz family: Özkundakci orcid: 0000-0002-5442-4576
  affiliations:
...
keywords: - Non-consumptive effects - Crayfish - Kōura - Brown bullhead
catfish - Antipredator behaviour

funding: ``This research was supported by the Fish Futures programme
funded through a Ministry of Business, Innovation and Employment grant
(CAWX2101) with additional funding provided by the Bay of Plenty
Regional Council under the Toihuarewa Waimāori - Bay of Plenty Regional
Council Chair in Lake and Freshwater Science programme.''

citation: container-title: ``\ldots{}''

title-block-style: none

knitr: opts\_chunk: dev: ``ragg\_png'' ---
...
--- title: ``Where do Kōura Live?'' subtitle: ``Littoral habitat
structure influences freshwater crayfish populations in five volcanic
lakes of Aotearoa New Zealand''
...
keywords: - Rotorua Te Arawa Lakes - North Island - Habitat structure -
Thermal stress - Generalised additive mixed models - Paranephrops
planifrons
...
citation: container-title: ``Raven, O.V., Burdon, F.J., Kusabs, I.A.K.
et al.~Littoral habitat structure influences freshwater crayfish
populations in five volcanic lakes of Aotearoa New Zealand.
Hydrobiologia (2026). \url{https://doi.org/10.1007/s10750-026-06302-z}''

nocite: \textbar{} Coffey and Clayton (1988), Shave et al. (1994), Smith
et al. (1996), Parkyn and Collier (2002), Vedia et al. (2017), Broughton
et al. (2017)
...
--- title: ``The Importance of Structure'' subtitle: ``The importance of
...
keywords: - Paranephrops planifrons - Artificial reef - Behaviour -
Habitat preference - Aotearoa New Zealand
...
--- title: ``Rock Piles as Kōura Habitat'' subtitle: ``Stone pile
refuges in an Aotearoa New Zealand lake: early benefits for threatened
crayfish but not its invasive predator''
...
keywords: - Aotearoa New Zealand - Artificial reef - Habitat enhancement
- Invasive species - Lake Rotoiti, Rotorua Te Arawa Lakes - Paranephrops
planifrons
...
quality boundary of habitat enhancement (see Appendix:
Section~\ref{sec-supp-okaro}), and a depth-gradient deployment in Lake
Rotoiti that explored use of stone pile structures beyond wading depth
(see Appendix: Section~\ref{sec-supp-rotoiti-deep}).
...
baited traps, finding evidence of crayfish colonisation using both
methods. More structurally complex habitat may also introduce a
systematic detection bias in the opposite direction: kōura sheltering
within stone piles may become genuinely harder to catch or observe if
they can forage on snails and other invertebrates within the structure
itself, without needing to emerge at all (Francis 2019). A similar
pattern has been reported in North American lakes containing largemouth
bass (\emph{Micropterus salmoides}) (W. Perry, pers. comm.). This
limitation influenced the monitoring approaches across the thesis, from
netting in Chapter 3 and 5 toward direct observation methods in later
trials (see Appendix: Section~\ref{sec-supp-rotoiti-deep}), where
spotlighting, Remotely Operated Vehicle (ROV) surveys, and diving
...
human dive surveys. These methods allow direct observation of kōura
using the structures and are easier to execute over depth than netting.
However, these direct methods capture only the moment of observation,
and the detection bias introduced by structural complexity means that
even direct observations may underestimate true habitat use if kōura
remain sheltered during surveys. Passive Integrated Transponder (PIT)
tagging, combined with an antenna array installed beneath or around a
structure, would allow individual kōura to be tracked continuously
without requiring their emergence or capture, resolving the detection
bias identified above. The same approach could also support
mark-recapture estimates of population size at stone pile sites,
complementing its use for tracking movement and habitat use. PIT tagging
is relatively low-cost and widely used in fish and crayfish movement
studies and represents a promising direction for confirming genuine
structural preference in future stone pile deployment (Bubb et al. 2006;
Westhoff and Sievert 2013).
...
Chapter 3's shoreline habitat survey across five Te Arawa Lakes showed
that kōura were most consistently associated with complex rocky habitats
and riparian vegetation (Jowett et al. 2008; Kusabs et al. 2015b).
Locations where this substrate has been lost or never existed are
therefore logical candidates for stone pile deployment. Chapter 4
...
benefits will depend on the environmental conditions in which the
structures are deployed. Stone piles function as a buffer against
stressors that cannot be eliminated at lake scale. Catfish eradication
would likely require broad-spectrum piscicides or complete lake drawdown
which would also kill or displace native fish species (Dedual 2019).
Future biotechnologies, including gene drives and pathogens that target
only the invasive species, could eventually provide additional options,
but these tools are still in early, experimental stages of development
(Thresher et al. 2014; Kopf et al. 2019; Teem et al. 2020), making
current eradication impractical at the Rotoiti and Rotorua scale. The
expected future increase in lake water temperature will intensify
thermal stratification under continued climate warming, which will
benefit catfish more than kōura (Woolway et al. 2021; Lee et al. 2025).
When these stressors cannot be removed habitat enhancement becomes a
practical management tool whose importance grows even as worsening
conditions constrain how much benefit it can ultimately deliver.
...
event in Lake Ōkaro. Where conditions are already favourable the ceiling
is correspondingly higher, consistent with Chapter 3's finding that
lakes with the best water quality, most complex habitat, and no catfish
...
for cultural practices. Localised kōura harvesting currently occurs at
Cherry Bay (Ōkahuroroa Bay) in Lake Rotoiti where regular monitoring
using the tau kōura (and whakaweku) in conjunction with regular aquatic
weed spraying and catfish netting has potentially already created a
degree of structural complexity in the bay. This suggests a model for
cultural kōura restoration in Lake Rotoiti: identifying areas with
favourable lake bathymetry, maintaining regular spraying of aquatic
weeds and active catfish removal, and creating habitat using whakaweku,
tau kōura, and potentially stone piles to establish dedicated kōura
reserves within in the lake that could support renewed cultural harvest
activity. This is a suggestion for future research and management to
consider together with Te Arawa.
...
Invasions 28: \url{https://doi.org/10.1007/s10530-026-03877-5}
...
\begin{tikzpicture}[remember picture, overlay]
  \node[inner sep=0pt] at ([yshift=-1cm]current page.center)
    {\includegraphics[width=\paperwidth,height=\paperheight]{images/appendix_cover.jpg}};
  \fill[black]
    (current page.north west) rectangle ([yshift=-5.5cm]current page.north east);
  \node[color=thesissand, align=left,
        font=\fontsize{13}{16}\selectfont\sffamily, anchor=west]

...
restoration tools, four studes were conducted: a behavioural experiment
...
study teting habitat structure configurations and materials, and a field
deployment of stone pile habitats in Lake Rotoiti.
...
giants on whose shoulders I stood to advance the study of kōura
(freshwater crayfish) in Aotearoa New Zealand. In particular, I thank
Alan A. Devcich, Laura Beverley Francis, Grant E. Barnes, Brendan J.
Hicks, C. L. Hopkins, I. G. Jowett, Karin Olsson, Per Nyström, Stephanie
M. Parkyn, Nisikawa Usio, Colin R. Townsend, and many others whose
foundational work has shaped our understanding of this species. It has
been a privilege to build upon their contributions and contribute to the
conservation of kōura.

This research would not have been possible without the support and
collaboration of Te Arawa Lakes Trust and Te Komiti Whakahaere. I am
especially grateful to Soweeta Fort-D'ath, William Anaru (Te Arawa Lakes
Trust), and Tihini Grant (Ngāti Pikiao) for their guidance, trust, and
partnership. My sincere thanks also extend to the Tāheke Opatia Marae,
Te Takinga Marae, and landowners, including Piripi Curtis, David
McIlraith, Piki Thomas, Haddon Lock, Barnett Vercoe, Richard Vercoe, and
Caroline Newton, for granting access to monitoring sites and
facilitating fieldwork. Their generosity and stewardship have been
invaluable.

I am profoundly thankful to my supervisors, Deniz Özkundakci, Frank
Burdon, Ian Kusabs, and Robin Holmes for their mentorship, patience, and
unwavering support throughout this journey. I also extend my
appreciation to my co-authors, Calum MacNeil and Finnbar Lee, for their
...
During my PhD journey, I have become increasingly aware of the
limitations and outdated practices within the scientific community.
Issues such as journal paywalls, slow peer review processes, and the
lack of transparency have reinforced my belief that science must be
open, accessible, and inclusive to serve its true purpose. This
conviction inspired me to found ScienceEcosystem.org, an open science
platform aimed at dismantling barriers to knowledge sharing and
fostering a more collaborative and transparent scientific ecosystem. I
am committed to developing this platform further to promote equitable
...
In the next chapter, \textbf{Chapter 4}, we designed and tested shelter
types to determine kōura preference. Kōura are known to use various
materials and compositions, so for this study we tested different
configurations of wood and stone structures in mesocosm experiments to
determine kōura shelter preferences. With an optimal design identified,
\textbf{Chapter 5} deployed five stone pile structures along the
shoreline in Lake Rotoiti and monitored kōura colonisation and abundance
development over 18 months. Finally, the \textbf{General Conclusion}
presents an overview of the findings and considers how structural
habitat restoration can contribute to building resilience in declining
freshwater crayfish populations more broadly. As each of the four
chapters is written as a stand-alone manuscript, some overlap of
background information and methods is unavoidable. However, the general
introduction provides a comprehensive overview of the study system, the
species involved, and the research questions addressed in this thesis.
...
before those were deployed the construction process by using a trailer
and bringing the rocks to the lake was tested in Lake Ōkaro. Lake Ōkaro
is one of the smaller Rotorura Te Arawa lakes and is also volcanic with
an area of 30.19 ha, a max and mean depth of 18 m and 12.5 m.
Waterquality in the lake has been very poor with tropic state flipping
between supertrophic and eutrophic and often algae blooms. To improve
water quality in the lake in 2005 a wetland has been constructed to
remove nitrogens and sediments off the main inflows into the lake. In
lake phosphorous treatment by alim dosings are execute 2 times a year in
the lake. Kōura have not been present in Lake Ōkaro in monitorings from
1981 to 2007 (Parkyn and Kusabs 2007). Monitoring in 2016 and 2017 still
found no kōura in the lake even as waterquality had been improved
(Kusabs 2017). waterquality now should be far enough restored that kōura
should be able to survive in the lake but natural recolonosation has not
happened yet therefore reintroduction might be possible. Lake Ōkaro is
stocked with trout for angling and as a preadaor of kōura, extra refuge
and habitat by stone piles would be good to trial in this lake. The lake
has no stone or rocky substrates therefore the construction of two stone
...
in a T-shape with the top of each 5 m long horizontal with the shore at
3.4 and 6 m of the shore at 1 m depth. To follow dissolved oxygen and
temperature devalopment of the stone piles and how they compare to the
rest of the lake on 11 September 2024 three HOBO U26-001 Dissolved
Oxygen Data Loggers (± 0.2 mg L⁻¹ DO accuracy, ± 0.2 °C temperature
accuracy; 0--30 mg L⁻¹ measurement range; Onset Computer Corporation,
...
In chapter 5 of this thesis stone piles were constructed on the
shoreline of Lake Rotoiti as they were deployed by hand with a trailer,
similar way as was trialed in Lake Ōkaro. Due to the limited range and
mean depth of deployment the question remained if the stone piles would
be effective deeper in the lake and if stone piles would be able to
suppress invasive machrophyte beds. In November 2025 therefore four
stone piles were constructed at various depths. Three of the stone piles
were constructed perpendicular to the shoreline. The first one was
placed underneed a jetty at around 1 m depth. The second one was placed
in the middle of ainvasive machrophyte bed infront of the jetty around 3
m depth. The third one was placed at the end of the machrophytes at a
depth of 7 till 9 m depth. To prevent the stones from sinking into the
sediment, wooden slaps were first installed wherafter the stones were
placed ontop keeping the wooden slaps inplace. The fourth stone pile was
constructed on a bedrock shelf 120 m away from the other stone piles. As
these stones were placed ontop of bedrock no wooden slaps were needed.
Construction was executed by a boat with a winch lowering bags of stones
to the preferd location guided by divers.

Monitoring was executed two times before construction and one time after
construction using spotlighting where after sunset the shoreline and any
available area under the jetty was observed with a torch and kōura
counted and their size estimated. The deeper locations were monitored
using a FIFISH V-EVO remotely operated vehicle (ROV; 4K 60 fps camera;
166° field of view; QYSEA Technology, Shenzhen, China) at night footage
was made of the location before and after stone pile construction and
kōura numbers were counted. Kōura CPUE was calculated over the time
spent filming and the amount of kōura counted.

The first pre monitoring (30/06/2025, water temp 13 °C) resulted in two
kōura seitings while spotlighting and two by the ROV, second pre
monitoring (26/08/2025, water temp 11 °C) showed zero kōura with
spotlighting but seven with the ROV. The monitoring after construction
executed on 1/05/2026 (water temp 16 °C) revealt ten kōura by
spotlighting around at the underneed the jetty and the ROV counted
eleven kōura on the deeper stone piles. Most kōura were seen at the
border of the stone piles where they met with the sandy substrate this
was expected as visual it was hard to look inside the stone piles and
kōura were observed when emerged and started foraging. The stone pile
ontop of the machrophyte bed showed a complete block of machrofyte
growed but at the sides the machrophyes were present densely making
kōura observations difficult.

The trial of placing stone piles at various depths revealt that stone
piles do quickly attract kōura from the surroundings and are able to
suppress invasive macrophytes. By placing stone piles at several depths
kōura can shift to hiding places most suited.

Diving was also executed before and after construction of the stone
piles but as koura are noccturnal during the day its not expected that
the koura will be observed outside of their shelter.

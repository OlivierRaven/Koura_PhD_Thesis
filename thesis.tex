...
nebulosus}) found at {Ōkawa Bay, Lake Rotoiti}. Centre for Biodiversity;
...
Invasions 28:205. \url{https://doi.org/10.1007/s10530-026-03877-5}
...
signal crayfish determined by PIT telemetry. Canadian Journal of Zoology
84:1202--1209. \url{https://doi.org/10.1139/z06-100}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{.ch1\_out }\OtherTok{\textless{}{-}} \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{exists}\NormalTok{(}\StringTok{"ch1\_out\_dir"}\NormalTok{)) \{}
\NormalTok{  ch1\_out\_dir}
\NormalTok{\} }\ControlFlowTok{else}\NormalTok{ \{}
\NormalTok{  f }\OtherTok{\textless{}{-}}\NormalTok{ knitr}\SpecialCharTok{::}\FunctionTok{current\_input}\NormalTok{(}\AttributeTok{dir =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{  thesis\_dir }\OtherTok{\textless{}{-}} \ControlFlowTok{if}\NormalTok{ (}\SpecialCharTok{!}\FunctionTok{is.null}\NormalTok{(f)) }\FunctionTok{dirname}\NormalTok{(}\FunctionTok{normalizePath}\NormalTok{(f)) }\ControlFlowTok{else} \FunctionTok{normalizePath}\NormalTok{(}\StringTok{"."}\NormalTok{)}
  \FunctionTok{file.path}\NormalTok{(thesis\_dir, }\StringTok{"01\_general\_intro"}\NormalTok{, }\StringTok{"outputs"}\NormalTok{)}
\NormalTok{\}}

\NormalTok{trends }\OtherTok{\textless{}{-}}\NormalTok{ readr}\SpecialCharTok{::}\FunctionTok{read\_csv}\NormalTok{(}
  \FunctionTok{file.path}\NormalTok{(.ch1\_out, }\StringTok{"tbl{-}livable{-}trends.csv"}\NormalTok{),}
...
\NormalTok{  dplyr}\SpecialCharTok{::}\FunctionTok{mutate}\NormalTok{(}
    ...
    \AttributeTok{p.value   =} \FunctionTok{signif}\NormalTok{(p.value, }\DecValTok{3}\NormalTok{)}
\NormalTok{  )}

\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(}
\NormalTok{  trends,}
  \AttributeTok{col.names =} \FunctionTok{c}\NormalTok{(}\StringTok{"Lake"}\NormalTok{, }\StringTok{"Season"}\NormalTok{, }\StringTok{"Slope (\% yr⁻¹)"}\NormalTok{, }\StringTok{"SE"}\NormalTok{, }\StringTok{"p{-}value"}\NormalTok{, }\StringTok{"Sig."}\NormalTok{, }\StringTok{"Direction"}\NormalTok{)}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\toprule
Variable & Stone pile & Control & Reference & \textbackslash{}textit\{p\} vs Control & \textbackslash{}textit\{p\} vs Reference\\
\midrule
...
\toprule
Season & Period & Site type & \textbackslash{}ensuremath\{\textbackslash{}psi\} (mean [95\textbackslash{}\% CrI])\\
\midrule

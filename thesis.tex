...
\emph{Write your abstract here --- maximum 350 words. It should cover:
(1) the overarching aim or research question, (2) the methods used
across the study chapters, (3) the main findings of each chapter
collectively, and (4) the overall conclusions and contribution to
knowledge or practice. Write it as continuous prose suitable for
...
\ifcsname c@chapter\endcsname \setcounter{chapter}{6}
\setcounter{section}{0}
...
Oxygen Data Loggers, were placed in the lake for a period of six months.
...
using a ROV (FIFISH V-EVO) at night footage was made of the location
before and after stone pile construction and kōura numbers were counted.
Kōura CPUE was calculated over the time spent filming and the amount of
kōura counted.
...
\ifcsname c@chapter\endcsname \setcounter{chapter}{7}
\setcounter{section}{0}

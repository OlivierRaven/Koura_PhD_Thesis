...
Lake Okaro is a small lake without a known koura population. The water
...
improved over the last decade. Koura used to be in the lake but due to
the poor water quality they probably disapered. Now we wanted to test if
it would be possible to bring koura back to the lake. as trout are
present in the lake, we wanted to make sure the koura that would be
...
refuge for the koura. The stone piles were constructed along the

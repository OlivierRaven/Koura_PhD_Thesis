...
\includegraphics[width=5.5cm]{images/Waikato_logo.png}
...
Native freshwater crayfish (\emph{Paranephrops planifrons}, hereafter
kōura) are a key mahinga kai (cultural harvest) species in Aotearoa New
Zealand with a rich history of harvest and trade by iwi (Māori
communities). Over the past two decades however, kōura populations have
declined by up to 90\% in Lake Rotoiti (North Island, New Zealand),
making traditional harvesting increasingly unviable. This decline is
driven by multiple stressors, including impaired water quality,
intensified lake stratification, and the spread of invasive fish and
aquatic weeds. Since around 2016, the non-native brown bullhead catfish
(\emph{Ameiurus nebulosus}) has become established in the lake and preys
on kōura, compounding upon the effects of other stressors. These threats
indicate that restoring habitat is necessary for kōura population
recovery.

I conducted four complementary studies to investigate and test potential
restoration tools: a behavioural controlled laboratory experiment
...
The results showed that: \textbf{Lab experiment} kōura reacted with
greater refuge use in the presence of the novel catfish than when
exposed to the native predator, longfin eel (\emph{Anguilla
dieffenbachii}).

\textbf{Field survey} Complex shoreline habitats consisting of rocks and
riparian vegetation were best predictors of kōura presence.

\textbf{Mesocosm experiment} When hole sizes were held constant, kōura
showed no preference between wood or stone, but more stable heavier
structures were preferred, and configurations providing refugia across
body sizes showed broadest appeal across size classes of kōura.

\textbf{Field experiment} Stone piles deployed in Lake Rotoiti attracted
kōura at densities more comparable to natural rocky substrates, with
differences relative to bare control sites not yet reaching statistical
significance after 18 months, suggesting that longer monitoring periods
...
Marguet, Ethan Morgan, Logan Kallam, Savio Dsouza, and Matt Prentice,
whose assistance with fieldwork, data collection, and logistical support
was indispensable. Special thanks to Dion and Josh for their friendship
and help in constructing wood splits and blocks.
...
et al. 2018). Freshwater ecosystems like rivers and lakes experience
widespread influences from land-use activities, introduced species, and
climate change (Dudgeon et al. 2006). This degradation is particularly
concerning given that freshwater systems disproportionately support
biodiversity and ecosystem services relative to their global area. Among
freshwater ecosystems, lakes are particularly sensitive to land-use
pressures because they integrate inputs from their entire catchment,
accumulating nutrients, sediment, and contaminants over time (Bhateria
and Jain 2016). Within lakes, these stressors are unevenly distributed
as they converge most acutely in the shallow littoral zone which is the
productive interface between the terrestrial and aquatic system (Strayer
and Findlay 2010). The littoral zone is characterised by its exposure to
...
nurseries for numerous species (Meerhoff and González-Sagrario 2022a).
This vegetation significantly contributes to the energy and nutrient
cycles within lake food webs. Unfortunately, lake shorelines are often
heavily impacted by human activities such as hardening, the introduction
of invasive species, and pollution (Vadeboncoeur et al. 2002; Strayer
and Findlay 2010). Despite their importance, the effects of
eutrophication and predation by non-native species in the littoral zone
remain relatively understudied (Vander Zanden and Vadeboncoeur 2020).
Rocky littoral habitats and structurally complex areas can function as
refugia, buffering multiple species against co-occurring threats, making
their protection a conservation priority in its own right (Selwood and
Zimmer 2020). Reversing the degradation of these productive but
vulnerable littoral habitats requires targeted interventions, though
these are often complex and resource-intensive (Palmer et al. 2005), a
challenge that has driven recent global commitments to ecosystem
restoration such as reduction of nutrient inputs by creating bufferzones
at lakes inlets and landscape connectivity (Meerhoff et al. 2022).

\section{Ecosystem and habitat
restoration}\label{ecosystem-and-habitat-restoration}

Reversing widespread degradation, of freshwater ecosystems and beyond,
has prompted growing global investment in ecosystem and habitat
restoration. The UN declared 2020-2030 the Decade for Ecosystem
Restoration, with the intention of halting the degradation of ecosystems
around the world (UN. General Assembly 2019; Gann et al. 2019; Cooke et
al. 2022), as habitat degradation and loss remain key drivers of
regional population extinction (Heinrichs et al. 2016). Ecosystem
restoration aims to recover an entire ecosystem including its structure,
function and dynamics, often focussing on enhancing resilience to future
stressors. Habitat restoration is a more targeted component of this
broader goal, focusing on enhancing the quality or availability of
habitat for a specific species or community, rather than an entire
ecosystem. Approaches to habitat restoration vary widely depending on
the system and species involved, but commonly include actions such as
replanting native vegetation, removing barriers like dams, or adding
structure to a habitat that has become structurally simplified or
degraded, approaches applied across terrestrial, coastal and freshwater
systems alike (Banks-Leite et al. 2020; Loch et al. 2020).

Adding structure is one of the more direct and widely applied forms of
habitat restoration, since many species depend on physical complexity in
their environment for shelter, feeding or reproduction (Geist and
Hawkins 2016). In marine systems, this principle is most visibly applied
through artificial reefs, structures placed on the seafloor to rebuild
the complexity lost from degraded or removed natural reef habitat,
supporting biodiversity recovery and fisheries productivity (Frehse et
al. 2025). While artificial reefs are most often associated with marine
environments, the same principle that adding physical structure to a
degraded habitat can restore the complexity and shelter availability,
extends to freshwater systems as well (Geist and Hawkins 2016).

In freshwater environments, this principle has been applied through the
addition of rock, woody debris, or other natural substrates to streams
and lakes that have lost structural complexity through historic
modification, sedimentation, or substrate removal (Smokorowski and Pratt
2007; Roni et al. 2008). These additions have been used to support a
range of freshwater taxa, including fish and invertebrates, by
recreating the kind of structurally complex habitats that naturally
support shelter, feeding and reproduction (Santos et al. 2011; McLean et
al. 2015; Zhu et al. 2021). However, not all added structures achieve
their intended benefit, poorly designed or inappropriate materials such
as plastic habitat structures can fail to replicate natural habitat
function and risk becoming a form of littering rather than restoration
(Baine 2001; Cooke et al. 2023), underscoring the importance of careful
design when structures are used as a restoration tool. Within freshwater
systems, structural restoration is particularly relevant for taxa that
depend on physical complexity for shelter, including freshwater
crayfish, a group of significant ecological and conservation importance
globally and one facing severe declines across much of its range.
...
\pandocbounded{\includegraphics[keepaspectratio]{images/fig-crayfish-families.png}}
...
left) and brown bullhead catfish (Ameiurus nebulosus, red, right), an
introduced predator discussed in the following section, in Aotearoa New
Zealand. Source: New Zealand Freshwater Fish Database (Stoffels 2024).}
...
2004). Kōura are associated with structurally complex habitats that
...
avoid areas where dissolved oxygen levels drop below 5 mg L\(^{-1}\) and
...
free-living larval stage. Females carry eggs and newly hatched juveniles
...
and 91 \% in kōura catch per unit effort (CPUE) in Lakes Rotorua and
Rotoiti respectively (Figure~\ref{fig-koura-decline}). These declines
reflect a multiple-stressor problem: long-term water quality
deterioration and habitat loss from invasive macrophytes have reduced
kōura populations over decades, with the recent establishment of the
brown bullhead catfish (\emph{Ameiurus nebulosus}) as a novel predator
compounding these pressures and accelerating the decline (Kusabs et al.
2026).
...
\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{images/fig-koura-decline2.png}
...
Crossman 1973; Dedual 2019). Catfish are known predators of kōura, and
have contributed to declining kōura CPUE in Lakes Rotorua and Rotoiti
(Kusabs et al. 2026). While kōura abundance had been declining before
catfish establishment, the decline became less variable after 2016, with
fewer recovery periods, suggesting catfish have reduced the population's
capacity to rebound (Kusabs et al. 2026). Catfish habitat use varies
seasonally: in lakes, catfish occupy depths down to approximately 17 m
(Dedual 2002) and shift between weedy and rocky habitats depending on
the season, primarily rocky habitats in winter when macrophytes die
...
size (Scott and Crossman 1973). Acoustic tagging of catfish in Lake
Rotoiti confirmed these seasonal patterns: catfish concentrated in
nearshore shallows during spring and summer, likely seeking warmer water
for feeding and reproduction, before dispersing to mid-water offshore
habitats in winter rarely exceeding 15 m depth even when the lake is
...
and Zimmer 2020). Restoring structural habitat may therefore reduce the
effect of fear of living alongside a novel predator.
...
(Land, Air, Water Aotearoa (LAWA) 2025).}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0881}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1195}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1384}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1321}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0943}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0881}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0755}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0881}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0881}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0881}}@{}}
...
\bottomrule\noalign{}
\endlastfoot
Rotorua & 81.0 & 45 & 508.0 & 11.0 & 45.0 & 0.24 & 280 & Polymictic &
Eutrophic \\
Rotoiti & 34.0 & 61 & 123.7 & 31.5 & 124.0 & 0.25 & 279 & Monomictic &
Mesotrophic \\
Rotoehu & 8.0 & 40 & 49.2 & 8.0 & 13.5 & 0.59 & 295 & Polymictic &
Eutrophic \\
Rotomā & 11.0 & 24 & 27.8 & 36.9 & 83.0 & 0.44 & 316 & Monomictic &
Oligotrophic \\
Ōkataina & 11.0 & 29 & 59.8 & 39.4 & 78.5 & 0.50 & 305 & Monomictic &
Oligotrophic \\
Ōkāreka & 3.0 & 11 & 19.6 & 20.0 & 33.5 & 0.60 & 355 & Monomictic &
Mesotrophic \\
Tikitapu & 1.0 & 5 & 6.2 & 18.0 & 27.5 & 0.65 & 355 & Monomictic &
Oligotrophic \\
Rotokākahi & 4.0 & 16 & 18.7 & 17.5 & 32.0 & 0.55 & 395 & Monomictic &
Mesotrophic \\
Tarawera & 41.0 & 48 & 143.1 & 50.0 & 87.5 & 0.57 & 305 & Monomictic &
Oligotrophic \\
Rotomāhana & 9.0 & 27 & 83.3 & 60.0 & 125.0 & 0.48 & 340 & Monomictic &
Mesotrophic \\
Ōkaro & 0.3 & 2 & 3.9 & 12.5 & 18.0 & 0.69 & 280 & Monomictic &
Eutrophic \\
Rerewhakaaitu & 5.0 & 25 & 37.0 & 7.0 & 15.8 & 0.44 & NA & Polymictic &
Eutrophic \\
...
(Figure~\ref{fig-rotoiti-weeds}). Current lake management prioritises
...
available habitat, where suitable depths shrink to precisely the zone
where predation risk is highest. The importance of an oxygenated deep
refuge is illustrated by Lake Taupō (maximum depth 186 m), where catfish
and kōura co-exist because deep waters remain oxygenated below the
...
proportion of each lake's bottom area that remains ``liveable'' meaning
sufficiently oxygenated and within thermal optimum for kōura. Across
eleven of the Rotorua Te Arawa Lakes, liveable habitat varies strongly
...
significant declines in annual mean liveable habitat, with Rotorua and
...
structural restoration can build resilience in kōura populations. In
lakes where muddy substrates provide limited refugia, adding rocky
substrate has been shown to relax refugia limitation and increase
crayfish population density (Johnsen and Taugbøl 2008).
...
column meeting dissolved oxygen (\textgreater{} 5 mg L\(^{-1}\)) and
...
mean liveable habitat for kōura across eleven of the Rotorua Te Arawa
Lakes. Liveable habitat is defined as the proportion of the water column
...
understood, several critical knowledge gaps limmit our ability to design
...
interactions, questions relevant to to freshwater prey specis facing
novel predatores globally. First, while catfish are implicated as a key
driver of kōura decline, the effect catfish have on kōura behaviour
leading to non-consumptive effects in comparison with native predators
had not been quantified. We therefore conducted aquarium experiments in
which kōura refuge use was recorded when exposed to native longfin eels
and to catfish. We expected that kōura would show no response to catfish
consistent with predator--prey naïveté (Sih et al. 2010), or that they
would show stronger antipredator responses to the novel catfish than to
native eels, consistent with generalised fear response (Sih et al.
2023). Second, the natural habitats that kōura prefer had been described
in streams and deeper parts of lakes but which shoreline habitat
features kōura prefer remained unknown. We therefore monitored kōura
presence at 60 shoreline sites across five of the Rotorua Te Arawa
Lakes, recording habitat features and fish species. We expected that
rocky substrates with high structural complexity would be the primary
predictor of kōura presence, consistent with stream habitat studies
(Jowett et al. 2008; Olsson 2008). Third, although habitat enhancement
structures had been applied in freshwater systems globally to support
fish and invertebrates (Smokorowski and Pratt 2007; Santos et al. 2011),
few studies had tested which combinations of material and structural
configuration best support crayfish specifically. We therefore designed
and tested multiple shelters configurations using wood and stone in
mesocosm experiments. We expected that configurations providing multiple
crevices of varying sizes would be preferred by the widest range of
kōura, including juveniles. Finally, no field deployments of habitat
enhancement structures for kōura in lakes had previously been reported.
Therefore, we deployed stone piles in Lake Rotoiti and expected that
kōura populations at the stone piles would increase, as providing more
refuge habitat would allow more kōura to avoid predators. A secondary
aim of the final study was to identify potential unintended consequences
of habitat enhancement, including the risk that structures may provide
refuge for catfish. This thesis addresses each of these gaps in turn
through four research chapters, building from behavioural mechanisms in
controlled conditions, through natural habitat use, to structure design,
and finally to field deployment.
...
each of the four chapters are written as stand-alone manuscripts, some
...
bias correction factor \(10^{0.5 \sigma^2}\) (Quinn and Keough 2002).
...
conservation (Meerhoff and González-Sagrario 2022b). As shoreline
...
{[}{Figure~\ref{fig-length-weight-ch5}}{]} (Froese 2006). Predicted
values were back-transformed with a lognormal bias correction factor
(10\^{}\{0.5 \cdot \sigma\^{}2\}) (Quinn and Keough 2002).
...
conducted in R (version 4.6.1; R Core Team (2025)) using the glmmTMB and
emmeans packages (Brooks et al. 2017; Lenth and Piaskowski 2017).
...
round as interaction terms and site nested within pair as a random
effect using similar families as the BACI models.
...
Covariate selection for each model was performed by comparing Corrected
...
more than 2 units relative to the base model (Burnham and R. 2002).
...
using the brms package (Bürkner 2017, 2018) using cmdstanr
(\textbf{Gabry2025?}) to estimate true occupancy and detection
probabilities for baited traps and fyke nets via logit links.
Standardised water temperature was included as the covarient for
...
compressing kōura into the nearshore zone where catfish predation
pressure is highest and the stone piles are located. The warm-season
model maximimises ecological relevance monitoring rounds and retained a
...
each simulated dataset was analysed using a logistic GLMM (lme4;
(\textbf{Bates2015?})). For the CPUE BACI, simulated abundance data were
...
fitted to a log-transformed CPUE. Statistical power as estimated as the
...
crayfish is a slow process: Johnsen and Taugbøl (2008) reported that
crayfish abundance at a stone site addition site took 13 years to reach
levels comparable to a control site, and freshwater invertebrate
colonisation studies generally show treatment effects emerging over two
to three years (\textbf{BRON?}). Following reconstruction of the Rotorua
lakefront, which included rocky kōura habitat only 17 kōura were
...
(\textbf{Kusabs2023?}). This suggests 18 months represents a minimum
rather than a sufficient monitoring duration for detectecting
population-level responses to habitat addition.
...
most productive zone of the lake (Devcich 1979). Occupancy is therefore
...
this intervention. For kōura CPUE the simulation-based power analysis
showed that for a power of 80 \% 167 pairs are needed which is not
duable with the current monitoring design but realisticly the stone
piles deployed during this study only covered in total \textasciitilde60
m2 which is compared to the 60 km length of the shore line hardly
noticeable therefore we expect before we can see a lake wide effect
deplometn of 167 stone pile sites does not sound strange.
...
rise (\textbf{BRON?}), increasing invertabrate activity
(\textbf{BRON?}), and reduction in nutrient availability due to
stratification(\textbf{BRON?}) the filamentous mats will break down and
the stone piles become available for kōura again (\textbf{BRON?}).
During the winter of 2025 the growth was not observed as it takes time
for
...
connectivity to deep waters (\textbf{BRON?}). Variation within the
reference paires shown by catfish difference during baseline check shows
that small local heterogeneity has influence on species abundance.
...
Bay where the highest population of catfish is present (Francis 2019).
Catfish have strong seasonal movement patterns with staying close to the
shoreline during spring and summer probably looking for warmest waters
to feed their young. While in winter movement increases and catfish
spread across the lake swimming mid-water not going deeper than 15 m
even when lake bottom is deeper (Blanchfield et al. 2026). For kōura
this means that during spring and summer the threat of catfish is
highest and habitat compression during this period also being greatest
further limiting the survival chances of kōura (\textbf{BRON?}).
\ldots{}
...
(\textbf{BRON?}). The need for removal of biofilm or cleaning of the
crevices from sediments could potentially restore structural complexity.
Placement of stone piles on wave intensive locations might help with
natural cleaning of the stone piles but could potentially be to rough as
a shelter for kōura. A monitoring period of 18 months is not ideal to
access the effectiveness of habitat restauraion and it is reomended to
continue monitoring for a total of 3 years. Continue of monitoring will
reveal of the crash of kōura CPUE in Winter 2026 was a individual
occurrence and colonasation of kōura in the stone piles will pick up
again in coming spring and summer when habitat becomes limited again and
the filamentous algae densety is less. A standardes assessment of
fouling is recommended with similar sides of the stones being
photocraphed every monitoring to compare devalopment and seasonal
variation.
...
multiple species and threats (Selwood and Zimmer 2020) the value of
...
with heightened refuge use to novel predatores than native ones. Field
...
those on natural rocky substrates. This chapter will synthesise on the
findings and main discussions of each chapter and presents two pilot
...
different monitoring methods will be discussed. Together with the main
chapters, these case studies broaden the application of the restoration
...
As documented by Kusabs et al. (2026), the establishment of catfish
(\emph{Ameiurus nebulosus}) in Lakes Rotorua and Rotoiti has been
accompanied by substantial declines in kōura abundance and biomass.
Catfish predation is, however, only one of the three compounding
stressors that together determine where kōura can persist in the Rotorua
Te Arawa Lakes. The second stressor is thermal stratification and the
seasonal anoxia it produces. As described in the general introduction,
stratification compresses the zone of liveable habitat for kōura into
the shallow littoral margins of the lake, this is the same zone where
catfish are most active. For fish, habitat compression is conventionally
calculated volumetrically, since fish use the full water column. This
volumetric loss is disproportionately large in shallow sloped lakes like
Rotorua and Rotoiti compared to deep-basin lakes due to the
concentration of water volume near the surface (Detmer 2026). For kōura,
as bottom-dwelling animals, the constraint is more severe as liveable
habitat is defined by bottom area, not volume, so compression of the
oxygenated zone translates directly into a reduction of available
benthic surface. Catfish are largely unaffected by this compression,
tolerating both low oxygen and elevated temperatures, while kōura are
driven upwards into the shallow zone where predation pressure is
highest. Climate projections suggest this dynamic will intensify as
stratification strengthens and anoxic events become more frequent and
prolonged ({Jane et al.} 2021; Lee et al. 2025). The third stressor is
the presence of invasive macrophytes in the littoral zone. Dense
macrophyte beds reduce the structural complexity of the shoreline,
replacing and or covering up rocky habitats reducing preferred kōura
habitat with a dense uniform layer that favours catfish. Macrophytes
also contribute to oxygen depletion during die-off events, further
reducing the habitable area available to kōura. The field surveys in
Chapter 3 provide additional grounding for this compounding effect.
Across the five monitored lakes, oligotrophic lakes with structurally
complex shorelines and no catfish present had the highest kōura catches,
while lakes like Rotorua and Rotoiti with catfish, eutrophication,
stratification, and extensive macrophyte cover yielded substantially
lower kōura numbers. Habitat restoration is therefore not a stand-alone
solution. Stone pile deployment can address structural habitat
availability, but not the other stressors and as a stand-alone action it
will have limited effect. Evidence from Chapter 3 suggests that kōura
recovery requires water quality improvement, predator management,
macrophyte control, and habitat restoration working together, with
restoration most likely to succeed in lakes with improving conditions.

\section{Fear as a reason to build}\label{fear-as-a-reason-to-build}

Chapter 2 showed that kōura react with heightened refuge use when
exposed to catfish compared to native predators like eels. This is
consistent with the response expected of a prey species encountering a
novel predator, one of which it has no evolutionary history and
therefore no calibrated sense of risk (Sih et al. 2023). This leads to
maximum caution, kōura increase their chance of survival, but at a cost.
An animal spending more time in refuge is an animal spending less time
foraging, leading to slower growth and reduced reproductive outputs.
This is the core mechanism behind the landscape of fear (Laundré et al.
2001), where predators do not need to eat every prey individual to
suppress a population, but their presence alone is sufficient to reshape
how prey use space and time, and those behavioural changes carry
demographic consequences. In the context of the Rotorua Te Arawa Lakes,
this means that catfish suppress kōura populations through two channels
simultaneously. Direct predation removes individuals and fear-induced
behavioural change reduces the reproductive capaccity of those that
survive. Population recovery under these conditions is likely to be slow
even if predation rates are reduced, because the behaviour suppression
persists as long as catfish are present. Habitat restoration can play an
important intervantion. Chapter 5 showed that stone piles in Lake
Rotoiti attracted kōura densities approaching those on natural rocky
substrates, despite the ongoing presence of catfish. High-quality refuge
does not eliminate the fear response, but it provides kōura with
locations where they can shelter effectively, emerge to forage in
relative safety, and maintain sufficient activity levels to reproduce.
In catfish-invaded lakes where predator eradication is ongoing, habitat
provision may therefore be what allows a remnant population to persist
and slowly recover rather than declining to local extinction. Stone
piles are not solving fear responses but they could be helpful in
...
Before deploying stone piles in Lake Rotoiti, the construction logistics
of loading stones onto a trailer and placing them by hand were first
trialled in Lake Ōkaro. Lake Ōkaro is one of the smaller Rotorura Te
Arawa volcanic lakes with an area of 30.19 ha, a max depth of 18 m and a
mean depth of 12.5 m. Water quality in the lake has been very poor with
trophic state flipping between hypereutrophic and eutrophic and frequent
algae blooms (\textbf{BRON?}). To improve water quality in the lake, in
2007 a wetland has been constructed to remove nitrogen and sediments off
the main inflows into the lake (Hudson et al. 2009). Twice a year alum
dosings (aluminum sulfate) are executed as in lake phosphorous treatment
...
Te Mana o Ngāti Rangitihi Trust, and Bay of Plenty Regional Council.
Stones were sourced from Rainbow Quarry located on Rainbow Mountain
three km from the lake. Stones used had a size range of 70-210 mm mean
120 mm and a total of 5 m\(^{3}\) was divided over two stone piles on
the north east shore of the lake. Stone piles were placed 3 and 6 m of
the shore, horizontal each 5 m long and 2 meters wide at 1 m depth. To
follow dissolved oxygen and temperature development of the stone piles
and how they compare to the rest of the lake on 11 September 2024 three
HOBO U26-001 Dissolved Oxygen Data Loggers (± 0.2 mg L\(^{-1}\) DO
accuracy, ± 0.2 °C temperature accuracy; 0--30 mg L\(^{-1}\) measurement
range; Onset Computer Corporation, Bourne, MA, USA), were placed in the
lake for a period of six months. Two loggers were buried inside the
stone piles and a third logger was placed outside of the stone piles as
control. In October 2024 twenty kōura sourced from within the catchment
were reintroduction on the stone piles to start a new population of
kōura in the lake.

In the early summer of 2024 the lake stratified rapidly with oxygen
levels dropping quickly and at December 10th oxygen levels reaching less
...
below tolerance. Kōura survival through this event is unlikely given the
prolonged hypoxic conditions.

\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{outputs/fig-okaro-combined.png}}
...
Construction of stone piles by hand is a very cheap and easy way of
building extra structure and refuge for kōura in the shallows. The
reintroduction of kōura was made difficult by a strong anoxic event.
Nevertheless the lessons learnt were of great value for the further
development of the stone pile structure as the stone size in Ōkaro was
smaller (range 70-210 mm; mean 120 mm) leading to more effort of getting
the stones from the trailer into the lake and smaller stones provide
smaller crevice sizes limiting shelter availability for larger size
kōura. For deployment in Lake Rotoiti slightly larger stones (85-315 mm;
mean 173 mm) were therefore selected to build the stone piles. This size
range was very convenient as the size of the stones was requiring
machinery for lifting which gave the opportunity to throw the stones
further than the end of the trailer and made it possible to rearrange
the stones if needed. The Ōkaro trial demonstrated that habitat
restoration cannot succeed ahead of water quality recovery. The anoxic
event that followed stone pile deployment confirmed that structural
complexity provides no benefit when dissolved oxygen drops below kōura
tolerance, kōura cannot use a refuge they cannot reach. This reinforces
the sequencing argument made later in this chapter: habitat provision
must follow, not precede, the establishment of survivable conditions.

\section{Case study - deep stone piles Lake
Rotoiti}\label{case-study---deep-stone-piles-lake-rotoiti}

All stone piles deployed in the preceding chapters, and in the Ōkaro
trial, were built by hand from the shore and therefore limited to
shallow, nearshore depths. Extending deployment across a depth gradient
required working from a boat, which opened two additional possibilities:
placing structures at depths beyond wading distance, and positioning
them within invasive macrophyte beds to test whether stone coverage
could suppress growth. Monitoring at greater depths is not well suited
to standard netting, so spotlighting, remotely operated vehicle (ROV)
...
The stone piles in the macrophyte bed and deeper were after sunset
monitored using a FIFISH V-EVO (4K 60 fps camera; 166° field of view;
QYSEA Technology, Shenzhen, China). The ROV was used to swim transects
at the location of the stone piles and kōura shown were counted. Kōura
CPUE was calculated over the time spent monitoring. Spotlight and ROV
monitoring was executed two times before stone pile construction, and
...
invasive macrophyte bed in front of the jetty around 3 m depth, and the
...
were first installed after which the stones were placed, holding the
...
designated location and emptied by divers.
...
spotlighting but seven with the ROV. The human dive did not find any
...
stone piles in front of the jetty monitored by the ROV. Most kōura were
seen at the border of the stone piles where they met with the sandy
substrate; this was expected as visual it was hard to look inside the
stone piles and kōura were observed when emerged and started foraging.
The stone pile in the macrophyte bed showed a complete block of
macrophyte growth but at the sides the macrophytes were present densely
making kōura observations difficult. The human diving did not find any
kōura (15/01/2026; water temp 21.7 °C) but noticed many bullies around
the stone piles. The second human dive (28/07/2026; water temp 11.1 °C)
found again no kōura.
...
of the engines the kōura do emerge from their hiding place and they do
not look affected by the monitoring of the ROV. Extending deployment
across a depth gradient adds an important dimension absent from the
shallow shoreline work of chapter 5. Kōura can access and use refuges
below the macrophyte zone, and structures distributed across multiple
depths give the flexibility to shift between refuges as thermal
stratification seasonally compresses the oxygenated zone upward. Stone
piles at depth therefore address not only structural habitat
availability but also the habitat compression dynamic identified as a
key stressor in the Rotorua Te Arawa Lakes, and the observed suppression
of macrophytes at deeper piles suggests an additional co-benefit of
restoring structural habitat in overgrown littoral zones and possibly
creates corridors connecting deep and shallow habitats.
...
Methods that sample a general area answer ``how many kōura are present
in this location?'' while active, site specific methods answer ``are
kōura using this structure?''. These are distinct questions, and
selecting the right monitoring method for each is relevant. Traditional
Māori harvesting methods using tau kōura with whakaweku (bundles of
bracken fern \emph{Pteridium esculentum}) have proven effective for
kōura monitoring in lakes and stream habitats (Kusabs and Quinn 2009;
...
creates habitat. Using it to assess whether stone piles attract kōura
would confound the monitoring tool with the intervention, making it
impossible to determine whether kōura are responding to the stone pile
or the whakaweku itself. Passive netting with single-winged fyke nets
and baited box traps was therefore used throughout Chapter 3 and 5. Box
traps baited with trout flesh in Chapter 3 and catfish flesh in Chapter
5. When comparing catches at Lake Rotoiti sites, no difference was found
between bait types. This was expected as kōura scavenge carcases of dead
predator fish without bias towards native or non-native species (MacNeil
et al. 2025). Trout as bait yielded a CPUE of 0.682 kōura per trap and
catfish bait 0.638 kōura per trap. Unbaited fyke nets had a notably
higher CPUE of 2.71 kōura per trap in the same lake, consistent with
their larger net opening and longer fishing lead. Fyke nets also catch
other fish species, which is useful if community composition is of
interest. However, 24-hour passive netting provides an approximation of
local abundance rather than direct evidence of habitat use. Trap catches
alone cannot determine whether kōura are actively using stone piles or
are simply present in the surrounding area. For Chapter 5 higher catches
near stone piles were therefore interpreted as indicating greater
habitat use of the structures. In structurally complex habitats, fyke
nets must be placed flat on the sediment to fish effectively; on rocky
substrates this is often not possible, and kōura may pass beneath the
net opening entirely. At the deep structures build in Lake Rotoiti, more
active monitoring approaches were applied including spotlighting, human
dive surveys, and ROV dive surveys. These methods allow direct
observation of kōura using the structures and are easier to execute over
depth than netting.
...
to detect crayfish in similar stream system (Harwood et al. 2025, 2026).
Conversely, eDNA has detected invasive crayfish in lakes where trapping
alone could not (Dougherty et al. 2016), suggesting it may be better
suited to lake-scale presence-absence assessments than to evaluate kōura
use of specific structures. Passive acoustics offer a complementary
approach as crayfish produce distinctive sounds during movement and
feeding, and acoustic methods have shown potential for identifying
crayfish behaviour in field and laboratory settings (Buscaino et al.
2012; De Vita et al. 2023). Application in marine systems has advanced
further, including detection of spiny lobsters over great distances
(Jézéquel et al. 2020, 2023), and the potential for passive acoustic
monitoring in lakes warrants exploration for kōura.

\section{What restoration can and cannot
fix}\label{what-restoration-can-and-cannot-fix}

Chapter 3 showed that kōura were most consistently associated with
...
candidates for stone pile restoration. Chapter 4 confirmed that
stability and structural complexity are the decisive factors in kōura
shelter selection, and stone piles deliver both. In lakes where
...
broader lake conditions improve. Stone piles can also physically
suppress invasive macrophytes at the placement site as demonstrated in
the deep Rotoiti case study. Whether habitat restoration achieves those
benefits depends on whether habitat is actually the limiting factor. In
a Norwegian lake where muddy substrates limited noble crayfish
(\emph{Astacus astacus}) distribution, adding rocky substrate to
previously unproductive areas resulted in colonisation and improved
harvest (Johnsen and Taugbøl 2008). In that system, habitat was the
constraint, and removing it produced a measurable response. Similarly,
structure additions to streams have been shown to improve success of
crayfish restocking efforts (Huolila et al. 1997). In both cases, the
stressor being addressed was the primary one operating on the
population. The situation in the Rotorua Te Arawa Lakes is more complex.
Lack of suitable habitat is one of the compounding stressors, and
addressing it alone will not produce the same clear response. If
dissolved oxygen drops below kōura tolerance, structure is irrelevant as
demonstrated by the anoxic event in Lake Ōkaro. If catfish pressure
remains high, stone piles improve survival odds but cannot prevent the
ongoing suppression from predation and fear effects. Restoration
therefore sets a ceiling defined by the other stressors: Chapter 3
showed that the lakes with the best habitat and the best water quality,
most complex habitat, and no catfish support the highest kōura
abundance. The question is not whether to restore habitat, but at what
point in a lake's recovery trajectory habitat becomes the limiting
factor, and before that point, improving water quality and reducing
predator pressure will produce greater return. The sequence of kōura
population recovery would start with stabilising water quality to a
point where it falls within kōura acceptable limits, then focus would
need to be on predator management, lowering the predation pressure and
then habitat recovery and if needed reintroduction.

\section{Future direction}\label{future-direction}

What have we learnt for the future\ldots{}

\subsection{Scaling restoration}\label{scaling-restoration}

When water quality and other aspacts are solved, stonepile deployment in
catfish invaded lakes helps

\subsection{Community contributions}\label{community-contributions}

Residents living along the lakes could help also instead of having a
retaining wall not providing habitat replace it with stones and bring
the stones into the deeper parts if possible to create kōura shelters.
under jettys placing stones are out of the way of boating or swimming
and create perfect structure for kōura.

\begin{figure}

\centering{

\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{images/koura_wheel2.png}

}

\caption{\label{fig-koura-wheel}Kōura weels by Mark Robinson Lake
Tarawera}
...
\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{images/koura_pipes.png}

}

\caption{\label{fig-koura-pipes}Kōura pipes by Mark Thomson Lake
Rotoiti}
...
Increasing shelter availability in the lake will atrrect kōura which in
turn can lead to kōura population recovery with in the future possible
recovery of cultural practices as now little is happening in Cherry Bay
(Ōkahuroroa Bay) Rotoiti with abundunce tau kōura monitoring brining a
high density of whakaweku creating complexity.

The hard but honest truth on restoring the cultural kōura harvest in
Lake Rotoiti. Due to the confounding effects of the multiple stressores
and the expectation of climate change and treaths of new exotic species
the honst take away is that koura definitely play an crucial role in the
lakes and will probably not become extinct in the lakes but lake wide
populations will with percistent catfish predation not reach historical
numbers needed for cultural harvests. catfish and koura might find a new
predator prey equaribium when funding for catfish elimination stops.
Focus should be therefor on protecting the spread of catfish and
invasive weeds to new lakes with good and stable koura populations like
Lake Rotoma, Okareka and Tarawera
...
\begin{tikzpicture}[remember picture, overlay]
  \node[inner sep=0pt, anchor=north]
    ...
    {\includegraphics[height=\dimexpr\paperheight-5.5cm\relax]{images/ch7_cover.jpg}};
  \fill[black]
    (current page.north west) rectangle ([yshift=-5.5cm]current page.north east);
  \node[color=thesissand, align=left,
        font=\fontsize{13}{16}\selectfont\sffamily, anchor=west]
...
\textless i\textgreater stan\textless/i\textgreater. Journal of
Statistical Software 80: \url{https://doi.org/10.18637/jss.v080.i01}
...
\bibitem[\citeproctext]{ref-Detmer2026}
Detmer TM (2026) From vertical to volumetric constraints: Basin shape
mediates oxythermal fish habitat compression. Hydrobiologia.
\url{https://doi.org/10.1007/s10750-026-06276-y}
...
Meerhoff M, González-Sagrario M de los Ángeles (2022a) Habitat
...
Meerhoff M, González-Sagrario M de los Ángeles (2022b) Habitat
complexity in shallow lakes and ponds: Importance, threats, and
potential for restoration. Hydrobiologia 849:3737--3760.
\url{https://doi.org/10.1007/s10750-021-04771-y}
...
\caption{\label{fig-descriptive-context-ch5}Descriptive context plots,

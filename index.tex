...
\urlstyle{same}
\hypersetup{
  pdftitle={Kōura habitat{,} behaviour{,} and the design of artificial reefs in New Zealand lakes},
  pdfauthor={Olivier V. Raven},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}


\title{Kōura habitat, behaviour, and the design of artificial reefs in
New Zealand lakes}
...
Quote: ``The more we learn, the easier the human world becomes---but the
...
partnership. My sincere thanks also extend to the Tāheke marae and
landowners, including Piripi Curtis, David McIlraith, Te Takinga Marae,
Piki Thomas, Tāheke Opatia Marae, Haddon Lock, Barnett Vercoe, Richard
Vercoe, and Caroline Newton, for granting access to monitoring sites and
...
Finally, I acknowledge the traditional knowledge and cultural
significance of kōura to local communities. Their wisdom has guided this
research and reinforced the importance of integrating Indigenous
perspectives into conservation efforts. It is my hope that this work
contributes meaningfully to both scientific progress and the
...
\chapter{General Introduction}\label{general-introduction-1}
...
experience pervasive influences from land-use activities, introduced
...
ecological and conservation importance globally.
...
crayfish species (Holdich et al. 2009). Therefore, conservation of
native crayfish therefore requires understanding not only the threats
they face but also the habitats they depend on, a challenge particularly
acute for endemic species in geographically isolated systems such as
those of Aotearoa New Zealand.
...
their common Māori name of kōura, although some iwi (Māori tribal
groups) use other names including kēwai, kēkēwai, and koeke. The two
species are the northern kōura (\emph{Paranephrops planifrons} White
1842) and the southern kōura (\emph{P. zealandicus} White 1847). The
northern kōura can be found all over the North Island and on the west
...
\pandocbounded{\includegraphics[keepaspectratio]{images/fig-nz-distribution-maps.png}}
...
Kōura are recognised as ecologically important and have been described
as keystone species in some systems (Collier et al. 1997) and inhabit
both streams and lakes. They tend to avoid areas with low dissolved
oxygen (DO \textless{} 5 mg/L) (Broughton et al. 2017) but have been
observed in streams with a pH as low as 4.1 and calcium concentrations
of 0.9 mg/L (Olsson et al. 2006). Kōura are sensitive to light greater
than 150-205 lux and stay therefore in deeper parts of lakes or use
shelters in shallower areas (Devcich 1979). They occur across a range of
substrates but prefer complex habitats, such as coarse gravel or rocky
substrates, which provide shelter (Jowett et al. 2008; Kusabs et al.
2015b). In streams, their highest abundance was recorded on substrates
with an average length of 10 cm (Olsson 2008). Kōura are omnivorous
scavengers and consume a wide range of food resources including
invertebrates (aquatic snails, chironomids, and mayflies) and detritus
(Parkyn et al. 2001). During daylight hours, kōura are most vulnerable
as prey for birds or other predators. Therefore, they will hide in
shelters or in deeper parts of lakes during the day and move to
shallower places during the night (Devcich 1979). When natural
substrates providing hiding places are rare, kōura can excavate tunnels
or burrows to provide cover. This behaviour is only possible if the
substrate is suitable like clay or pumice sand, such as in Lake Tikitapu
where tunnelling behaviour has been observed. Kōura have direct
development: females carry eggs and then newly hatched juveniles beneath
the abdomen for approximately three weeks before release, typically at
depths of less than 10 m in lakes (Parkyn and Kusabs 2007). Juveniles
mature in two to three years depending on water temperature (Devcich
1979; Parkyn 2000).
...
and Quinn 2009). Māori harvest kōura just like other kai (food) in
...
the Auckland region --- reportedly by mistake, as the intended species
was channel catfish (\emph{Ictalurus punctatus}) (Barnes 1996). Although
Lake St John has since been drained, catfish persisted and have spread
throughout the upper North Island via accidental and deliberate releases
...
catfish were recovered during weed harvesting operations (Francis 2019).
Catfish subsequently spread to Lake Rotorua in 2018 via the Ōhau
Channel. Since 2016, routine monitoring and active control fishing have
been carried out to reduce their impact (Grayling 2020). Aotearoa lacks
native Siluriformes, making catfish a novel predation threat to which
native species may lack adequate behavioural or sensory adaptations (Sih
et al. 2010; Carthey and Banks 2014).
...
both spatially within lakes and across the year (Kusabs et al. 2015a;
Lee et al. 2025). Understanding these compounding pressures requires
knowledge of how kōura use lake habitat naturally and how each stressor
narrows the available range.

Kōura are naturally associated with complex rocky habitats (Jowett et
al. 2008; Kusabs et al. 2015b) or in deeper parts of the lake that
provide refuge from visual predators during daylight hours. At night,
kōura migrate vertically into the productive littoral zone to forage
(Devcich 1979). The use of both shallow and deep habitats means that,
for kōura to thrive, both must remain accessible and habitable. In
stratified lakes during summer, thermal stratification creates anoxic
conditions below the thermocline (dissolved oxygen \textless5 mg L⁻¹),
displacing kōura from their daytime deep refuge into the shallow
littoral zone (Kusabs et al. 2026). This forced upward movement places
kōura directly in the depth range where catfish predation pressure is
greatest as catfish rarely occur below approximately 17 m (Dedual 2002).
The result is a seasonal compression of available habitat, where
suitable depths shrink precisely where predation risk is highest. The
importance of an oxygenated deep refuge is illustrated by Lake Taupō
(maximum depth 186 m), where catfish and kōura co-exist because deep
waters remain oxygenated below the thermocline year-round, providing
continuous suitable habitat for kōura (Verburg and Albert 2019; Kusabs
et al. 2026). In Lake Rotoiti, the deep refuge becomes anoxic and
unavailable for kōura (Kusabs et al. 2026).

The shallow refuge available to kōura is also getting smaller. Dense
beds of invasive macrophytes obstruct kōura movement through the
...
proportion of each lake's water column that remains ``livable'' meaning
sufficiently oxygenated and within thermal tolerance for kōura. Across
...
such as Rotorua, Rotoiti, Ōkaro, and Rotomahana, while deeper
...
Over the last 20 years several lakes show statistically significant
declines in annual mean livable habitat, with Rotorua and Ōkāreka
declining -0.5\% yr⁻¹ (Figure~\ref{fig-livable-habitat-trends}).
...
\pandocbounded{\includegraphics[keepaspectratio]{images/fig-livable-habitat-summary.png}}
...
meeting dissolved oxygen (\textgreater5 mg L⁻¹) and temperature
(\textless21 °C) thresholds suitable for kōura. Coloured lines show
seasonal means; the black line shows the overall trend. Strong seasonal
compression is evident in eutrophic lakes (Rotorua, Rotoiti, Ōkaro,
Rotomahana), while oligotrophic lakes (Tarawera, Tikitapu) remain stable
year-round. Source: Moore and McBride (2026).}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/fig-livable-habitat-trends.png}}
...
meeting dissolved oxygen (\textgreater5 mg L⁻¹) and temperature
(\textless21 °C) thresholds suitable for kōura. Points represent annual
means; blue lines show linear regressions with 95\% confidence
intervals. Slopes are reported as percentage change per year
(significance: *** p \textless{} 0.001, ns = not significant). Several
lakes show significant declines in livable habitat over the monitoring
period. Source: Moore and McBride (2026).}
...
Plenty region; Table~\ref{tbl-bop-lake-overview}). The lakes were formed
by rhyolitic volcanic activity over the past \textasciitilde230,000
years and continue to experience volcanic influence, most recently
trough the 1886 eruption of Mount Tarawera, which deposited basalt
scoria and the distinctive Rotomāhana Mud across the surrounding
catchments (Cole et al. 2014). The lakes vary considerably in size
(0.3-81 km²) and maximum depth (13.5-125 m), and span a gradient of
mixing regimes and trophic states from oligotrophic (e.g.~Tarawera,
Rotomā) to supertrophic (Ōkaro; Table~\ref{tbl-bop-lake-overview}). This
diversity makes the Te Arawa Lakes a particularly informative system for
studying how kōura respond to differing combinations of habitat
structure, water quality, and predator presence.
...
Mesotrophic \\
Ōkaro & 0.3 & 2 & 3.9 & 12.5 & 18.0 & 280 & Monomictic &
Super-trophic \\
...
Each lake supports a mix of native and introduced species. Next to kōura
and catfish discussed above, native taxa include the freshwater mussle
kākahi (\emph{Echyridella menziesii}), kōaro (\emph{Galaxias
...
(Figure~\ref{fig-rotoiti-weeds}). Current lake management focussus on
improving waterquality dan controlling invasive species, including alum
(aluminium sulphate) dosing in Lakes Rotorua and Ōkaro to reduce to
reduce phosphorus loading, mechanical and chemical control of invasive
...
inreasingly well understood, several critical gpas remain in our ability
to design effective interventions. First, while catfish are probably the
main reason for kōura declines, the effect catfish have on kōura
behaviour leading to non-consumative effects in comparison with native
predators has not been quantified. We expected that kōura will show
stronger antipredator responses to the novel catfish than to native
eels, consistent with generalised fear response (Sih et al. 2023).
Second, the natural habitats that kōura prefer have been described in
streams and deeper parts of lakes but what shoreline habitats features
kōura prefer was still unknown. We expected that kōura would be
primeraly found on shorelines providing physical refuge as found for
stream habitats (Jowett et al. 2008). Third, although habitat
enhancement structures have been applied in freshwater systems globally
to support fish and invertebrates (Smokorowski and Pratt 2007; Santos et
al. 2011), very little studies have tested which combinations of
material and structural configuration best support crayfish
specifically. We expected that structurally complex structures providing
various size crevices would be preferred by widest range of kōura.
Finally, no previous studies of structure deployment to enhance kōura
habitats had been executed in lakes. Therefore we deployed stone piles
in Lake Rotoiti and expected that kōura populations at the stone piles
will increase as by providing more refuge habitat more kōura would be
able to hide from predators. This thesis addresses each of these gaps in
turn through four research chapters, building from behavioural
...
This thesis aimed to determine and develop the best ways to restore and
build resilience in the Rotorua Te Arawa Lakes kōura populations. The
findings of this thesis are reported in the following four research
chapters, followed by a general conclusion
...
kōura prefer? \\
3 & 4 --- Structure over Material & Does shelter structure or material
composition drive kōura refuge selection? \\
4 & 5 --- Stone Piles Rotoiti & Can habitat enhancement structures
provide effective habitat for kōura in Lake Rotoiti? \\
\end{longtable}

Before the deployment of any structures we first wanted to better
...
this we were able to better understand what habitat features are
important for kōura and this monitoring gave better understanding of
habitats that would benefit from the deployment of structures. In the
next chapter, \textbf{Chapter 4}, it was time to design the most
preferred structure. Kōura are known to use various materials and
compositions, so for this study we tested in mesocosm experiments
different configurations of wood and stone structures for the
preferences of kōura. When the preferred and optimal structure was
determined it was time to deploy and test it in the lake, bringing us to
\textbf{Chapter 5}, where we tested the deployed of five stone pile
structures along the shoreline in Lake Rotoiti and monitored for 18
months the development and colonisation of kōura. Finally, in the
\textbf{General Conclusion}, an overview of the findings and their wider
implications will be discussed in a way that habitat restoration can be
beneficial in building resilience in many degraded ecosystems.

\bookmarksetup{startatroot}

\chapter{Native vs.~Novel Threats}\label{native-vs.-novel-threats}
...
\chapter{Fear of the new: a predatory invader provokes stronger
non-consumptive effects on a keystone native prey than a native
predator}\label{fear-of-the-new-a-predatory-invader-provokes-stronger-non-consumptive-effects-on-a-keystone-native-prey-than-a-native-predator}
...
values as a food resource (Kusabs and Quinn 2009). Ecologically, kōura
play a critical role as ecosystem engineers through their effects on
sediment dynamics, nutrient cycling, and benthic community structure
(Collier et al. 1997; Parkyn et al. 2001; Usio and Townsend 2004).
Currently, kōura are threatened by multiple stressors, including climate
change, water-quality degradation and invasive species, contributing to
widespread population declines (Lee et al. 2025; Kusabs et al. 2026).
...
\section{Refuge experiment}\label{refuge-experiment}
...
\section{Feeding experiment}\label{feeding-experiment}
...
\section{Refuge experiment}\label{refuge-experiment-1}
...
\section{Feeding experiment}\label{feeding-experiment-1}
...
\section{Refuge use}\label{refuge-use}
...
\section{Feeding behaviour}\label{feeding-behaviour}
...
\pandocbounded{\includegraphics[keepaspectratio]{02_koura_fear/images/setup_combined.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{02_koura_fear/index_files/figure-latex/analysis-fig-emmeans-stratified-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{02_koura_fear/index_files/figure-latex/analysis-fig-refuge-plot-output-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{02_koura_fear/index_files/figure-latex/analysis-fig-feeding-plot-output-1.png}}
...
\chapter{Where do Kōura Live}\label{where-do-kux14dura-live}
...
\chapter{Littoral habitat structure influences freshwater crayfish
populations in five volcanic lakes of Aotearoa New
Zealand}\label{littoral-habitat-structure-influences-freshwater-crayfish-populations-in-five-volcanic-lakes-of-aotearoa-new-zealand}
...
Rotoiti at time of sampling (Kusabs et al. 2026).
...
(\textbf{?@tbl-environmental-biotic-overview}).
...
\section{Kōura occupancy}\label{kux14dura-occupancy}
...
\section{Kōura CPUE}\label{kux14dura-cpue}
...
\section{Kōura BPUE}\label{kux14dura-bpue}
...
\section{Habitat associations with
...
\section{Fish associations as indicator of habitat
...
\section{Associations with physico-chemical
...
used by freshwater crayfish (Johnsen and Taugbøl 2008), may help support
...
\section{Funding statement}\label{funding-statement-1}
...
\section{Authors' contributions}\label{authors-contributions-1}
...
\section{Ethical approval}\label{ethical-approval-1}
...
\caption{Physical, morphometric, and trophic characteristics of the five Rotorua
Te Arawa lakes surveyed, including sampling dates and number of littoral
sites sampled per lake. Lake surface area, perimeter length, catchment
area, depth, elevation, mixing regime, and trophic state for 2024 are
derived from the @LAWA2025 database. Shoreline composition percentages
are calculated from useable shoreline only, excluding geothermal and
cliff sections.}\tabularnewline
...
Rotoiti & 15/01/2025 (12) & 34 & 61 & 123.7 & 31.5 & 124.0 & 279 & Stratified & Mesotrophic & 0.0 & 68.5 & 21.8 & 9.7\\
Rotoehu & 10/12/2024 (12) & 8 & 40 & 49.2 & 8.0 & 13.5 & 295 & Polymictic & Eutrophic & 3.3 & 91.2 & 1.7 & 3.8\\
Rotomā & 6/11/2024 (12) & 11 & 24 & 27.8 & 36.9 & 83.0 & 316 & Stratified & Oligotrophic & 0.0 & 62.0 & 17.7 & 20.4\\
Ōkāreka & 31/10/2024 (10), 22/01/2025 (2) & 3 & 11 & 19.6 & 20.0 & 33.5 & 355 & Stratified & Mesotrophic & 8.9 & 45.1 & 20.2 & 25.8\\
\bottomrule
\end{longtable}
\end{landscape}
...
\caption{Overview of environmental and biotic variables measured at
littoral sampling sites, including variable descriptions, units, and
hypothesised relevance for kōura (\emph{Paranephrops planifrons}).
Variables were selected a priori based on known habitat requirements,
physiological constraints, and potential biotic interactions influencing
kōura occurrence, abundance, and biomass in lake littoral
zones.}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Variable
...
\chapter{Figures}\label{figures-1}

\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{03_koura_shoreline_habitats/images/Natural_habitat_map.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03_koura_shoreline_habitats/index_files/figure-latex/analysis-fig-koura-by-lake-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03_koura_shoreline_habitats/index_files/figure-latex/analysis-fig-occupancy-model-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03_koura_shoreline_habitats/index_files/figure-latex/analysis-fig-cpue-hurdle-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03_koura_shoreline_habitats/index_files/figure-latex/analysis-fig-bpue-hurdle-output-1.png}}
...
\chapter{Supplementary information}\label{supplementary-information-1}

\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{03_koura_shoreline_habitats/index_files/figure-latex/analysis-fig-length-weight-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{03_koura_shoreline_habitats/index_files/figure-latex/analysis-fig-raw-data-all-predictors-output-1.png}}
...
\caption{Distribution of environmental and biotic variables measured at
littoral sampling sites across five Te Arawa lakes in the Rotorua region
of Aotearoa New Zealand.}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Lake
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\chapter{Structure over Material}\label{structure-over-material}
...
\chapter{The importance of structure: mesocosm evidence for shelter
design in freshwater crayfish
restoration}\label{the-importance-of-structure-mesocosm-evidence-for-shelter-design-in-freshwater-crayfish-restoration}
...
in freshwater ecosystems (Kusabs and Quinn 2009; Kusabs et al. 2015a).
In their natural habitat, kōura are positively associated with
overhanging banks, coarse substrates, and woody debris (Raven et al. (a)
in review; Usio and Townsend 2000; Jowett et al. 2008; Parkyn et al.
2009). Kōura have been shown to significantly increase refuge use in the
presence of predators (Raven et al. (b) in review; Shave et al. 1994).
Habitat restoration by increasing shelter availability represents a
promising management tool for kōura recovery, and the use of natural
materials aligns with ecological and cultural values.
...
\chapter{Materials and Methods}\label{materials-and-methods-2}

\section{Animal collection and tank
...
\section{Experiment 1: Individual
...
\section{Experiment 3: Wood vs Stone}\label{experiment-3-wood-vs-stone}
...
\section{Structure matters more than
...
\section{Body size and competitive
...
\section{Restoration implications}\label{restoration-implications}
...
\section{Funding statement}\label{funding-statement-2}
...
\section{Authors' contributions}\label{authors-contributions-2}
...
\section{Ethical approval}\label{ethical-approval-2}
...
\section{Data availability
statement}\label{data-availability-statement-2}
...
\chapter{Figures}\label{figures-2}

\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{04_koura_mesocosm/images/Setup_exp_tanks.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{04_koura_mesocosm/index_files/figure-latex/analysis-fig-exp1-output-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{04_koura_mesocosm/index_files/figure-latex/analysis-fig-exp2-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{04_koura_mesocosm/index_files/figure-latex/analysis-fig-exp3-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{04_koura_mesocosm/index_files/figure-latex/analysis-fig-exp4-output-1.png}}
...
\chapter{Stone piles Rotoiti}\label{stone-piles-rotoiti}
...
\chapter{Reenforcing kōura reseliance using habitat enhancing
structures}\label{reenforcing-kux14dura-reseliance-using-habitat-enhancing-structures}
...
threatened with extinction (Sayer et al. 2025). Among the most
...
quality decline (Richman et al. 2015). As keystone species and ecosystem
engineers, crayfish play crucial roles in nutrient cycling,
bioturbation, and foodweb dynamics, and their loss can have cascading
consequences for freshwater ecosystems (Momot 1995; Collier et al. 1997;
Parkyn et al. 2001).
...
support customary fisheries using culturally important practices such as
tau kōura, yet populations in Lakes Rotoiti and Rotorua have declined by
up to 96 \% over the past two decades, with consequent loss of these
customary practices (Kusabs et al. 2015a; Kusabs et al. 2026). The
primary driver of decline is predation by the invasive brown bullhead
catfish (\emph{Ameiurus nebulosus} Lesueur, 1819, hereafter catfish),
confirmed in these lakes in 2016 and 2018 (Francis 2019; Grayling 2020).
Catfish are native to eastern North America where they mostly live in
muddy slow-moving water bodies and can survive and spawn in a wide
temperature range, tolerate poor water quality, low oxygen concentration
and have a broad diet (Scott and Crossman 1973), making them a highly
...
catfish rarely swim beyond 18 m depth (Dedual 2002). This compression is
...
including increased refuge use (Raven et al. (a) in review), reducing
...
vegetation (Raven et al. (b) in review). Coarse rocky substrate provides
refugia from predators and shelter during moulting (Streissl and Hödl
2002). Experimental studies confirm that shelter availability directly
reduces catfish predation on crayfish (Adams 2007; Zhao et al. 2024),
and kōura increase refuge use in the presence of catfish compared to
native predators (Raven et al. (a) in review), emphasising the
...
structurally complexity in the littoral zone could potentially be a
...
\chapter{Materials and Methods}\label{materials-and-methods-3}

\section{Study location and
...
\textasciitilde25 km from the lake) with a size range of 50 - 400 mm. At
each of the five stone pile sites, three stone piles were arranged
horizontally along the shoreline by hand from the shore. Stone pile
design was informed by mesocosm experiments demonstrating kōura
preference for enclosed stone structures (Raven et al. (c) in review).
...
control-impact (BACI) design (Underwood 1994); a post-construction trend
model, testing whether that response changed progressively over time at
stone pile relative to control sites; and a convergence model, testing
whether stone pile sites approached reference-sites densities over time.
...
covariates and site nested within pair as a random effect. The
post-construction trend model tested the response variables kōura
...
before construction as covariates and site number as random effect. The
convergence model tested the response variables kōura catfish abundance
or biomass fitted with Tweedie, site type and monitoring number as
interaction, season and substrate index from post-construction as
covariates and site number as random effect. All models were fitted and
validated in R (version 4.5.2; R Core Team (2025)) using the glmmTMB,
DHARMa, and emmeans packages (Hartig 2016; Brooks et al. 2017; Lenth and
Piaskowski 2017). Multiple-testing correction using Benjamini--Hochberg
correction was applied separately for each model. Robustness of the
models was further assessed via sensitivity analyses and colonisation
driver comparison in supplementary material.
...
\section{Funding statement}\label{funding-statement-3}
...
\section{Authors' contributions}\label{authors-contributions-3}
...
\section{Declarations}\label{declarations-3}

The corresponding author has declared that none of the authors has any
competing interests.

\section{Data availability
statement}\label{data-availability-statement-3}
...
\chapter{Figures}\label{figures-3}

\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{05_stone_piles_rotoiti/images/Rotoiti_monitoring_sites.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{05_stone_piles_rotoiti/index_files/figure-latex/analysis-fig-koura-trends-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{05_stone_piles_rotoiti/index_files/figure-latex/analysis-fig-convergence-plot-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{05_stone_piles_rotoiti/index_files/figure-latex/analysis-fig-forest-plot-output-1.png}}
...
\chapter{Supplementary information}\label{supplementary-information-2}
...
\pandocbounded{\includegraphics[keepaspectratio]{05_stone_piles_rotoiti/index_files/figure-latex/analysis-fig-length-weight-output-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{05_stone_piles_rotoiti/index_files/figure-latex/analysis-fig-length-weight-output-3.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{05_stone_piles_rotoiti/index_files/figure-latex/analysis-fig-descriptive-context-output-1.png}}
...
Raven OV, Burdon FJ, Kusabs IAK, et al ((b) in review)
...
Raven OV, Holmes R, Kusabs IAK, et al ((c) in review)
...
Raven OV, MacNeil C, Lee F, et al ((a) in review)

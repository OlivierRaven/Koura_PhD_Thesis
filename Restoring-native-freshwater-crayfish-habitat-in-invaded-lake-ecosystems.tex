...
\graphicspath{{.}{../}{../images/}{02_koura_fear/}{../02_koura_fear/}{03_koura_shoreline_habitats/}{../03_koura_shoreline_habitats/}{04_koura_mesocosm/}{../04_koura_mesocosm/}{05_stone_piles_rotoiti/}{../05_stone_piles_rotoiti/}}
\makeatletter
...
\pandocbounded{\includegraphics[keepaspectratio]{images/fig-study-lakes-map.png}}
...
Fear of the new: a predatory invader provokes stronger non-consumptive
effects on a keystone native prey than a native predator
...
\begin{tikzpicture}[remember picture, overlay]
  \node[inner sep=0pt] at (current page.center)
    {\includegraphics[width=\paperwidth,height=\paperheight]{images/ch2_cover.jpg}};
  \fill[black]
    (current page.north west) rectangle ([yshift=-7cm]current page.north east);
  \node[color=thesissand, align=left,
        font=\fontsize{13}{16}\selectfont\sffamily, anchor=west]
...
\includegraphics[width=6.5in,height=\textheight,keepaspectratio]{02_koura_fear/outputs/fig-emmeans-stratified.png}
...
\includegraphics[width=6.5in,height=\textheight,keepaspectratio]{02_koura_fear/outputs/fig-refuge-plot.png}
...
\includegraphics[width=5in,height=\textheight,keepaspectratio]{02_koura_fear/outputs/fig-feeding-plot.png}
...
Littoral habitat structure influences freshwater crayfish populations in
five volcanic lakes of Aotearoa New Zealand
...
\includegraphics[width=3in,height=\textheight,keepaspectratio]{03_koura_shoreline_habitats/outputs/fig-koura-by-lake.png}
...
\includegraphics[width=6.5in,height=\textheight,keepaspectratio]{03_koura_shoreline_habitats/outputs/fig-occupancy-model.png}
...
\includegraphics[width=5.5in,height=\textheight,keepaspectratio]{03_koura_shoreline_habitats/outputs/fig-cpue-hurdle.png}
...
\includegraphics[width=4in,height=\textheight,keepaspectratio]{03_koura_shoreline_habitats/outputs/fig-bpue-hurdle.png}
...
\includegraphics[width=6.5in,height=\textheight,keepaspectratio]{03_koura_shoreline_habitats/outputs/fig-length-weight.png}
...
\includegraphics[width=5in,height=\textheight,keepaspectratio]{03_koura_shoreline_habitats/outputs/fig-raw-data-all-predictors.png}
...
\chapter{The Importance of Structure}\label{the-importance-of-structure}

The importance of structure: mesocosm evidence for shelter design in
...
\begin{tikzpicture}[remember picture, overlay]
  \node[inner sep=0pt] at (current page.center)
    {\includegraphics[width=\paperwidth,height=\paperheight]{images/ch4_cover.jpg}};
  \fill[black]
    (current page.north west) rectangle ([yshift=-7cm]current page.north east);
  \node[color=thesissand, align=left,
        font=\fontsize{13}{16}\selectfont\sffamily, anchor=west]
...
banks, coarse substrates, and woody debris (Raven et al. (a) in review;
Usio and Townsend 2000; Jowett et al. 2008; Parkyn et al. 2009). Kōura
have been shown to significantly increase refuge use in the presence of
predators (Raven et al. (b) in review; Shave et al. 1994). Habitat
...
and next-day location (\emph{p} = 0.002), suggesting kōura actively
...
\includegraphics[width=5in,height=\textheight,keepaspectratio]{04_koura_mesocosm/outputs/fig-exp1.png}
...
\includegraphics[width=6.5in,height=\textheight,keepaspectratio]{04_koura_mesocosm/outputs/fig-exp2.png}
...
\includegraphics[width=6.5in,height=\textheight,keepaspectratio]{04_koura_mesocosm/outputs/fig-exp3.png}
...
\includegraphics[width=6.5in,height=\textheight,keepaspectratio]{04_koura_mesocosm/outputs/fig-exp4.png}
...
\chapter{Rock Piles as Kōura
Habitat}\label{rock-piles-as-kux14dura-habitat}

Reinforcing kōura resilience using rock piles to enhance freshwater
crayfish habitat in an Aotearoa New Zealand lake
...
\begin{tikzpicture}[remember picture, overlay]
  \node[inner sep=0pt] at (current page.center)
    {\includegraphics[width=\paperwidth,height=\paperheight]{images/ch5_cover.jpg}};
  \fill[black]
    (current page.north west) rectangle ([yshift=-7cm]current page.north east);
  \node[color=thesissand, align=left,
        font=\fontsize{13}{16}\selectfont\sffamily, anchor=west]
...
\includegraphics[width=5in,height=\textheight,keepaspectratio]{05_stone_piles_rotoiti/outputs/fig-koura-trends.png}
...
\includegraphics[width=6.5in,height=\textheight,keepaspectratio]{05_stone_piles_rotoiti/outputs/fig-convergence-plot.png}
...
\includegraphics[width=3in,height=\textheight,keepaspectratio]{05_stone_piles_rotoiti/outputs/fig-forest-plot.png}
...
\includegraphics[width=6.5in,height=\textheight,keepaspectratio]{05_stone_piles_rotoiti/outputs/fig-length-weight.png}
...
\includegraphics[width=6.5in,height=\textheight,keepaspectratio]{05_stone_piles_rotoiti/outputs/fig-descriptive-context.png}
